...
public class DictBasicController extends BaseController {
    ...
    /**
     * 字典通用下拉列表
     * @param type moduleStatus，superiorOption 上级选项，approveOption 审批人选项，processCondition 流程网关条件 approverEmpty 审批人为空时 multiPersonReview 多人处理方式 timeoutHandling 超时处理方式 reviewSetting 审批设置 processStatus 流程状态 processType 流程类型

...
public class ApproveSyncRecordController extends BaseController {
    ...
    */
    ...
    public ApiResult<BaseResultDTO.AddDTO> add(@RequestBody @Validated ApproveSyncRecordDTO.AddDTO dto) {
        return success(approveSyncRecordService.add(dto));
    }
    ...
    */
    ...
    @LogAction(value = LogActionEnum.UPDATE, desc = "ERP审批同步-通知配置修改")
        ...
        menuCode = "workflow:approveSyncRecord:update",
        serviceClass = ApproveSyncRecordService.class,
        keyIdName = "id")
    public ApiResult<?> update(@RequestBody @Validated ApproveSyncRecordDTO.UpdateDTO dto) {
        approveSyncRecordService.update(dto);
        return success();
    }

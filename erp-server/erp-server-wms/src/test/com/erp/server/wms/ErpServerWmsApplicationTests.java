...
//
//        List<String> list = Arrays.asList("1678753533744123905",
//                "1678764103549587459",
//                "1677329651875188740",
//                "1678732732579975169",
//                "1677329653158645767",
...
//            try {
//                HttpUtil.createPost("http://172.16.100.10:9000/api/wms/so/outstock/disApprove")
//                        .bearerAuth("eyJhbGciOiJIUzI1NiJ9.eyJ1aWQiOiIxNTQ5OTQ4NDc2NzU3MzAzMjk3IiwidXNlcl9rZXkiOiIxNTQ5OTQ4NDc2NzU3MzAzMjk3IiwidXNlck5hbWUiOiJhZG1pbiIsImlhdCI6MTY4OTIzMTMzNiwiZXhwIjoxNjg5ODM2MTM2fQ.mICkwpbBHE0CEL9_WDdJOPUVfWr8pWedzI8PGWyV_DM")
//                        .body(JSONUtil.createObj().put("ids", Arrays.asList(id)).put("","").toString(), ContentType.JSON.getValue())
//                        .execute();
//            } catch (Exception e) {
//                e.printStackTrace();
//            }
...
//    }
    ...
    @Test
    public void test(){
        SoOutstockEntity entity=   soOutstockService.getById("1681930762183512065");
        syncKingdeeSoOutstockService.syncDataToKingdee(entity, SyncKingdeeOperateEnum.OPERATE_APPROVE.getCode());
    }

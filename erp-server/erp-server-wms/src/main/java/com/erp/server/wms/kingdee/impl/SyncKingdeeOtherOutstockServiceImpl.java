...
public class SyncKingdeeOtherOutstockServiceImpl implements SyncKingdeeOtherOutstockService {
    ...
    public void syncDataToKingdee(OtherOutstockEntity entity, String operate) {
        ...
        //更新同步状态为待同步
        otherOutstockService.updateSyncKingdeeStatus(entity.getId(), SyncStatusEnum.TO_BE_SYNC.getCode(),"",operate);
        ...
        CompletableFuture.supplyAsync(() -> {
            ...
            if (result.getSendStatus().equals(SendStatus.SEND_OK)) {
                //mq发送成更新业务表状态及时间
                return otherOutstockService.updateSyncKingdeeStatus(entity.getId(), SyncStatusEnum.IN_SYNC.getCode(), "",operate);
            }
            return Boolean.TRUE;
        });
    }

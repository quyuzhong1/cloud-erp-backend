...
public class SyncKingdeeStocktakingProfitServiceImpl implements SyncKingdeeStocktakingProfitService {
    ...
    private DmpPushTaskEntity saveTask (StocktakingProfitLossEntity entity, String operate, Map<String, Object> resultMap) {
        ...
        List<CfgSettingEntity> list = FeignQuery.create(CfgSettingEntity.class)
        		.eq(CfgSettingEntity::getKey, SourceTypeEnum.STOCKTAKING_PROFIT.getCode())
        ...
        if(CollUtil.isEmpty(list)) {
            ...
            dmpSyncTaskDTO.setMqTag(RocketMqTagEnum.KINGDEE_STOCKTAKING_PROFIT_TAG.getName());
        ...
        wmsPushMsgEntity.setSourceType(SourceTypeEnum.STOCKTAKING_PROFIT.getCode());
	...
	public Map<String, Object> newSyncDataToKingdee(StocktakingProfitLossEntity entity, String operate) {
        ...
        if (Objects.isNull(entity)) {
            throw new ServiceException("未找到盘盈单");
        }

 ...
 */
public class VirtualWarehouseAllocationExcelListener extends AnalysisEventListener<MoveInfoExcelDTO> {
    ...
    public VirtualWarehouseAllocationExcelListener(WarehouseLocationMoveService warehouseLocationMoveService,

...
public interface PackingTaskMapper extends BaseMapper<PackingTaskEntity> {
    ...
    Page<WmsCartonDetailDTO.ListPackingDetailDTO> listPackingDetailBySkuId(@Param("query") Page<PackingTaskDTO.ExportDTO> query,@Param("params") PackingTaskDTO.ExportDTO page);
    ...
    List<WmsCartonDTO.CountDTO> countPackingQtyBySourceIds(@Param("sourceIds") List<String> sourceIds);
}

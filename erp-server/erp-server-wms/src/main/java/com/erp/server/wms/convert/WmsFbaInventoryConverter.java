...
public interface WmsFbaInventoryConverter {
    ...
    @Mappings({
            ...
            // 其他记录信息
            @Mapping(target = "skuNo", expression = "java(org.apache.commons.lang3.StringUtils.isBlank(newEntity.getSkuNo())? oldEntity.getSkuNo() : newEntity.getSkuNo())"),
            @Mapping(target = "productName", expression = "java(org.apache.commons.lang3.StringUtils.isBlank(newEntity.getProductName())? oldEntity.getProductName() : newEntity.getProductName())"),
            ...
            @Mapping(target = "warehouseName", expression = "java(org.apache.commons.lang3.StringUtils.isBlank(newEntity.getWarehouseName())? oldEntity.getWarehouseName() : newEntity.getWarehouseName())"),
            @Mapping(target = "warehouseId", expression = "java(org.apache.commons.lang3.StringUtils.isBlank(newEntity.getWarehouseId())? oldEntity.getWarehouseId() : newEntity.getWarehouseId())"),
            // 库存报告管理信息
            ...
            @Mapping(target = "deliveryChannels", expression = "java(org.apache.commons.lang3.StringUtils.isBlank(newEntity.getDeliveryChannels())? oldEntity.getDeliveryChannels() : newEntity.getDeliveryChannels())"),

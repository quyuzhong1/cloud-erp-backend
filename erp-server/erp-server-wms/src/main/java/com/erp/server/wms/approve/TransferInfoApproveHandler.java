...
public class TransferInfoApproveHandler extends AbstractApproveHandler {
    ...
    public BatchResultDTO approve(ApproveOneDTO dto) {
        return transferInfoService.approve(transferInfoService.getById(dto.getId()),dto.getType(),dto.getComment(),dto.getIsNeedProcess(),Boolean.TRUE,Boolean.TRUE);
    }

    @Override
    public Boolean cancelProcess(ApproveDTO.CancelProcessDTO dto) {
        return transferInfoService.cancelProcess(new ApproveDTO.BatchCancelProcessDTO(dto));
    }
    ...
    public Boolean approveEnd(ApproveDTO.EndProcessDTO dto) {
        ...
        //添加日志
        return operateLogService.addModuleOperateLog(CharSequenceUtil.format("【{}】审核，审核【{}】了一个分步式调入单",dto.getApprovePlatformEnum().getName(), ApproveTypeEnum.getName(dto.getApproveStatus().getStatus())), ModuleTypeEnum.TRANSFER_INFO.getCode(),dto.getBusinessId(), "审核操作");
    }
    ...
    public void addComment(ApproveDTO.AddCommentDTO dto) {
        ...
        dto.getComments().stream().map(obj -> new OperateLogDTO.AddModuleOperateLogDTO(CharSequenceUtil.format("【{}】流程添加评论【{}】",dto.getApprovePlatformEnum().getName(),obj), ModuleTypeEnum.TRANSFER_INFO.getCode(), dto.getId(), "添加评论"))

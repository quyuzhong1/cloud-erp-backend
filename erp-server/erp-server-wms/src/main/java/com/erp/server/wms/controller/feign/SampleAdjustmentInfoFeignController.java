...
@Slf4j
@RestController
@LogSystemModule("样品调整单app端")
@RequestMapping("/feign/sampleAdjustmentInfo")
public class SampleAdjustmentInfoFeignController extends BaseController {
     ...
     */
    @PostMapping("/add")
    @LogAction(value = LogActionEnum.INSERT, desc = "样品调整单app端新增")
     ...
     */
    @PostMapping("/update")
    @LogAction(value = LogActionEnum.UPDATE, desc = "样品调整单app端修改")
    ...
    public ApiResult<List<SampleAdjustmentInfoDTO.TabListDTO>> tabListApp(@RequestBody PermissionsDTO param) {
        return success(sampleAdjustmentInfoService.tabListApp(param));
    }
    ...
    public ApiResult<PagingVO<SampleAdjustmentInfoDTO.ListDTO>> pagingApp(@RequestBody @Validated PagingDTO<SampleAdjustmentInfoDTO.PagingParamDTO> dto) {
        return success(sampleAdjustmentInfoService.pagingApp(dto));
    }
    ...
    @DataPermission(operationType = DataAttributeEnum.CHECK_BY_ID,
            ...
            serviceClass = SampleAdjustmentInfoService.class,
            keyIdName = "ids")
    @LogAction(value = LogActionEnum.SUBMIT, desc = "样品调整单app端提交审核")
    ...
    @DataPermission(operationType = DataAttributeEnum.CHECK_BY_ID,
            ...
            serviceClass = SampleAdjustmentInfoService.class,
            keyIdName = "ids")
    @LogAction(value = LogActionEnum.APPROVE, desc = "样品调整单app端审核")
    ...
    @DataPermission(operationType = DataAttributeEnum.CHECK_BY_ID,
            ...
            serviceClass = SampleAdjustmentInfoService.class,
            keyIdName = "ids")
    @LogAction(value = LogActionEnum.DISAPPROVE, desc = "样品调整单app端反审核")
    ...
    @DataPermission(operationType = DataAttributeEnum.CHECK_BY_ID,
            ...
            serviceClass = SampleAdjustmentInfoService.class,
            keyIdName = "ids")
    @LogAction(value = LogActionEnum.DELETE, desc = "样品调整单app端删除")
    ...
    @DataPermission(operationType = DataAttributeEnum.CHECK_BY_ID,
            ...
            serviceClass = SampleAdjustmentInfoService.class,
            keyIdName = "ids")
    @LogAction(value = LogActionEnum.INVALID, desc = "样品调整单app端作废")
    ...
    @DataPermission(operationType = DataAttributeEnum.CHECK_BY_ID,
            ...
            serviceClass = SampleAdjustmentInfoService.class,
            keyIdName = "ids")
    @LogAction(value = LogActionEnum.CANCEL, desc = "样品调整单app端撤销")
    public ApiResult<List<BatchResultDTO>> batchCancelProcess(@RequestBody @Validated BaseIdsDTO.IdsDTO dto) {
        ...
        for (String id : dto.getIds()) {
            ...
            try {
                cancelResult = sampleAdjustmentInfoService.cancelProcess(new ApproveDTO.CancelProcessDTO(id));
            }catch (Exception e){
                log.error("样品调整单app端撤回流程失败",e);
                SampleAdjustmentInfoEntity entity = idEntityMap.get(id);
                if (ObjectUtil.isEmpty(entity)) {
    ...
    @GetMapping("/view")
    @LogViewService
    public ApiResult<SampleAdjustmentInfoDTO.ViewDTO> viewApp(@RequestParam("id") String id) {

...
@Slf4j
@RestController
@LogSystemModule("样品退回单")
@RequestMapping("/sampleBackInfo")
public class SampleBackInfoController extends BaseController {
    ...
    */
    @PostMapping("/add")
    @LogAction(value = LogActionEnum.INSERT, desc = "样品退回单新增")
    ...
    */
    @PostMapping("/update")
    @LogAction(value = LogActionEnum.UPDATE, desc = "样品退回单修改")
    ...
    */
    ...
    public ApiResult<PagingVO<SampleBackInfoDTO.ListDTO>> paging(@RequestBody @Validated PagingDTO<SampleBackInfoDTO.PagingParamDTO> dto) {
        return success(sampleBackInfoService.paging(dto));
    }
    ...
    */
    ...
    @DataPermission(operationType = DataAttributeEnum.CHECK_BY_ID,
            ...
            serviceClass = SampleBackInfoService.class,
            keyIdName = "ids")
    @LogAction(value = LogActionEnum.SUBMIT, desc = "样品退回单提交审核")
    public ApiResult<List<BatchResultDTO>> batchSubmit(@RequestBody @Validated BaseIdsDTO.IdsDTO dto) {
        ...
        for (String id : dto.getIds()) {
            ...
            try {
                submit = sampleBackInfoService.submit(id);
            }catch (Exception e){
                log.error("样品退回单 提交审核失败",e);
    ...
    */
    ...
    @DataPermission(operationType = DataAttributeEnum.CHECK_BY_ID,
            ...
            serviceClass = SampleBackInfoService.class,
            keyIdName = "ids")
    @LogAction(value = LogActionEnum.APPROVE, desc = "样品退回单审核")
    public ApiResult<List<BatchResultDTO>> batchApprove(@RequestBody @Validated BaseApproveParamDTO dto) {
        ...
        for (String id : ids) {
            ...
            try {
                approveResult = sampleBackInfoService.approve(new ApproveOneDTO(id, dto.getType(),dto.getComment()));
            }catch (Exception e){
    ...
    */
    ...
    @DataPermission(operationType = DataAttributeEnum.CHECK_BY_ID,
            ...
            serviceClass = SampleBackInfoService.class,
            keyIdName = "ids")
    @LogAction(value = LogActionEnum.DISAPPROVE, desc = "样品退回单反审核")
    public ApiResult<List<BatchResultDTO>> batchDisApprove(@RequestBody @Validated BaseIdsDTO.IdsDTO dto) {
        ...
        for (String id : dto.getIds()) {
            ...
            try {
                disApproveResult = sampleBackInfoService.disApprove(id);
            }catch (Exception e){
                log.error("样品退回单反审核失败",e);
                SampleBackInfoEntity entity = idEntityMap.get(id);
                if (ObjectUtil.isEmpty(entity)) {
    ...
    */
    ...
    @DataPermission(operationType = DataAttributeEnum.CHECK_BY_ID,
            ...
            serviceClass = SampleBackInfoService.class,
            keyIdName = "ids")
    @LogAction(value = LogActionEnum.DELETE, desc = "样品退回单删除")
    public ApiResult<List<BatchResultDTO>> batchDelete(@RequestBody @Validated BaseIdsDTO.IdsDTO dto) {
        ...
        for (String id : dto.getIds()) {
            ...
            try {
                deleteResult = sampleBackInfoService.delete(id);
            }catch (Exception e){
                log.error("样品退回单删除失败",e);
                SampleBackInfoEntity entity = idEntityMap.get(id);
                if (ObjectUtil.isEmpty(entity)) {
    ...
    */
    ...
    @DataPermission(operationType = DataAttributeEnum.CHECK_BY_ID,
            ...
            serviceClass = SampleBackInfoService.class,
            keyIdName = "ids")
    @LogAction(value = LogActionEnum.INVALID, desc = "样品退回单作废")
    public ApiResult<List<BatchResultDTO>> batchInvalid(@RequestBody @Validated BaseIdsDTO.RemarkDTO dto) {
        ...
        for (String id : dto.getIds()) {
            ...
            try {
                invalidResult = sampleBackInfoService.invalid(id,dto.getRemark());
            }catch (Exception e){
                log.error("样品退回单作废失败",e);
                SampleBackInfoEntity entity = idEntityMap.get(id);
                if (ObjectUtil.isEmpty(entity)) {
                    invalidResult = BatchResultDTO.fail(id, id, "样品退回单不存在, 作废失败");
    ...
    */
    ...
    @DataPermission(operationType = DataAttributeEnum.CHECK_BY_ID,
            ...
            serviceClass = SampleBackInfoService.class,
            keyIdName = "ids")
    @LogAction(value = LogActionEnum.CANCEL, desc = "样品退回单撤销")
    public ApiResult<List<BatchResultDTO>> batchCancelProcess(@RequestBody @Validated BaseIdsDTO.IdsDTO dto) {
        ...
        for (String id : dto.getIds()) {
            ...
            try {
                cancelResult = sampleBackInfoService.cancelProcess(new ApproveDTO.CancelProcessDTO(id));
            }catch (Exception e){
                log.error("样品退回单撤回流程失败",e);
                SampleBackInfoEntity entity = idEntityMap.get(id);
                if (ObjectUtil.isEmpty(entity)) {
    ...
    */
    ...
    @DataPermission(operationType = DataAttributeEnum.CHECK_BY_ID,
            tableField = "create_user_id",
            menuCode = "wms:sampleBackInfo:view",
            serviceClass = SampleBackInfoService.class,
            keyIdName = "id")
    @LogViewService
    public ApiResult<SampleBackInfoDTO.ViewDTO> view(@RequestParam("id") String id) {

...
public class SoReturnReceiveApproveHandler extends AbstractApproveHandler {
    ...
    public Boolean cancelProcess(ApproveDTO.CancelProcessDTO dto) {
        return soReturnReceiveService.cancelProcess(new ApproveDTO.BatchCancelProcessDTO(dto));
    }
    ...
    public Boolean disApprove(ApproveDTO.DisApproveDTO dto) {
        ...
        if (ObjectUtil.isEmpty(entity)) {
            throw new ServiceException(ApiError.BILL_NOT_EXIST_WITH_TYPE,"销售退货签收单");
        }

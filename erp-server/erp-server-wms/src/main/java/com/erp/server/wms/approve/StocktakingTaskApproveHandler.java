...
public class StocktakingTaskApproveHandler extends AbstractApproveHandler {
    ...
    public Boolean cancelProcess(ApproveDTO.CancelProcessDTO dto) {
        BatchResultDTO resultDTO = stocktakingTaskService.cancelProcess(dto);
    ...
    public Boolean approveEnd(ApproveDTO.EndProcessDTO dto) {
        ...
        Boolean approve = stocktakingTaskService.approveEnd(approveOne, entity);
        ...
        //添加日志
        return operateLogService.addModuleOperateLog(CharSequenceUtil.format("【{}】审核，审核【{}】了一个盘点任务表",dto.getApprovePlatformEnum().getName(), ApproveTypeEnum.getName(dto.getApproveStatus().getStatus())), ModuleTypeEnum.STOCKTAKING_TASK.getCode(),dto.getBusinessId(), "审核操作");
    ...
    public void addComment(ApproveDTO.AddCommentDTO dto) {
        ...
        dto.getComments().stream().map(obj -> new OperateLogDTO.AddModuleOperateLogDTO(CharSequenceUtil.format("【{}】流程添加评论【{}】",dto.getApprovePlatformEnum().getName(),obj), ModuleTypeEnum.STOCKTAKING_TASK.getCode(), dto.getId(), "添加评论"))

...
public interface InventoryMapper extends BaseMapper<InventoryEntity> {
     ...
     * @return com.erp.model.wms.dto.inventory.InventoryDTO.PdaInventoryDTO
     **/
    IPage<InventoryDTO.PdaInventoryWarehouseDTO> listInventoryWarehouseByParam(Page query,@Param("params") InventoryDTO.InventoryBySkuNoDTO params);
     ...
     * @return
     */
    IPage<InventoryDTO.PdaInventoryWarehousePageDTO> pageInventoryWarehouseByWarehouse(Page query,@Param("params") InventoryDTO.InventoryBySkuNoDTO params);
    /**
     * 根据条件查询仓库下的仓位库存信息
     * @Author Luo_WG
     * @Date 2023/8/25 18:13

...
@RequestMapping("/app/sampleBackInfo")
public class SampleBackInfoAppController extends BaseController {
    ...
    public ApiResult<List<BatchResultDTO>> batchCancelProcess(@RequestBody @Validated BaseIdsDTO.IdsDTO dto) {
        ...
        for (String id : dto.getIds()) {
            ...
            try {
                cancelResult = sampleBackInfoService.cancelProcess(new ApproveDTO.CancelProcessDTO(id), ClientTypeEnum.APP);
            }catch (Exception e){

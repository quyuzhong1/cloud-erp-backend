...
public class OtherOutstockApproveHandler extends AbstractApproveHandler {
    ...
    public Boolean approveEnd(ApproveDTO.EndProcessDTO dto) {
        ...
        Boolean approve = otherOutstockService.approveEnd(approveOne, entity);
        ...
        //添加日志
        return operateLogService.addModuleOperateLog(CharSequenceUtil.format("【{}】审核，审核【{}】了一个其他出库表",dto.getApprovePlatformEnum().getName(), ApproveTypeEnum.getName(dto.getApproveStatus().getStatus())), ModuleTypeEnum.OTHER_OUTSTOCK.getCode(),dto.getBusinessId(), "审核操作");
    }
    ...
    public void addComment(ApproveDTO.AddCommentDTO dto) {
        ...
        dto.getComments().stream().map(obj -> new OperateLogDTO.AddModuleOperateLogDTO(CharSequenceUtil.format("【{}】流程添加评论【{}】",dto.getApprovePlatformEnum().getName(),obj), ModuleTypeEnum.OTHER_OUTSTOCK.getCode(), dto.getId(), "添加评论"))

...
public class WarehouseLocationMoveInfoServiceImpl extends SuperServiceImpl<WarehouseLocationMoveInfoMapper, WarehouseLocationMoveInfoEntity> implements WarehouseLocationMoveInfoService {
    ...
    */
    ...
    @Override
    public void exportList(WarehouseLocationMoveInfoDTO.ExportDTO param, HttpServletResponse response) {
        List<WarehouseLocationMoveInfoDTO.ListDTO> list = this.baseMapper.listExport(param);
        ...
        String excelPath = "excel/warehouseLocationMoveInfo.xlsx";
        String name = "仓位移动主单导出";

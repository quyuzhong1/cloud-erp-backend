...
public class CfgTransactionRulesServiceImpl extends SuperServiceImpl<CfgTransactionRulesMapper, CfgTransactionRulesEntity> implements CfgTransactionRulesService {
    ...
    public void initRules() {
        ...
        cfgTransactionRulesEntity.setRemark(CharSequenceUtil.format(TEMPLATE,businessType.getName(), InventoryWarehouseOptionEnum.WAREHOUSE_CURRENT.getName(), inventoryStatus.getName(), inventoryMode.getName()));
        ...
        inventoryMode = InventoryModeEnum.IN_STOCK;
        cfgTransactionRulesEntity.setTransactionMode(inventoryMode.getCode());
        cfgTransactionRulesEntity.setRemark(CharSequenceUtil.format(TEMPLATE,businessType.getName(),  InventoryWarehouseOptionEnum.WAREHOUSE_TARGET.getName(), inventoryStatus.getName(), inventoryMode.getName()));
        rules.add(cfgTransactionRulesEntity);
        ...
        inventoryMode = InventoryModeEnum.OUT_STOCK;
        cfgTransactionRulesEntity.setTransactionMode(inventoryMode.getCode());
        cfgTransactionRulesEntity.setRemark(CharSequenceUtil.format(TEMPLATE,businessType.getName(), inventoryWarehouseOptionEnum.getName(), inventoryStatus.getName(), inventoryMode.getName()));
        rules.add(cfgTransactionRulesEntity);

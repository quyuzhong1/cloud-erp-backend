...
public interface RequisitionApplicationConverter {
    ...
    @Mappings({
        ...
        @Mapping(target = "status", expression = "java(com.erp.model.wms.enums.RequisitionApplicationStatusEnum.WAIT_HANDLE.getCode())"),
        ...
        @Mapping(target = "requisitionWarehouseId", source = "toWarehouseId"),
        @Mapping(target = "requisitionWarehouseName", source = "toWarehouseName"),

...
public class SampleScrapApproveHandler extends AbstractApproveHandler {
    ...
    public Boolean disApprove(ApproveDTO.DisApproveDTO dto) {
        BatchResultDTO result = sampleScrapInfoService.disApprove(dto.getId(), ClientTypeEnum.WEB);
        return result.getSuccess();
    }
    ...
    public void addComment(ApproveDTO.AddCommentDTO dto) {
        ...
        dto.getComments().stream().map(obj -> new OperateLogDTO.AddModuleOperateLogDTO(CharSequenceUtil.format("【{}】流程添加评论【{}】",dto.getApprovePlatformEnum().getName(),obj), ModuleTypeEnum.SAMPLE_SCRAP_INFO.getCode(), dto.getId(), "添加评论"))

...
public class SyncWdtOtherInStockServiceImpl extends AbstractWdtService implements SyncWdtOtherInStockService {
    ...
    public DmpPushTaskFeignDTO generateTask(List<CreateOtherStockinRequest.GoodsList> goodsList, String operateCode, String sourceCode, String detailId, String outerCode, String thirdWarehouseCode, boolean checkOuterCode, String sysWarehouseId, String sysWarehouseName){
...
//    @Override
    public Pair<List<CreateOtherStockinRequest.GoodsList>, List<CreateOtherStockinRequest.GoodsList>> splitGoodsList(String sysWarehouseId, List<CreateOtherStockinRequest.GoodsList> goodsList){
        List<WarehouseLocationMappingEntity> mappingList = warehouseLocationMappingMapper.selectList(new LambdaQueryWrapper<WarehouseLocationMappingEntity>()

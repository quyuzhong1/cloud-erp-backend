...
public class SoReturnNoticeApproveHandler extends AbstractApproveHandler {
    ...
    public BatchResultDTO approve(ApproveOneDTO dto) {
        return soReturnNoticeService.approve(soReturnNoticeService.getById(dto.getId()),dto.getType(),dto.getComment(),dto.getIsNeedProcess());
    }
    ...
    public Boolean disApprove(ApproveDTO.DisApproveDTO dto) {
        ...
        if (ObjectUtil.isEmpty(entity)) {
            throw new ServiceException(ApiError.BILL_NOT_EXIST_WITH_TYPE,"销售退货通知");
        }

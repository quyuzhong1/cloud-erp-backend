...
//        PurchaseOrderSupplierEntity orderSupplierByOrderId = scmTaskFeign.getOrderSupplierByOrderId(purchaseOrderEntity.getId());
    ...
    public Boolean submit(List<String> ids) {
        ...
        //采购组织不能为空
        String codes = purchaseReturnOrderEntities.stream().filter(obj -> StrUtil.isBlank(obj.getPurchaseOrderId())).map(PoReturnEntity::getCode).collect(Collectors.joining(","));
    ...
    public Boolean exportExcel(PurchaseReturnOrderDTO.PagingParamDTO dto, HttpServletResponse response) {
        ...
        String excelPath = "excel/poReturnExport.xlsx";
        String name = "退货单";

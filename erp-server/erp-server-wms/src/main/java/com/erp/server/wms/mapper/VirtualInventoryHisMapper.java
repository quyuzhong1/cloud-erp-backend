...
public interface VirtualInventoryHisMapper extends BaseMapper<VirtualInventoryHisEntity> {
     ...
     * @return List<AddDTO>
     */
    List<VirtualInventoryHisDTO.AddDTO> listVirtualInventoryHis(@Param("virtualInventoryIds")List<String> virtualInventoryIds,@Param("localDate") LocalDate localDate);
    /**
     * 根据关联id和日期查询
     * @author will

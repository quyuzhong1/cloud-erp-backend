...
//        String code = sysUserFeign.getBusinessNo(new SysCodeDTO(BusinessNoConstant.FHTZ, BusinessNoTypeEnum.CODE_FHTZ.getCode()));
        ...
        autoGenerateDeclareDetailMid(soDeliveryNoticeEntity, BillGenerateTimingEnum.AFTER_ADD, Boolean.TRUE);
    ...
    public Boolean approveEnd(ApproveOneDTO dto, SoDeliveryNoticeEntity entity) {
        ...
        if (ApproveTypeEnum.PASS.getStatus().equals(dto.getType())) {
            ...
            autoGenerateDeclareDetailMid(entity, BillGenerateTimingEnum.AFTER_APPROVE, Boolean.TRUE);
        } else {
            //审核不通过
    ...
    @Override
    public List<TmsDeclareBillDTO.MergeDeclareBillDTO> listAfterPushB2bDeclareNoMerge(List<TmsDeclareBillDTO.PushDeclareNoMergeDTO> list) {
     ...
     */
    private List<TmsDeclareBillDTO.MergeDeclareBillDTO> buildB2bMinMergeDeclareBillList(List<TmsDeclareBillDTO.SourceDeliveryDetailDTO> sourceDetailList) {
        if (CollUtil.isEmpty(sourceDetailList)) {
            return Collections.emptyList();
        }
...
//        List<WarehouseEntity> warehouseEntityList = warehouseService.listByIds(transferWarehouseIdList);
    ...
    public void updatePackingStatus(String id, String packingStatus) {
        ...
        if (CharSequenceUtil.equals(packingStatus, PackingTaskStatusEnum.PACKED.getCode())) {
            ...
            if (Objects.nonNull(entity)) {
                autoGenerateDeclareDetailMid(entity, BillGenerateTimingEnum.AFTER_ADD, Boolean.TRUE);
     ...
     * @date 2026-04-29
     */
    private void autoGenerateDeclareDetailMid(SoDeliveryNoticeEntity entity, BillGenerateTimingEnum billGenerateTimingEnum, Boolean checkCfg) {

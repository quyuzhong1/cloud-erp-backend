...
public class SyncNewWdtRefundOrderConsumer implements RocketMQListener<Object> {
    ...
    public void onMessage(Object ext) {
        ...
        log.info("监听到旺店通退货单需要同步：entity={}", jsonObject);
        WdtReturnOrderDTO entity = JSON.parseObject(ext.toString(),  WdtReturnOrderDTO.class);

...
public class StocktakingProfitLossApproveHandler extends AbstractApproveHandler {
    ...
    public BatchResultDTO approve(ApproveOneDTO dto) {
        return stocktakingProfitLossService.approve(dto.getId(),dto);
    }

    @Override
    public Boolean cancelProcess(ApproveDTO.CancelProcessDTO dto) {
        BatchResultDTO resultDTO = stocktakingProfitLossService.cancelProcess(dto);
    ...
    public Boolean approveEnd(ApproveDTO.EndProcessDTO dto) {
        ...
        Boolean approve = stocktakingProfitLossService.approveEnd(approveOne, entity);
        ...
        //添加日志
        return operateLogService.addModuleOperateLog(CharSequenceUtil.format("【{}】审核，审核【{}】了一个盘点表",dto.getApprovePlatformEnum().getName(), ApproveTypeEnum.getName(dto.getApproveStatus().getStatus())), ModuleTypeEnum.STOCKTAKING_PROFIT_LOSS.getCode(),dto.getBusinessId(), "审核操作");
    }
    ...
    public void addComment(ApproveDTO.AddCommentDTO dto) {
        ...
        dto.getComments().stream().map(obj -> new OperateLogDTO.AddModuleOperateLogDTO(CharSequenceUtil.format("【{}】流程添加评论【{}】",dto.getApprovePlatformEnum().getName(),obj), ModuleTypeEnum.STOCKTAKING_PROFIT_LOSS.getCode(), dto.getId(), "添加评论"))

 ...
 * @Author: zhangchunlin
 */
@ConfigurationProperties(prefix = VirtualInventoryRedisConfigProperties.PREFIX)
@RefreshScope
@Component
public class VirtualInventoryRedisConfigProperties {

    public static final String PREFIX = "virtualinventoryredis";

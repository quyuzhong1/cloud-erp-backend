...
public class PurchasePriceApproveHandler extends AbstractApproveHandler {
    ...
    public Boolean cancelProcess(ApproveDTO.CancelProcessDTO dto) {
        ...
        BatchResultDTO resultDTO = purchasePriceService.cancelProcessEntity(dto,entity);
    ...
    public Boolean approveEnd(ApproveDTO.EndProcessDTO dto) {
        ...
        //添加日志
        return operateLogService.addModuleOperateLog(CharSequenceUtil.format("【{}】审核，审核【{}】了一个采购价目表",dto.getApprovePlatformEnum().getName(), ApproveTypeEnum.getName(dto.getApproveStatus().getStatus())), ModuleTypeEnum.PURCHASE_PRICE.getCode(),dto.getBusinessId(), "审核操作");
    }
    ...
    public void addComment(ApproveDTO.AddCommentDTO dto) {
        ...
        dto.getComments().stream().map(obj -> new OperateLogDTO.AddModuleOperateLogDTO(CharSequenceUtil.format("【{}】流程添加评论【{}】",dto.getApprovePlatformEnum().getName(),obj), ModuleTypeEnum.PURCHASE_PRICE.getCode(), dto.getId(), "添加评论"))

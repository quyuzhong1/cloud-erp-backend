...
public class SubcontractOrderApproveHandler extends AbstractApproveHandler {
    ...
    public Boolean approveEnd(ApproveDTO.EndProcessDTO dto) {
        ...
        //添加日志
        return operateLogService.addModuleOperateLog(CharSequenceUtil.format("【{}】审核，审核【{}】了一个委外订单表",dto.getApprovePlatformEnum().getName(), ApproveTypeEnum.getName(dto.getApproveStatus().getStatus())), ModuleTypeEnum.SUBCONTRACT_ORDER.getCode(),dto.getBusinessId(), "审核操作");
    }
    ...
    public void addComment(ApproveDTO.AddCommentDTO dto) {
        ...
        dto.getComments().stream().map(obj -> new OperateLogDTO.AddModuleOperateLogDTO(CharSequenceUtil.format("【{}】流程添加评论【{}】",dto.getApprovePlatformEnum().getName(),obj), ModuleTypeEnum.SUBCONTRACT_ORDER.getCode(), dto.getId(), "添加评论"))

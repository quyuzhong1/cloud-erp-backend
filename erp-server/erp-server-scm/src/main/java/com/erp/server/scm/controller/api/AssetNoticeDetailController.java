...
@RestController
@LogSystemModule("")
@RequestMapping("/assetNoticeDetail")
public class AssetNoticeDetailController extends BaseController {
    ...
    */
    ...
    public ApiResult<BaseResultDTO.AddDTO> add(@RequestBody @Validated AssetNoticeDetailDTO.AddDTO dto) {
        return success(assetNoticeDetailService.add(dto));
    }
    ...
    */
    ...
    public ApiResult<?> update(@RequestBody @Validated AssetNoticeDetailDTO.UpdateDTO dto) {
        assetNoticeDetailService.update(dto);
        return success();
    }

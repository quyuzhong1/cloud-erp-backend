...
public class BiSalesModuleController extends BaseController {
    ...
    public ApiResult<Object> newAndOldSalesExportExcel(@RequestBody NewAndOldSalesSearchDTO.SearchDTO dto, HttpServletResponse response) {
    ...
    public ApiResult<Object> completionRateRankingExportExcel(@RequestBody CompletionRateRankingDTO.SearchDTO dto, HttpServletResponse response) {

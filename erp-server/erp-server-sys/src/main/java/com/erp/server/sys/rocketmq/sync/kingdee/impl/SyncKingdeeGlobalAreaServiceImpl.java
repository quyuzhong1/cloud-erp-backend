...
public class SyncKingdeeGlobalAreaServiceImpl implements SyncKingdeeGlobalAreaService {
    ...
    public String syncDataToKingdee(DictGlobalAreaEntity entity, String operate) {
    ...
    private String saveTask(DictGlobalAreaEntity entity, String operate, Map<String, Object> resultMap) {
        //添加推送任务

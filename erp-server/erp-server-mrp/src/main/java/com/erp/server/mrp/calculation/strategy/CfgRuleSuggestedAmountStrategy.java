...
@Component
public class CfgRuleSuggestedAmountStrategy implements CfgRuleSettingStrategy<CfgRuleCommonDTO.StrategyDTO, List<CfgRuleCommonDTO.StrategyResultDTO>> {
    ...
    public List<CfgRuleCommonDTO.StrategyResultDTO> process(CfgRuleCommonDTO.StrategyDTO strategyDTO) {
        List<CfgRuleCommonDTO.StrategyResultDTO> cfgRuleCommon = cfgRuleCommonService.getCfgRuleCommon(strategyDTO.getPlatformType(), CfgRuleCommonTypeEnum.SUGGEST.getCode());

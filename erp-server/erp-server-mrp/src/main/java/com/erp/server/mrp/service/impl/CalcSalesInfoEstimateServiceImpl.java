...
public class CalcSalesInfoEstimateServiceImpl extends SuperServiceImpl<CalcSalesInfoEstimateMapper, CalcSalesInfoEstimateEntity> implements CalcSalesInfoEstimateService {
    ...
    @Override
    public List<CalcSalesInfoEstimateEntity> listByCalcSalesInfoIdsAndDate(List<String> dimIds, LocalDate startCalcDate, LocalDate endCalcDate) {
        List<CalcSalesInfoEstimateEntity> list = list(Wrappers.<CalcSalesInfoEstimateEntity>lambdaQuery()
                .in(CalcSalesInfoEstimateEntity::getCalcSalesInfoDimId, dimIds)
                .between(CalcSalesInfoEstimateEntity::getDate, startCalcDate, endCalcDate)
        );

...
public class CfgRuleWarehouseDetailServiceImpl extends SuperServiceImpl<CfgRuleWarehouseDetailMapper, CfgRuleWarehouseDetailEntity> implements CfgRuleWarehouseDetailService {
    ...
    */
    ...
    public Boolean update(List<CfgRuleWarehouseDetailDTO.UpdateDTO> cfgLocalWarehouseList,String mainId,String type,Boolean isVirtual) {
        ...
        //日志
        addOperateLog(list,warehouseEntityList,mainId,virtualWarehouseIdList,ruleWarehouseEntity);
     ...
     */
    private void addOperateLog (List<CfgRuleWarehouseDetailEntity> list,List<WarehouseEntity> warehouseEntityList
            , String mainId,List<String> virtualWarehouseIdList,CfgRuleWarehouseEntity ruleWarehouseEntity) {
        /**
         * 1、启用虚拟仓时添加虚拟仓日志，否则添加实体仓日志
         * 2、启用海外仓时添加海外仓日志
         */

...
public class SystemStrategy implements SalesEstimateStrategy {
     ...
     */
    public static CfgRuleSalesQtyDTO.StrategyFormulaResultDTO getStrategyFormulaResultDTO(List<CfgRuleSalesQtyDTO.StrategyFormulaResultDTO> formulaResults, LocalDate calcDate, List<CfgRuleSalesQtyDTO.StrategyFormulaResultDTO> defaultFormulaResults) {

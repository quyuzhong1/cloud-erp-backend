...
public class KolB2bApplicationController extends BaseController {
    ...
    */
    @PostMapping("/add")
    @LogAction(value = LogActionEnum.INSERT, desc = "B2B寄养申请主表新增")
    ...
    */
    @PostMapping("/update")
    @LogAction(value = LogActionEnum.UPDATE, desc = "B2B寄养申请主表修改")
    ...
    */
    ...
    @DataPermission(operationType = DataAttributeEnum.CHECK_BY_ID,
            ...
            serviceClass = KolB2bApplicationService.class,
            keyIdName = "ids")
    @LogAction(value = LogActionEnum.SUBMIT, desc = "B2B寄养申请主表提交审核")
    public ApiResult<List<BatchResultDTO>> batchSubmit(@RequestBody @Validated BaseIdsDTO.IdsDTO dto) {
        ...
        for (String id : dto.getIds()) {
            ...
            try {
                ...
                log.error("B2B寄养申请主单 提交审核失败",e);
                KolB2bApplicationEntity entity = idEntityMap.get(id);
                if (ObjectUtil.isEmpty(entity)) {
                    submit = BatchResultDTO.fail(id, id, "B2B寄养申请主单不存在, 提交失败");
    ...
    */
    ...
    @DataPermission(operationType = DataAttributeEnum.CHECK_BY_ID,
            ...
            serviceClass = KolB2bApplicationService.class,
            keyIdName = "ids")
    @LogAction(value = LogActionEnum.APPROVE, desc = "B2B寄养申请主表审核")
    public ApiResult<List<BatchResultDTO>> batchApprove(@RequestBody @Validated BaseApproveParamDTO dto) {
        ...
        for (String id : ids) {
            ...
            try {
                ...
                log.error("B2B寄养申请主单审核失败",e);
                KolB2bApplicationEntity entity = idEntityMap.get(id);
                if (ObjectUtil.isEmpty(entity)) {
                    approveResult = BatchResultDTO.fail(id, id, "B2B寄养申请主单不存在, 审核失败");
    ...
    */
    ...
    @DataPermission(operationType = DataAttributeEnum.CHECK_BY_ID,
            ...
            serviceClass = KolB2bApplicationService.class,
            keyIdName = "ids")
    @LogAction(value = LogActionEnum.DISAPPROVE, desc = "B2B寄养申请主表反审核")
    public ApiResult<List<BatchResultDTO>> batchDisApprove(@RequestBody @Validated BaseIdsDTO.IdsDTO dto) {
        ...
        for (String id : dto.getIds()) {
            ...
            try {
                ...
                log.error("B2B寄养申请主单反审核失败",e);
                KolB2bApplicationEntity entity = idEntityMap.get(id);
                if (ObjectUtil.isEmpty(entity)) {
                    disApproveResult = BatchResultDTO.fail(id, id, "B2B寄养申请主单不存在, 反审核失败");
    ...
    */
    ...
    @DataPermission(operationType = DataAttributeEnum.CHECK_BY_ID,
            ...
            serviceClass = KolB2bApplicationService.class,
            keyIdName = "ids")
    @LogAction(value = LogActionEnum.DELETE, desc = "B2B寄养申请主表删除")
    public ApiResult<List<BatchResultDTO>> batchDelete(@RequestBody @Validated BaseIdsDTO.IdsDTO dto) {
        ...
        for (String id : dto.getIds()) {
            ...
            try {
                ...
                log.error("B2B寄养申请主单删除失败",e);
                KolB2bApplicationEntity entity = idEntityMap.get(id);
                if (ObjectUtil.isEmpty(entity)) {
                    deleteResult = BatchResultDTO.fail(id, id, "B2B寄养申请主单不存在, 删除失败");
    ...
    */
    ...
    @DataPermission(operationType = DataAttributeEnum.CHECK_BY_ID,
            ...
            serviceClass = KolB2bApplicationService.class,
            keyIdName = "ids")
    @LogAction(value = LogActionEnum.INVALID, desc = "B2B寄养申请主表作废")
    public ApiResult<List<BatchResultDTO>> batchInvalid(@RequestBody @Validated BaseIdsDTO.RemarkDTO dto) {
        ...
        for (String id : dto.getIds()) {
            ...
            try {
                ...
                log.error("B2B寄养申请主单作废失败",e);
                KolB2bApplicationEntity entity = idEntityMap.get(id);
                if (ObjectUtil.isEmpty(entity)) {
                    invalidResult = BatchResultDTO.fail(id, id, "B2B寄养申请主单不存在, 作废失败");
    ...
    */
    ...
    @DataPermission(operationType = DataAttributeEnum.CHECK_BY_ID,
            ...
            serviceClass = KolB2bApplicationService.class,
            keyIdName = "ids")
    @LogAction(value = LogActionEnum.CANCEL, desc = "B2B寄养申请主表撤销")
    public ApiResult<List<BatchResultDTO>> batchCancelProcess(@RequestBody @Validated BaseIdsDTO.IdsDTO dto) {
        ...
        for (String id : dto.getIds()) {
            ...
            try {
                ...
                log.error("B2B寄养申请主单撤回流程失败",e);
                KolB2bApplicationEntity entity = idEntityMap.get(id);
                if (ObjectUtil.isEmpty(entity)) {
                    cancelResult = BatchResultDTO.fail(id, id, "B2B寄养申请主单不存在, 撤回流程失败");
    ...
    */
    ...
    @LogAction(value = LogActionEnum.EXPORT, desc = "B2B寄养申请主表导出Excel数据")
    ...
    public ApiResult<Object> downloadTemplate(HttpServletRequest request, HttpServletResponse response) {
        String path = "classpath:excel/kolB2bApplicationTemplate.xlsx";
     ...
     * @return ApiResult<Object>
     */
    @LogAction(value = LogActionEnum.EXPORT, desc = "导入Excel数据")
    @PostMapping("/import")
    ...
    public ApiResult<Boolean> generateSoInfo(@RequestBody @Validated KolB2bApplicationDTO.GenerateSoInfoDTO dto) {
        Boolean result = kolB2bApplicationService.generateSoInfo(dto);
        return result ? success() : failure();
    }
    ...
    public ApiResult<Boolean> generateFeedback(@RequestBody @Validated KolB2bApplicationDTO.GenerateFeedbackDTO dto) {
        Boolean result = kolB2bApplicationService.generateFeedback(dto);
        return result ? success() : failure();
    }

...
public class SyncKingdeeCustomerB2cContactServiceImpl implements SyncKingdeeCustomerB2cContactService {
    ...
    public void syncDataToKingdee(CustomerB2cContactEntity entity, String operate) {
        ...
        //更新同步状态为待同步
        customerB2cContactService.updateSyncKingdeeStatus(entity.getId(),SyncKingdeeStatusEnum.TO_BE_SYNC.getCode(),"",operate);
        ...
        CompletableFuture.supplyAsync(() -> {
            ...
            if (result.getSendStatus().equals(SendStatus.SEND_OK)) {
                //mq发送成更新业务表状态及时间
                return customerB2cContactService.updateSyncKingdeeStatus(entity.getId(), SyncKingdeeStatusEnum.IN_SYNC.getCode(),"", operate);
            }
            return Boolean.TRUE;
        });
    }

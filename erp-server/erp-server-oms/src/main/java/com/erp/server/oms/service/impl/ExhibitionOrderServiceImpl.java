...
public class ExhibitionOrderServiceImpl extends SuperServiceImpl<ExhibitionOrderMapper, ExhibitionOrderEntity> implements ExhibitionOrderService {
    ...
    public BaseResultDTO.AddDTO add(ExhibitionOrderDTO.AddDTO addDTO) {
        ...
        operateLogService.addModuleOperateLog(msg, null, exhibitionOrderEntity.getId(), "新增操作");
        // TODO 新增明细（如果有明细的话）

        return new BaseResultDTO.AddDTO(exhibitionOrderEntity.getId(), code);
    }
    ...
    */
    ...
    public Boolean update(ExhibitionOrderDTO.UpdateDTO addOrUpdateDTO) {
        ...
        // 记录主单操作日志
            ...
            String msg = StrUtil.format("用户【{}】编辑单号为【{}】的【{}】单据 ", UserContext.getDefaultLoginUser().getUserName(), exhibitionOrderEntity.getCode(), "展会订单信息");
        // TODO 此处的null需修改为日志模块类型，moduleType查看ModuleTypeEnum枚举类
        operateLogService.addModuleOperateLogByObj(old, exhibitionOrderEntity, null, exhibitionOrderEntity.getId(), msg);
        return Boolean.TRUE;
    }
    ...
    public List<ExhibitionOrderDTO.TabListDTO> tabList(PermissionsDTO param) {
        ...
        statusList.parallelStream().forEach(status -> {
            ...
            list.add(new ExhibitionOrderDTO.TabListDTO(status, 0));
        }
        });
        list.add(new ExhibitionOrderDTO.TabListDTO("all", list.stream().mapToInt(ExhibitionOrderDTO.TabListDTO::getCount).sum()));
        // 计算合计数量
        return list;
    }

    @Override
    public void exportList(ExhibitionOrderDTO.ExportDTO param, HttpServletResponse response) {
        List<ExhibitionOrderDTO.ListDTO> list = this.baseMapper.listExport(param);
        ...
        String excelPath = "excel/exhibitionOrder.xlsx";
        String name = "展会订单信息导出";
    ...
    */
    ...
    public BatchResultDTO delete(String id) {
        ...
        operateLogService.addModuleOperateLog(msg, null, entity.getCode(), "删除展会订单信息数据");
    ...
    */
    ...
    public ExhibitionOrderDTO.ViewDTO view(String id) {
        ...
        ExhibitionOrderDTO.ViewDTO data = BeanMapperUtils.map(ExhibitionOrderDTO.ViewDTO.class, exhibitionOrderEntity);
        // 数据填充处理
        fillOne(data);
        // TODO 查询明细数据（如果有的话）
        return data;
    ...
    **/
    ...
    private void fillOne(ExhibitionOrderDTO.ViewDTO data) {
    ...
    */
    private void fillList(List<ExhibitionOrderDTO.ListDTO> list) {
        ...
        // 属性赋值
        for(ExhibitionOrderDTO.ListDTO data : list) {

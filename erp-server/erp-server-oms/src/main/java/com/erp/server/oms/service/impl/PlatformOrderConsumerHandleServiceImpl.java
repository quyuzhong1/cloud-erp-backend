...
//        }
        ...
        //如果已发货且仓库为空且是平台仓订单
        if (isShipped && isWarehouseEmpty && hasPlatformWarehouse && !PlatformDictEnum.ALI_EXPRESS.getCode().equals(mainEntity.getDictPlatform()) && !PlatformDictEnum.SHOPEE.getCode().equals(mainEntity.getDictPlatform())) {

...
@Component
public class FullyManagedQueryHandler extends AbstractQueryHandler {
    ...
    private String getPlatformWarehouseDeliverySql() {
        return " ( " +
                ...
                " or " +
                " ((sb2c.dict_platform is null or sb2c.dict_platform <> 'TikTok') and (sb2c.label_json ~ 'AFN' or sb2c.label_json ~ 'cainiaoInternationalWarehouse' or sb2c.label_json ~ 'WFSFulfilled' or sb2c.label_json ~ '3PLFulfilled' or sb2c.label_json ~ 'fulfillment' or sb2c.label_json ~ 'fulfilled_by_shopee')) " +
                " ) ";
    }
    ...
    private String getNotPlatformWarehouseDeliverySql() {
        return " ( " +
                ...
                " or " +
                " ((sb2c.dict_platform is null or sb2c.dict_platform <> 'TikTok') and sb2c.label_json !~ ('AFN|cainiaoInternationalWarehouse|WFSFulfilled|3PLFulfilled|fulfillment|fulfilled_by_shopee')) " +
                " ) ";
    }
    ...
    public String getTabSql (Object value) {
        ...
        if (FullyManagedTabEnum.ENUM_PENDING.getCode().equals(value)) {
        ...
        //待审核
        if (FullyManagedTabEnum.ENUM_APPROVE_ING.getCode().equals(value)) {
            payStatusList.add(SoB2cPayStatusEnum.ENUM_PAID.getCode());
        ...
        //配货中
        if (FullyManagedTabEnum.ENUM_IN_DISTRIBUTION.getCode().equals(value)) {
            payStatusList.add(SoB2cPayStatusEnum.ENUM_PAID.getCode());
        ...
        //待发货
        if (FullyManagedTabEnum.ENUM_WAIT_SHIPPED.getCode().equals(value)) {
            payStatusList.add(SoB2cPayStatusEnum.ENUM_PAID.getCode());
            approveStatusList.add(ApproveStatusEnum.APPROVE.getStatus());
        ...
        //已发货
        if (FullyManagedTabEnum.ENUM_SHIPPED.getCode().equals(value)) {
            payStatusList.add(SoB2cPayStatusEnum.ENUM_PAID.getCode());
            approveStatusList.add(ApproveStatusEnum.APPROVE.getStatus());
        ...
        //已作废
        if (FullyManagedTabEnum.ENUM_INVALID.getCode().equals(value)) {
            payStatusList.add(SoB2cPayStatusEnum.ENUM_PAID.getCode());
            super.buildSplicingSQLDTO("sb2c.invalid_status", QueryConditionEnum.EQ,true, QueryDataTypeEnum.BOOLEAN);
        }
        //订单异常
        if (FullyManagedTabEnum.ENUM_ORDER_ERROR.getCode().equals(value)) {
            payStatusList.add(SoB2cPayStatusEnum.ENUM_PAID.getCode());

 ...
 */
@Component
public class SoPriceQueryHandler extends AbstractQueryHandler {
    ...
    public String getTabSql (Object value) {
        ...
        if (PurchasePriceTabFlagEnum.APPROVE_ING.getCode().equals(value)) {
            ...
            //需要审核的业务ids
            List<String> businessIds = commonService.listProcessCurBusinessIds(SourceTypeEnum.SO_PRICE.getCode());

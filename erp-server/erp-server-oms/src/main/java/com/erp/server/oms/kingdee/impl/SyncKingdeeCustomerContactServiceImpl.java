...
public class SyncKingdeeCustomerContactServiceImpl implements SyncKingdeeCustomerContactService {
    ...
    public String syncDataToKingdee(CustomerContactEntity entity, String operate) {
     ...
     * @param resultMap
     */
    private String saveTask (CustomerContactEntity entity, String operate, Map<String, Object> resultMap) {
        //添加推送任务

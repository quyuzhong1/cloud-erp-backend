...
public class NewPlatformRestCloudReturnOrderConsumerService extends AbstractRestCloudPlatformConsumerHandler {
    @Resource
    private NewPlatformReturnOrderConsumerService platformReturnOrderConsumerService;

    @Override
    public String getBizName() {
        return "restCloud平台退货订单";
    }

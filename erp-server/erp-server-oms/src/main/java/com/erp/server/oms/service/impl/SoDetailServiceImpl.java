...
public class SoDetailServiceImpl extends SuperServiceImpl<SoDetailMapper, SoDetailEntity> implements SoDetailService {
     ...
     */
    @Override
    public void updateSoDetail(String mainId, Boolean isTax, List<SoDetailDTO.UpdateDTO> detailList, boolean isChangeVirtual) {
        ...
        checkSoDetailQty(dbList,updateList,removeList,isChangeVirtual);
...
//        }
    ...
    public void calCost(List<SkuVO> skuList, LocalDate saleOrderBillDate, SoDetailEntity item, Boolean isBrush) {
        ...
        if (Objects.nonNull(purchasePrice) &&
            ...
            String billDate = saleOrderBillDate.format(DateTimeFormatter.ofPattern("yyyy-MM-dd"));
            BigDecimal rate = dmpTaskFeign.getRate(billDate, supplierSkuPrice.getCurrency());
...
//        List<DmpSkuCostEntity> dmpSkuCostList = dmpTaskFeign.listRedisBySkuNoList(Arrays.asList(item.getSkuNo()));
     ...
     * @param removeList
     */
    private void checkSoDetailQty ( List<SoDetailEntity> dbList,List<SoDetailDTO.UpdateDTO> updateList,List<SoDetailEntity> removeList,Boolean isChangeVirtual) {

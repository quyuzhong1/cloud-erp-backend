...
@Slf4j
@Component
@PlatformSoB2cAnnotate(method = PlatformDictEnum.WALMART)
public class WalmartSoB2cHandle implements ISoB2cHandleService{
    ...
    public Boolean handleRule(SoB2cEntity mainEntity) {
        ...
        try {
            ...
            log.error("[沃尔玛订单规则处理失败]:order={},msg={}", mainEntity.getPlatformCode(), e.getMessage());
        }
        return true;
    }

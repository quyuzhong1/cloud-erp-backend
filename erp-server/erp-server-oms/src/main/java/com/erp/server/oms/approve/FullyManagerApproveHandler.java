...
@Slf4j
@Component
@ApproveBusinessKey(SourceTypeEnum.TIK_TOK_FULLY)
public class FullyManagerApproveHandler extends AbstractApproveHandler {
    ...
    public Boolean approveEnd(ApproveDTO.EndProcessDTO dto) {
        ...
        //添加日志
        return operateLogService.addModuleOperateLog(CharSequenceUtil.format("【{}】审核，审核【{}】了一全托管订单", dto.getApprovePlatformEnum().getName(),ApproveTypeEnum.getName(dto.getApproveStatus().getStatus())), ModuleTypeEnum.SO_B2C.getCode(),dto.getBusinessId(), "审核操作");
    }

...
public class SyncKingdeeCustomerB2cServiceImpl implements SyncKingdeeCustomerB2cService {
    ...
    public void syncDataToKingdee(CustomerB2cEntity entity, String operate) {
        ...
        //更新同步状态为待同步
        customerB2cService.updateSyncKingdeeStatus(entity.getId(),SyncKingdeeStatusEnum.TO_BE_SYNC.getCode(),"",operate);
...
/*        List<SellerDTO.ViewDTO> sellerList = customerSellerService.listByMainId(entity.getId());
        ...
        CompletableFuture.supplyAsync(() -> {
            ...
            if (result.getSendStatus().equals(SendStatus.SEND_OK)) {
                ...
                //mq发送成更新业务表状态及时间
                return customerB2cService.updateSyncKingdeeStatus(entity.getId(), SyncKingdeeStatusEnum.IN_SYNC.getCode(), "", operate);
            }
            return Boolean.TRUE;
        });
    }

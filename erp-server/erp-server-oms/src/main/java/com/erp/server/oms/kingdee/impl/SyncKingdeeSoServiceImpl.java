...
public class SyncKingdeeSoServiceImpl implements SyncKingdeeSoService {
    ...
    public void syncDataToKingdee(SoInfoEntity entity, String operate) {
        ...
        finance.put("discountAmount", Objects.nonNull(entity.getDiscountAmount()) ? entity.getDiscountAmount() : BigDecimal.ZERO);
        ...
        for (SoDetailDTO.ViewDTO item : details) {
            ...
            jsonObject.set("discountAmount", Objects.nonNull(item.getDiscountAmount()) ? item.getDiscountAmount() : BigDecimal.ZERO);
            list.add(jsonObject);
        }

...
public class InvoiceInfoServiceImpl extends SuperServiceImpl<InvoiceInfoMapper, InvoiceInfoEntity> implements InvoiceInfoService {
    ...
    */
    ...
    public BatchResultDTO batchGenerateNfeInvoice(String id) {
        ...
        //添加日志
        operateLogService.addModuleOperateLog(CharSequenceUtil.format("销售订单【{}】生成NF-e发票",soB2cEntity.getCode()), ModuleTypeEnum.SO_B2C.getCode(), soB2cEntity.getId(), "生成NF-e发票操作");

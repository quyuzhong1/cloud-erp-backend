...
public class InvoiceInfoServiceImpl extends SuperServiceImpl<InvoiceInfoMapper, InvoiceInfoEntity> implements InvoiceInfoService {
    ...
    */
    ...
    public List<BatchResultDTO> batchGenerateInvoice(List<String> ids) {
        ...
        service.updateBatchById(waitCreateVoiceList);
        //开票成功并且配置为自动上传的，上传发票
        List<InvoiceInfoEntity> uploadInvoiceList = autoUploadInvoice(waitCreateVoiceList, cfgVatInvoiceEntities, soB2cEntityList, resultDTOList);
        service.updateBatchById(uploadInvoiceList);

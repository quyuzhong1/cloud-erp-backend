...
public class ShippingApiTest {
    ...
    private final ShippingApi api = amazonAuthorizationGrant(new AmazonAuthorConfigDTO());

    public ShippingApi amazonAuthorizationGrant(AmazonAuthorConfigDTO authorConfigDTO) {

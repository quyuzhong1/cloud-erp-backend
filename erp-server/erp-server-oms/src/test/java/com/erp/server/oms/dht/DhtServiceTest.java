...
public class DhtServiceTest {
    ...
    public void getUserByMobile() {
        DhtUserResp resp = dhtService.getUserByMobile("15007174733");
        System.out.println(JSONUtil.toJsonStr(resp));
    }
...
//                        .salesOrganization("ORG01")
        ...
        DhtBaseResp<String> resp = dhtService.createCustomer(dhtOperationCustomerReq);
        System.out.println(JSONUtil.toJsonStr(resp));
    }
...
//                        .salesOrganization("ORG01")
                ...
                .build());
        dhtOperationCustomerReq.setData(dataDTO);
        DhtBaseResp<String> resp = dhtService.updateCustomer(dhtOperationCustomerReq);
        System.out.println(JSONUtil.toJsonStr(resp));
    }
    ...
    public void queryCustomer() {
        ...
        DhtQueryCustomerReq.DataDTO dataDTO = DhtQueryCustomerReq.DataDTO.builder()
                ...
                .build();
        req.setData(dataDTO);
        DhtBaseResp<DhtQueryCustomerResp> resp = dhtService.queryCustomer(req);
        System.out.println(JSONUtil.toJsonStr(resp));
    }
    ...
    public void invalidCustomer() {
        ...
        DhtInvalidCustomerReq.DataDTO dataDTO = DhtInvalidCustomerReq.DataDTO.builder()
                ...
                .build();
        req.setData(dataDTO);
        DhtBaseResp<String> resp = dhtService.invalidCustomer(req);
        System.out.println(JSONUtil.toJsonStr(resp));
    }
    ...
    public void enableCustomer() {
        ...
        DhtEnableCustomerReq.DataDTO dataDTO = DhtEnableCustomerReq.DataDTO.builder()
                ...
                .build();
        req.setData(dataDTO);
        DhtBaseResp<String> resp = dhtService.enableCustomer(req);
        System.out.println(JSONUtil.toJsonStr(resp));
    }
    ...
    public void deleteCustomer() {
        ...
        DhtDeleteCustomerReq.DataDTO dataDTO = DhtDeleteCustomerReq.DataDTO.builder()
                ...
                .build();
        req.setData(dataDTO);
        DhtBaseResp<String> resp = dhtService.deleteCustomer(req);
        System.out.println(JSONUtil.toJsonStr(resp));
    }
}
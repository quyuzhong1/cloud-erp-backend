...
import static com.common.business.enums.FileTaskEventEnum.EXPORT_WMS_INVENTORY_DAILY_LOCATION;

@Component
@Slf4j
public class ExportWmsInventoryDailyLocationHandler extends AbstractPageFileEventHandler<InventoryReportDTO.ListDailyInventoryDTO, InventoryReportDTO.DailyInventoryParamDTO> {
    ...
    public FileTaskEventEnum getEvent() {
        return EXPORT_WMS_INVENTORY_DAILY_LOCATION;
    }

    @Override
    public String getExcelPath() {
        return "excel/wms/dailyInventoryLocation.xlsx";
    }
}

...
@Component
public class ExportDmpPushTaskHandler extends AbstractPageFileEventHandler<DmpPushTaskDTO.ListDTO, DmpPushTaskDTO.ParamDTO> {
    ...
    protected PagingVO<DmpPushTaskDTO.ListDTO> getPageData(PagingDTO<DmpPushTaskDTO.ParamDTO> dto) {
        return exportDmpFeign.exportPushTask(dto);
    }

    @Override
    public FileTaskEventEnum getEvent() {
        return EXPORT_PUSH_TASK;
    }

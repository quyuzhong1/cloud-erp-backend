...
@Component
@Slf4j
public class ExportPlmMoldMonitorReturnHandler extends AbstractPageFileEventHandler<MoldMonitorDTO.ListDTO, MoldMonitorDTO.PagingParamDTO> {
    ...
    protected String getExcelPath() {
        return "excel/plm/moldMonitorReturn.xlsx";
    }

    @Override
    public FileTaskEventEnum getEvent() {
        return EXPORT_PLM_MOLD_MONITOR_RETURN;
    }
}

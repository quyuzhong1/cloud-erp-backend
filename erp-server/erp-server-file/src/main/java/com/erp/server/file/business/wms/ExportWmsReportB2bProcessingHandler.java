...
@Component
@Slf4j
public class ExportWmsReportB2bProcessingHandler extends AbstractPageFileEventHandler<ReportProcessingDTO.ListDTO,ReportProcessingDTO.PagingParamDTO> {
    ...
    protected PagingVO<ReportProcessingDTO.ListDTO> getPageData(PagingDTO<ReportProcessingDTO.PagingParamDTO> dto) {
        return exportWmsFeign.exportTotalB2bProcessing(dto);
    }

    @Override
    public FileTaskEventEnum getEvent() {
        return EXPORT_WMS_B2B_TOTAL_PROCESSING_EXPORT;
    }

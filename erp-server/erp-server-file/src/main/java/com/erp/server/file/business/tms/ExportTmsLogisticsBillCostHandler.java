...
@Component
@Slf4j
public class ExportTmsLogisticsBillCostHandler extends AbstractPageFileEventHandler<LogisticsBillCostDTO.ListDTO, LogisticsBillCostDTO.PagingParamDTO> {
    @Resource
    ...
    public FileTaskEventEnum getEvent() {
        return EXPORT_TMS_LOGISTICS_BILL_COST;
    }
    ...
    protected PagingVO<LogisticsBillCostDTO.ListDTO> getPageData(PagingDTO<LogisticsBillCostDTO.PagingParamDTO> dto) {
        return exportTmsFeign.exportLogisticsBillCost(dto);
    }
}

...
@Component
public class ExportDmpPullTaskHandler extends AbstractPageFileEventHandler<DmpPullTaskDTO.ListDTO, DmpPullTaskDTO.ParamDTO> {
    ...
    protected PagingVO<DmpPullTaskDTO.ListDTO> getPageData(PagingDTO<DmpPullTaskDTO.ParamDTO> dto) {
        return exportDmpFeign.exportPullTask(dto);
    }

    @Override
    public FileTaskEventEnum getEvent() {
        return EXPORT_PULL_TASK;
    }
}

...
@Component
@Slf4j
public class ExportOmsShopHandler extends AbstractPageFileEventHandler<ShopDTO.PagingViewDTO, ShopDTO.ExportDTO> {
    ...
    protected PagingVO<ShopDTO.PagingViewDTO> getPageData(PagingDTO<ShopDTO.ExportDTO> dto) {
        return exportOmsFeign.exportShop(dto);
    }

    @Override
    public FileTaskEventEnum getEvent() {
        return EXPORT_OMS_SHOP;
    }

    @Override
    public String getExcelPath() {
        return "excel/oms/ShopInfo.xlsx";
    }
}

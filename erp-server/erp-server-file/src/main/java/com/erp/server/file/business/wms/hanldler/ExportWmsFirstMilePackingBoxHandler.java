...
@Component
@Slf4j
public class ExportWmsFirstMilePackingBoxHandler extends AbstractPageFileEventHandler<WmsCartonDetailDTO.ListPackingDetailDTO, PackingTaskDTO.ExportDTO> {
    ...
    public FileTaskEventEnum getEvent() {
        return EXPORT_WMS_FIRST_MILE_PACKING_BOX;
    }

    @Override
    public String getExcelPath() {
        return "excel/wms/firstMilePackingBoxExport.xlsx";
    }
}

...
public class ExportPlmProductForbiddenWordHandler extends AbstractPageFileEventHandler<CfgProductForbiddenWordExportExcelDTO, CfgProductForbiddenWordDTO.PagingParamDTO> {
    ...
    @Override
    protected List<CfgProductForbiddenWordExportExcelDTO> getData(FileTask fileTask) {
        CfgProductForbiddenWordDTO.PagingParamDTO dto = readValue(fileTask.getMetaInfo(), new TypeReference<CfgProductForbiddenWordDTO.PagingParamDTO>() {
        });

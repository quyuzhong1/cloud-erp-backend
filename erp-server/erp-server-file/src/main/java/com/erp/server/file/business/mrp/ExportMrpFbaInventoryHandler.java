...
import static com.common.business.enums.FileTaskEventEnum.EXPORT_MRP_FBA_INVENTORY;
...
public class ExportMrpFbaInventoryHandler extends AbstractPageFileEventHandler<FbaHistoryInventoryDTO.ListDTO, FbaHistoryInventoryDTO.ExportDTO> {
    ...
    public FileTaskEventEnum getEvent() {
        return EXPORT_MRP_FBA_INVENTORY;
    }

    @Override
    public String getExcelPath() {
        return "excel/mrp/fbaHistoryInventory.xlsx";
    }
}

...
@Component
@Slf4j
public class ExportWmsPackingTaskDetailHandler extends AbstractPageFileEventHandler<WmsCartonDetailDTO.ListPackingDetailDTO, PackingTaskDTO.ExportDTO> {
    ...
    public FileTaskEventEnum getEvent() {
        return EXPORT_WMS_PACKING_TASK_DETAIL;
    }

...
public class ExportWmsInitStockHandler extends AbstractPageFileEventHandler<InitStockDTO.ListDTO, InitStockDTO.ExportSearchParamDTO> {
    ...
    @Override
    protected List<InitStockDTO.ListDTO> getData(FileTask fileTask) {
        InitStockDTO.ExportSearchParamDTO dto = readValue(fileTask.getMetaInfo(), new TypeReference<InitStockDTO.ExportSearchParamDTO>() {
        });

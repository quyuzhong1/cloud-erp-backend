...
@Component
@Slf4j
public class ExportTmsCfgSailingHandler extends AbstractPageFileEventHandler<TmsCfgSailingDTO.ListDTO, TmsCfgSailingDTO.PagingParamDTO> {

    @Resource
    private ExportTmsFeign exportTmsFeign;

    @Override
    protected PagingVO<TmsCfgSailingDTO.ListDTO> getPageData(PagingDTO<TmsCfgSailingDTO.PagingParamDTO> dto) {
    ...
    protected String getExcelPath() {
        return "excel/tms/tmsCfgSailingExport.xlsx";
    }

    @Override
    public FileTaskEventEnum getEvent() {
        return EXPORT_TMS_CFG_SAILING;
    }
}

...
import static com.common.business.enums.FileTaskEventEnum.EXPORT_PLM_PRODUCT_ALL;

@Component
@Slf4j
public class ExportPlmProductAllHandler extends AbstractPageFileEventHandler<BomExportExcelVO, SearchPagingDTO> {
    @Resource

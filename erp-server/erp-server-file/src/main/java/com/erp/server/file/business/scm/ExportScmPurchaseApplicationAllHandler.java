...
@Component
@Slf4j
public class ExportScmPurchaseApplicationAllHandler extends AbstractPageFileEventHandler<PurchaseApplicationDTO.ListDTO, PurchaseApplicationDTO.SearchParamDTO> {
    @Resource
    ...
    public FileTaskEventEnum getEvent() {
        return EXPORT_SCM_PURCHASE_APPLICATION_ALL;
    }

    @Override
    public String getExcelPath() {
        return "excel/scm/purchaseApplicationAll.xlsx";
    }
}

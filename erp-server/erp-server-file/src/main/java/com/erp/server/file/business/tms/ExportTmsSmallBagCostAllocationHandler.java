...
@Component
@Slf4j
public class ExportTmsSmallBagCostAllocationHandler extends AbstractPageFileEventHandler<SmallBagCostAllocationDTO.ListDTO, SmallBagCostAllocationDTO.PagingParamDTO> {
    @Resource
    private ExportTmsFeign exportTmsFeign;

    @Override
    public String getExcelPath() {
        return "excel/tms/smallBagCostAllocation.xlsx";
    }

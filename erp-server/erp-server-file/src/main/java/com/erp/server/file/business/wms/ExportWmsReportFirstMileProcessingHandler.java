...
import static com.common.business.enums.FileTaskEventEnum.EXPORT_WMS_FIRST_MILE_TOTAL_PROCESSING_EXPORT;

@Component
@Slf4j
public class ExportWmsReportFirstMileProcessingHandler extends AbstractPageFileEventHandler<ReportProcessingDTO.ListDTO,ReportProcessingDTO.PagingParamDTO> {
    ...
    protected PagingVO<ReportProcessingDTO.ListDTO> getPageData(PagingDTO<ReportProcessingDTO.PagingParamDTO> dto) {
        return exportWmsFeign.exportTotalFirstMileProcessing(dto);
    }

    @Override
    public FileTaskEventEnum getEvent() {
        return EXPORT_WMS_FIRST_MILE_TOTAL_PROCESSING_EXPORT;
    }

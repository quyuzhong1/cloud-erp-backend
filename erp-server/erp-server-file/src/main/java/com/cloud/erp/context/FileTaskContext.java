...
import com.cloud.erp.repository.IFileTaskRepository;
import com.cloud.erp.utils.ExceptionUtils;
...
public class FileTaskContext {
    ...
    public void delete(String id) {
        ...
        LoginUser currentUser = userService.getCurrentUser();
    ...
    public void process(String id) {
        ...
        if (!ObjectUtils.isEmpty(fileTask) && fileTask.isPending()) {
            ...
            try {
                ...
                log.info("文件任务[{}]已完成,状态为[{}],总耗时[{}]", fileTask.getId(), fileTask.getStatus(), Duration.between(fileTask.getStartTime(), fileTask.getFinishTime()).getSeconds());
                fileTaskRepository.updateById(fileTask);
            }
        } else {

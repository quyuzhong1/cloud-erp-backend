...
//            FindIterable<Document> orderCollection = orderCollection.find(new Document("amazonOrderId", fulfillmentOrderNo1));
            ...
            for (AmazonOrderEntity entity : resultList) {
                ...
                set.add("update dmp_so_info set update_time = now(), all_amount = '" + all_amount + "',total_discount = "+  total_discount + " where third_code = '"+ amazonOrderId + "' and shop_id = '"+ shopId + "'  and source_system = 'Amazon' and source_platform = 'Amazon' and is_deleted = 'f';");
            }


            String url = "C:\\Users\\Jim\\Desktop\\amazon_order\\amazon_order_"+ dbName +".sql";

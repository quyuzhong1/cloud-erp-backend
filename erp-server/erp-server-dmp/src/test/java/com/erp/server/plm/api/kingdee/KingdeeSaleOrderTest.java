 ...
 * 销售订单 测试
 */
public class KingdeeSaleOrderTest {
    public static void main(String[] args) {
        KingdeeApiUtils saleOrderApi=new KingdeeApiUtils("SAL_SaleOrder");

        // 列表字段
        String fieldKeys = "FID,FBillNo,FDocumentStatus,FReturnType,FRowType,FMaterialName,FMaterialGroup,FMaterialId,FMaterialId.FNumber,FMaterialModel,FQty,FPriceUnitQty,FUnitID,FAuxPropId,FPrice,FEntryTaxRate,FTaxPrice,FIsFree,FEntryTaxAmount,FMaterialType,FAmount,FBarcode,FMapName,F_ulz_BaseProperty,FMapId,FBaseUnitId,FOldQty,FTaxNetPrice,FDiscount,FPriceDiscount,FBranchId,FEntryNote,FSrcType,FSrcBillNo,FMinPlanDeliveryDate,FDeliveryStatus,F_ulz_Decimal,F_ulz_CGCB,FSOStockId.FName";

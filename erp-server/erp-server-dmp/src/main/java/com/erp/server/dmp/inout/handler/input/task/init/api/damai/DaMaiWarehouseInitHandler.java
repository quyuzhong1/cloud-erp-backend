...
@Service
@Scope("prototype")
public class DaMaiWarehouseInitHandler extends DmpInputInitHandler {
    ...
    public List<DmpInputTaskInitDTO> getInitData(DmpInputInitRequest dmpRequest, DmpInputTaskResponse dmpResponse) {
        ...
        DaMaiBaseResp<List<DaMaiWarehouseResp>> resp = daMaiService.getWarehouseList(overseasProviderEntity.getAuthJson());
        if(resp == null) {
            return Collections.emptyList();
        }
        if(!Objects.equals(resp.getStatus(), "success")) {
            throw new ServiceException("大卖仓获取仓库列表失败,msg:"+resp.getMsg());
        }

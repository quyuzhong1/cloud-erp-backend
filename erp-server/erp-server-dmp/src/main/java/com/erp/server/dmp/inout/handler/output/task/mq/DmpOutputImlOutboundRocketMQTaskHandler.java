...
@Service
@Scope("prototype")
public class DmpOutputImlOutboundRocketMQTaskHandler extends DmpOutputRocketMQTaskHandler{
    ...
    public PlatformOutboundDTO convert(DmpThirdOutboundEntity dmpThirdOutboundEntity , String cfgOutputId) {
		...
		String erpOrderStatus = ImlEnums.OrderStatusEnum.getErpOrderStatus(orderStatus);

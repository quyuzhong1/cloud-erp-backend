...
//public class AmzReportFbaMyiAllInventoryHandler extends AmzReportSaveMongoHandler {
//
//    @Resource
...
//        List<ReportFbaMyiAllInventoryCsvEntity> list = JSONUtil.toList(jsonArray, ReportFbaMyiAllInventoryCsvEntity.class);
//        // 库存管理数据
//        // 查询当前店铺信息
...
//                .stream()
//                .map(ReportFbaMyiAllInventoryCsvEntity::getSku)
//                .distinct()

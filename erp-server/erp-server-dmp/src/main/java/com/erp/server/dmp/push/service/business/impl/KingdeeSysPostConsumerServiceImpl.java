...
/**
 * @author Lambda
 * @Classname KingdeeSysPostConsumerServiceImpl
 * @Description TODO
...
@Service
@Slf4j
public class KingdeeSysPostConsumerServiceImpl  implements KingdeeSysPostConsumerService {
    ...
    public void operateAddOrUpdate(KingdeeApiUtils apiUtils, PlatformEntity platformEntity, Map<String, Object> map, Integer type) {
        ...
        if (KingdeeDocStatusEnum.CREATED.getCode().equals(documentStatus) || KingdeeDocStatusEnum.REAPPROVE.getCode().equals(documentStatus) || flag) {
            //给修改json对象赋值ID
            KingdeeUtils.makeFieldJson(json, "FPOSTID", ".", id);
    ...
    public void operateDelete(KingdeeApiUtils apiUtils, PlatformEntity platformEntity, Map<String, Object> map, String operate) {
        //删除
        kingdeeCommonService.handleDelete(apiUtils,platformEntity,map,ApiModuleTypeEnum.SYS_POST.getCode(),operate);
        return;
    }
}

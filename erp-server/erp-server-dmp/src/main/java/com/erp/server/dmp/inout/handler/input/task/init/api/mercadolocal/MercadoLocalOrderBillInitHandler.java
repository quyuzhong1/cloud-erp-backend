...
public class MercadoLocalOrderBillInitHandler extends DmpInputInitHandler {
	...
	public List<DmpInputTaskInitDTO> getInitData(DmpInputInitRequest dmpRequest, DmpInputTaskResponse dmpResponse) {
		...
		for (Map<String, Object> findMongoDatum : findMongoData) {
			...
			String path = dmpCfgApiEntity.getApiType().replace("{order_id}", findMongoDatum.get("fid").toString());
			...
			BillViewDTO shipmentViewDTO = null;
			try {
			...
			shipmentViewDTO.setFid(findMongoDatum.get("fid").toString());

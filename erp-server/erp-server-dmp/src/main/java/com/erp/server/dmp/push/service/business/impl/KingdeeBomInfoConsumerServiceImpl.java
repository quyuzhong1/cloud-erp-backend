...
/**
 * @author Lambda
 * @Classname KingdeeBomInfoConsumerServiceImpl
 * @Description TODO
...
@Slf4j
@Service
public class KingdeeBomInfoConsumerServiceImpl implements KingdeeBomInfoConsumerService {
    @Resource
    ...
    @KingdeeApi(KingdeePushModuleEnum.ENG_BOM)

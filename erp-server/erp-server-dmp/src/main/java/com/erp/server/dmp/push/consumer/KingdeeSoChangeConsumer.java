...
@Service
@Slf4j
@RocketMQMessageListener(topic = RocketMqTopic.SYNC_KINGDEE_ERP_TOPIC, selectorExpression = "kingdee_so_change_tag", consumerGroup = RocketMqConsumerGroup.SYNC_KINGDEE_SO_CHANGE)
public class KingdeeSoChangeConsumer implements RocketMQListener<Map<String, Object>> {
    ...
    public static void main(String[] args) {
        ...
        queryFilters.add(String.format("FBillNo = '%s'", "XSD-20230403-35184_V001"));
        String filterStr = String.join(" and ", queryFilters);
        String fieldKeys = "FBillTypeID.FNUMBER,FBillTypeID.FNAME,FChangeType";

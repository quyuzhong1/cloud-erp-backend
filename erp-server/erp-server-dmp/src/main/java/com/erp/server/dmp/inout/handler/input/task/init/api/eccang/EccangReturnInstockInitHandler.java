...
@Service
@Scope("prototype")
public abstract class EccangReturnInstockInitHandler extends DmpInputInitHandler {
    ...
    public List<DmpInputTaskInitDTO> getInitData(DmpInputInitRequest dmpRequest, DmpInputTaskResponse dmpResponse) {
        ...
        while(true) {
            ...
            log.debug(getPlatForm().getName()+"退货信息请求:{}", returnReq);
            String response = AntuUtils.callService(getPlatForm() ,apiType,returnReq);
            log.debug(getPlatForm().getName()+"退货信息响应:{}", response);
    ...
    public abstract DmpBasicSystemCodeEnum getDmpBasicSystemCodeEnum();

...
/**
 * @author Lambda
 * @Classname KingdeeSoReturnConsumerServiceImpl
 * @Description TODO
 * @Date 2023-08-02 9:26
 * @Created by yl
 */
@Service
@Slf4j
public class KingdeeSoReturnConsumerServiceImpl implements KingdeeSoReturnConsumerService {
    @Resource
    private KingdeeCommonService kingdeeCommonService;

    @Override
    @Transactional(rollbackFor = Exception.class)
    @KingdeeApi(KingdeePushModuleEnum.SAL_RETURNSTOCK)
    ...
    public void operateDelete(KingdeeApiUtils apiUtils,PlatformEntity platformEntity,Map<String, Object> map,String operate) {
        //删除
        kingdeeCommonService.handleDelete(apiUtils,platformEntity,map,ApiModuleTypeEnum.SO_RETURN.getCode(),operate);
        return;
    }
}

...
@Service
@Scope("prototype")
public class EccangBoundDmpHandler extends DmpInputDbConvertDmpHandler {
	...
	protected void afterConvertData(Map<List<Map<String, Object>>, List<TreeMap<String, Object>>> dmpInputDataDmpRelationMaps) {
		...
		for(Map.Entry<List<Map<String, Object>>, List<TreeMap<String, Object>>> dmpInputDataDmpRelationMap : dmpInputDataDmpRelationMaps.entrySet()) {
		    ...
		    if(mongoData.containsKey("order_business_type")){
				String orderType = "B2C";
				String originOrderType = String.valueOf(mongoData.get("order_business_type"));
				if("b2b".equals(originOrderType)){
					orderType = "B2B";
				}
				for(TreeMap<String, Object> dmpDataMap : dmpDataMaps) {
					dmpDataMap.put("orderType", orderType);
				}
			}
		}
	}

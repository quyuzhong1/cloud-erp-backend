...
@Service
@Scope("prototype")
public class DmpOutputLxProductRocketMQTaskHandler extends DmpOutputRocketMQTaskHandler {
    ...
    public Map<String, String> getPushJsonDataMap(DmpOutputTaskRequest dmpRequest, DmpOutputTaskResponse dmpResponse) {
        ...
        for(String changId : changeIds) {
            ...
            if (CollectionUtils.isEmpty(dmpSkuInfoEntityList)){
                log.warn("领星Listing数据解析异常: dmpProductInfoEntity={}, skuEntityList={}", JSONUtil.toJsonStr(dmpProductInfoEntity), JSONUtil.toJsonStr(dmpSkuInfoEntityList));
                continue;
            }
    ...
    public PlatformProductDTO convert(DmpProductInfoEntity dmpProductInfoEntity , DmpSkuInfoEntity dmpSkuInfoEntity , String cfgOutputId) {
        ...
        // 平台唯一标识=平台skuId + 店铺ID
        product.setUniqueId(dmpSkuInfoEntity.getThirdId());
    ...
    protected List<String> getSourceCodeKeys() {
        return Collections.singletonList("thirdId");
    }
}

...
@Service
@Scope("prototype")
public class EccangB2BOutboundRocketMQTaskHandler extends DmpOutputRocketMQTaskHandler {
    ...
    public PlatformOutboundDTO convert(DmpThirdOutboundEntity dmpThirdOutboundEntity , String cfgOutputId) {
		...
		String erpOrderStatus = AntuEnums.B2BOrderStatusEnum.getErpOrderStatus(orderStatus);
    	...
    	platformOutboundDTO.setThirdOrderStatus(AntuEnums.B2BOrderStatusEnum.getName(orderStatus));

...
@Service
@Scope("prototype")
public class SptInboundInitHandler extends DmpInputInitHandler {
    ...
    public List<DmpInputTaskInitDTO> getInitData(DmpInputInitRequest dmpRequest, DmpInputTaskResponse dmpResponse) {
        ...
        List<String> receiveCodeList = overseasWarehouseFeign.getReceiptNumbersForStatus(Arrays.asList(OverseasInstockStatusEnum.TO_BE_SIGNED.getCode()
                ...
                , OverseasInstockStatusEnum.MANUAL_COMPLETION.getCode()), OmsPlatformEnum.OMS_SPT.getCode());
        ...
        if (CollUtil.isNotEmpty(receiveCodeList)) {
            ...
            List<OverseasProviderEntity> overseasProviderEntityList = dmpHandlerCache.getOverseasProviderEntityList(d -> d.getCode().equals(OmsPlatformEnum.OMS_SPT.getCode()));
            ...
            AntuGetReceiptReq antuGetReceiptReq = AntuGetReceiptReq.builder()
                    ...
                    .build();
            String response = AntuUtils.callService(OmsPlatformEnum.OMS_SPT,apiType, antuGetReceiptReq);

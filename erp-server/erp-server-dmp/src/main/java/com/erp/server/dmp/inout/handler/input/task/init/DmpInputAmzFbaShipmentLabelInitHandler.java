...
//            String rateLimitStr = requestTypeRateLimiterEnum.getRateLimit();
            try {
                ...
                GetLabelsResponse response = api.getLabels(shipmentId, AmazonFbaLabelPageTypeEnum.PLAIN_PAPER.getCode(),
                        AmazonFbaLabelTypeEnum.BARCODE_2D.getCode(), null, null, null, 100, 0);
                String labelUrl = "";

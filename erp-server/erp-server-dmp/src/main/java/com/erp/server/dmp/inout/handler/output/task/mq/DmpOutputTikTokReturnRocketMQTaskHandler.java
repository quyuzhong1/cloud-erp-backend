...
@Service
@Scope("prototype")
public class DmpOutputTikTokReturnRocketMQTaskHandler extends DmpOutputRocketMQTaskHandler {
    ...
    public Map<String, String> getPushJsonDataMap(DmpOutputTaskRequest dmpRequest, DmpOutputTaskResponse dmpResponse) {
        ...
        for (String changId : changeIds) {
            PlatformReturnOrderDTO orderDTO = this.convert(dmpEntityMap.get(changId), dmpDetailEntityMap.get(changId), cfgOutputId);
            if (orderDTO != null) {

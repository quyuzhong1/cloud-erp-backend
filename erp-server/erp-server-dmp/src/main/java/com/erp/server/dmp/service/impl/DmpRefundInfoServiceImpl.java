...
public class DmpRefundInfoServiceImpl extends ServiceImpl<DmpRefundInfoMapper, DmpRefundInfoEntity>
    ...
    public DmpRefundInfoEntity getRefundByPlatformOrderId(DmpRefundInfoEntity returnOrderInfoEntity) {
        ...
        lambdaQueryWrapper.eq(DmpRefundInfoEntity::getRefundCode, returnOrderInfoEntity.getRefundCode());
    ...
    public Boolean updateRefundByPlatformOrderId(DmpRefundInfoEntity dmpRefundInfoEntity) {
        ...
        lambdaQueryWrapper.eq(DmpRefundInfoEntity::getRefundCode, dmpRefundInfoEntity.getRefundCode());
    ...
    public void cleanRefundTask(){
        ...
        for (DmpRefundInfoEntity dmpRefundInfoEntity : dmpRefundInfoEntities) {
            ...
            DmpOrderInfoEntity dmpOrderInfoEntity = dmpOrderInfoService.getOrderBySalesRecordNumber(dmpRefundInfoEntity.getSalesRecordNumber(), dmpRefundInfoEntity.getPlatformOrderId(), dmpRefundInfoEntity.getPlatformSign());

...
public class DictRuleConditionController extends BaseController {
    ...
    */
    @PostMapping("/add")
    @LogAction(value = LogActionEnum.INSERT, desc = "条件字典表新增")
    public ApiResult<BaseResultDTO.AddDTO> add(@RequestBody @Validated DictRuleConditionDTO.AddDTO dto) {
    ...
    */
    @PostMapping("/update")
    @LogAction(value = LogActionEnum.UPDATE, desc = "条件字典表修改")
        @DataPermission(operationType = DataAttributeEnum.CHECK_BY_ID,
        tableField = "create_user_id",
        menuCode = "dmp:dictRuleCondition:update",

...
@Service
@Scope("prototype")
public class DmpOutputLxOrderRocketMQTaskHandler extends DmpOutputRocketMQTaskHandler {
    ...
    public PlatformOrderDTO convert(DmpSoInfoEntity dmpSoInfoEntity,
        ...
        if (!CollectionUtils.isEmpty(dmpSoReceiverEntityList)) {
            ...
            receiverDTO.setIeNo(dmpSoReceiverEntity.getIeNo());
            receiverDTO.setTaxidType(dmpSoReceiverEntity.getTaxidType());
        }
    ...
    public PlatformOrderDetailDTO intPlatformOrderDetailDTO(DmpSoDetailEntity item) {
        ...
        detailDTO.setPlatformSubSoCode(item.getPlatformSubSoCode());
        // 平台产品id

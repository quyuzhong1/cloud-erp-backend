...
/**
 * 爱亚（AIYA）海外仓库 DMP 输出 MQ 任务处理器，对齐 {@code WegoWarehouseRocketMQTaskHandler}。
 * <p>
 * <ol>
...
@Service
@Scope("prototype")
public class AiyaWarehouseRocketMQTaskHandler extends DmpOutputRocketMQTaskHandler {
    ...
    public Map<String, String> getPushJsonDataMap(DmpOutputTaskRequest dmpRequest, DmpOutputTaskResponse dmpResponse) {
        ...
        for (String changeId : changeIds) {
            ...
            if (dmpThirdWarehouseInfoEntity == null) {
                log.warn("AiyaWarehouseRocketMQTaskHandler: changeId={} not found, cfgOutputId={}", changeId, cfgOutputId);
                continue;
            }
    ...
    protected List<String> getSourceCodeKeys() {
        return Collections.singletonList("warehouseCode");
    }
}

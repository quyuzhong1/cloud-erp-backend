...
@Service
@Slf4j
@RocketMQMessageListener(topic = RocketMqTopic.SYNC_KINGDEE_ERP_TOPIC, selectorExpression = "kingdee_warehouse_tag", consumerGroup = RocketMqConsumerGroup.SYNC_KINGDEE_WAREHOUSE)

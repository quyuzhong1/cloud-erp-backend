...
@Service
@Slf4j
public class KingdeeAssetPurchaseOrderConsumerServiceImpl implements KingdeeAssetPurchaseOrderConsumerService {
    ...
    public void executeConsumer(Map<String, Object> map) {
        ...
        //模块类型
        Integer type = ApiModuleTypeEnum.ASSET_PURCHASE_ORDER.getCode();

...
@Service
@Scope("prototype")
public class DmpOutputJituWarehouseRocketMQTaskHandler extends DmpOutputRocketMQTaskHandler{
    ...
    public PlatformWarehouseDTO convert(DmpThirdWarehouseInfoEntity dmpThirdWarehouseInfoEntity , String cfgOutputId) {
    	...
    	warehouse.setCountryName(dmpThirdWarehouseInfoEntity.getCountryCode());
		warehouse.setPlatformWarehouseStatus("1");
		warehouse.setPlatformWarehouseType("0");

...
public class Track123WebhookInitHandler implements DmpInputApiInitHandler {
    ...
    public List<DmpInputTaskInitDTO> getApiData(DmpInputApiInitRequest request) {
        ...
        dmpLogisticsTrackWebhookRecordService.prepareRecords(PLATFORM_CODE, initConfig.getIngTimeoutMinutes());
        List<DmpLogisticsTrackWebhookRecordEntity> records =
                dmpLogisticsTrackWebhookRecordService.claimLatestWaitRecords(PLATFORM_CODE, initConfig.getBatchSize());

...
@Service
@Slf4j
public class KingdeeTransferOutConsumer<T extends DmpSyncTaskIdDTO> extends AbstractPlatformConsumerHandler<T> {
    @Resource
    private KingdeeTransferOutConsumerService kingdeeTransferOutConsumerService;
    ...
    public static void main(String[] args) {
        ...
        queryFilters.add(String.format("FBillNo = '%s'", "FBDC250427000004"));
        String filterStr = String.join(" and ", queryFilters);
        String fieldKeys = "FID,FVESTONWAY";
    ...
    public ApiResult<?> handle(Object ext) {
        ...
        kingdeeTransferOutConsumerService.executeConsumer(map);

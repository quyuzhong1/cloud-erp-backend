...
@Service
@Scope("prototype")
public class DmpOutputKingdeeEccShopRocketMQTaskHandler extends DmpOutputRocketMQTaskHandler{
	@Override
    ...
    public BiShopInfoEntity convert(DmpShopInfoEntity dmpShopInfoEntity , String cfgOutputId) {
        ...
        //平台店铺账户
        biShopInfoEntity.setAccountUserName(dmpShopInfoEntity.getAccountUserName());
        //平台店铺标识
        biShopInfoEntity.setAccountStoreName(dmpShopInfoEntity.getAccountStoreName());
        //店铺名称
        biShopInfoEntity.setName(dmpShopInfoEntity.getName());
        //平台名称
        ...
        biShopInfoEntity.setCreateUserId(dmpShopInfoEntity.getContacts());

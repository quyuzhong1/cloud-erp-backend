...
//        List<SoB2cEntity> existOrderList = soB2cFeign.getByPlatformCode(amazonOrderIds, PlatformDictEnum.AMAZON.getCode(), taskEntity.getShopId());
        ...
        if (!CollectionUtils.isEmpty(existList)){
            ...
            // 事务处理
            businessService.batchPullProcessBusiness(jobTaskDTO.getPlatformCategory(), jobTaskDTO.getDictPlatform(), jobTaskDTO.getBillType(), jobTaskDTO, dto.getPlatformApiEnum(), 300);
        }
    }

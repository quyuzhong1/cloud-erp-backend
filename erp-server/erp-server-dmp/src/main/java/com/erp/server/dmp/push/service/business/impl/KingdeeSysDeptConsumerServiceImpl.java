...
/**
 * @author Lambda
 * @Classname KingdeeSysDeptConsumerServiceImpl
 * @Description TODO
 * @Date 2023-08-02 9:46
 * @Created by yl
 */
@Service
@Slf4j
public class KingdeeSysDeptConsumerServiceImpl implements KingdeeSysDeptConsumerService {
    ...
    @KingdeeApi(KingdeePushModuleEnum.BD_DEPARTMENT)
    ...
    public void operateDelete(KingdeeApiUtils apiUtils, PlatformEntity platformEntity, Map<String, Object> map, String operate) {
        //删除
        kingdeeCommonService.handleDelete(apiUtils,platformEntity,map,ApiModuleTypeEnum.SYS_DEPARTMENT.getCode(),operate);
        return;
    }

...
/**
 * InboundPlan detail -> dmp_fba_inbound_plan
 */
@Service
@Scope("prototype")
public class DmpInputAmzFbaInboundPlanFbaShipmentDmpHandler extends DmpInputDbConvertDmpHandler {
    ...
    protected void afterConvertData(Map<List<Map<String, Object>>, List<TreeMap<String, Object>>> dmpInputDataDmpRelationMaps) {
        ...
        for (Map.Entry<List<Map<String, Object>>, List<TreeMap<String, Object>>> relationEntry : dmpInputDataDmpRelationMaps.entrySet()) {
            ...
            for (TreeMap<String, Object> dmpDataMap : dmpDataMaps) {
                fillInboundPlanFields(dmpDataMap, mongoData);
            }
            relationEntry.setValue(dmpDataMaps);
        }
    }

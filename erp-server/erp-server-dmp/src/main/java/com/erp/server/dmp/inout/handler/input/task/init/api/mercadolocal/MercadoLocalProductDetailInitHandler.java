...
import com.sdk.oms.mercadolocal.dto.mercadolocal.listing.BodyBean;
...
@Service
@Scope("prototype")
public class MercadoLocalProductDetailInitHandler extends DmpInputInitHandler {
	@Resource
	...
	public List<DmpInputTaskInitDTO> getInitData(DmpInputInitRequest dmpRequest, DmpInputTaskResponse dmpResponse) {
		...
		for (List<String> list : partition) {
			...
			params.put("userId", shopInfoDTO.getUserId().toString());
			...
			if (!Objects.equals(apiResult.getCode(), 200)) {
				...
				throw new RuntimeException(CharSequenceUtil.format("调用url={},入参params={}, 美客多Listing数据失败，返回值 responseMap={}",

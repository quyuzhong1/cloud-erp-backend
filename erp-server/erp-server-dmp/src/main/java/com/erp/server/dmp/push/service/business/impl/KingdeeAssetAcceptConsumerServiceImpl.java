...
@Service
@Slf4j
public class KingdeeAssetAcceptConsumerServiceImpl implements KingdeeAssetAcceptConsumerService {
    ...
    public void executeConsumer(Map<String, Object> map) {
        ...
        //模块类型
        Integer type = ApiModuleTypeEnum.ASSET_ACCEPT.getCode();
        ...
        if (SyncOperateEnum.OPERATE_APPROVE.getCode().equals(operate)) {
            operateApprove(apiUtils,platformEntity, map,json,type);
        }
        /**
         * 删除
         */
    ...
    public void operateDelete(KingdeeApiUtils apiUtils,PlatformEntity platformEntity,Map<String, Object> map,String operate) {
        //删除
        kingdeeCommonService.handleDelete(apiUtils,platformEntity,map,ApiModuleTypeEnum.ASSET_ACCEPT.getCode(),operate);
        return;
    }
    ...
    public void updateKingdeeDetailId (JSONArray jsonArray) {
        ...
        params.put("code",ApiModuleTypeEnum.ASSET_ACCEPT.getCode().toString());

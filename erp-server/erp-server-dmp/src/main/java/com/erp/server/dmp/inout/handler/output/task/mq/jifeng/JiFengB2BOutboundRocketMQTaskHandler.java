...
@Service
@Scope("prototype")
public class JiFengB2BOutboundRocketMQTaskHandler extends DmpOutputRocketMQTaskHandler {
    ...
    public PlatformOutboundDTO convert(DmpThirdOutboundEntity dmpThirdOutboundEntity , String cfgOutputId) {
		...
		String erpOrderStatus = JiFengEnums.B2BOrderStatusEnum.getErpOrderStatus(orderStatus);
    	...
    	platformOutboundDTO.setThirdOrderStatus(JiFengEnums.B2BOrderStatusEnum.getName(orderStatus));

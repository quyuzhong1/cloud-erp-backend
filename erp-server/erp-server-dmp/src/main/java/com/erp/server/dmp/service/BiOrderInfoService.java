 ...
 * 订单服务类
 */
public interface BiOrderInfoService extends IService<BiOrderInfoEntity> {
    /**
     * 添加订单信息
     *
     ...
     **/
    String add(BiOrderInfoEntity biOrderInfoEntity);
     ...
     **/
    BiOrderInfoEntity getOrderByPlatformOrderId(String platformOrderId);
     ...
     **/
    String checkOrder(BiOrderInfoEntity orderInfoEntity);
     ...
     * @Date 2022/11/14 21:28
     **/
    BiOrderInfoEntity getOrderBySalesRecordNumber(String salesRecordNumber, String platformOrderId, String platformSign);

    /**
     * 更新清洗数据
     *
     * @param userDeptList
     * @param biOrderInfoEntity
     */
    void cleanDmpOrderInfo(List<SysUserDeptDTO> userDeptList, BiOrderInfoEntity biOrderInfoEntity, List<CustomerDTO.SellerUserDeptDTO> sellerUserDeptDTOS);

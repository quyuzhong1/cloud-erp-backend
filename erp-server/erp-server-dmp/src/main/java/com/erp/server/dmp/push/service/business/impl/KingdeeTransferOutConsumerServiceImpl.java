...
@Service
@Slf4j
public class KingdeeTransferOutConsumerServiceImpl implements KingdeeTransferOutConsumerService {
    ...
    public void operateInvalid (KingdeeApiUtils apiUtils,PlatformEntity platformEntity, Map<String, Object> map,String operate){
        //作废
        kingdeeCommonService.handleInvalid(apiUtils,platformEntity,map,ApiModuleTypeEnum.TRANSFER_OUT.getCode(),operate);
        return;
    }
    ...
    public void operateDisapprove ( KingdeeApiUtils apiUtils,PlatformEntity platformEntity, Map<String, Object> map){
        //反审核
        kingdeeCommonService.handleUnAudit(platformEntity, map, apiUtils, ApiModuleTypeEnum.TRANSFER_OUT.getCode());
        return;
    }
    ...
    public void operateApprove (KingdeeApiUtils apiUtils,PlatformEntity platformEntity, Map<String, Object> map){
        //模块类型
        Integer type = ApiModuleTypeEnum.TRANSFER_OUT.getCode();
    ...
    public Boolean saveOrUpdate (KingdeeApiUtils apiUtils,PlatformEntity platformEntity,Map<String, Object> map,JSONObject json,KingdeeParamDTO.SaveParamDTO param) {
        ...
        Boolean isAdd = kingdeeCommonService.saveAndAutoApprove(platformEntity,map,apiUtils,json,param,ApiModuleTypeEnum.TRANSFER_OUT.getCode());
        if (isAdd) {
            //给明细id赋值

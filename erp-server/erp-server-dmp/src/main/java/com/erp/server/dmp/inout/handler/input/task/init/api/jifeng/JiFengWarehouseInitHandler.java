...
@Service
@Scope("prototype")
public class JiFengWarehouseInitHandler extends DmpInputInitHandler {
    ...
    public List<DmpInputTaskInitDTO> getInitData(DmpInputInitRequest dmpRequest, DmpInputTaskResponse dmpResponse) {
        ...
        JiFengBaseResp<List<JiFengWarehouseResp>> resp = jiFengService.getWarehouseList(overseasProviderEntity.getAuthJson());
        if(resp == null) {

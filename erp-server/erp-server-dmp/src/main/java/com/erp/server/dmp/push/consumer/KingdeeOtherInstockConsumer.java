...
//        selectorExpression = "kingdee_other_instock_tag",
//        consumerGroup = RocketMqConsumerGroup.SYNC_KINGDEE_OTHER_INSTOCK,
//        consumeMode = ConsumeMode.ORDERLY)
public class KingdeeOtherInstockConsumer<T extends DmpSyncTaskIdDTO> extends AbstractPlatformConsumerHandler<T> {

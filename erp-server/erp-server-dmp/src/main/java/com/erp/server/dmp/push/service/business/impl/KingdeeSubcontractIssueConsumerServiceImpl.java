 ...
 * @description: 委外发料单
 * @author Will
 * @date: 2024/1/26 18:11
 */
@Service
@Slf4j
public class KingdeeSubcontractIssueConsumerServiceImpl implements KingdeeSubcontractIssueConsumerService {
    ...
    @KingdeeApi(KingdeePushModuleEnum.SUB_PICKMTRL)
    ...
    public void operateDelete(KingdeeApiUtils apiUtils,PlatformEntity platformEntity,Map<String, Object> map,String operate) {
        //删除
        kingdeeCommonService.handleDelete(apiUtils,platformEntity,map,ApiModuleTypeEnum.SUBCONTRACT_ISSUE.getCode(),operate);
        return;
    }
}

...
@Service
@Slf4j
public class KingdeeExchangeRateConsumerServiceImpl implements KingdeeExchangeRateConsumerService {
    ...
    public void executeConsumer(Map<String, Object> map) {
        ...
        if (SyncOperateEnum.OPERATE_ADD.getCode().equals(operate)) {
            saveOrUpdate(apiUtils,platformEntity,map);
        }
        /**
         * 审核
         */
    ...
    public void operateApprove (KingdeeApiUtils apiUtils,PlatformEntity platformEntity, Map<String, Object> map){
        //模块类型
        Integer type = ApiModuleTypeEnum.BD_RATE.getCode();
        ...
        try {
            ...
            //新增数据
            saveAndAutoApprove( apiUtils, platformEntity, map,json, param);
            return;
        }
        //查找到数据后，判断其审核状态
     ...
     * 新增或修改后提审，审核
     */
    public Boolean saveAndAutoApprove(KingdeeApiUtils apiUtils, PlatformEntity platformEntity, Map<String, Object> map, JSONObject json, KingdeeParamDTO.SaveParamDTO param) {

        Boolean isAdd = kingdeeCommonService.saveAndAutoApprove(platformEntity,map,apiUtils,json,param,ApiModuleTypeEnum.BD_RATE.getCode());
        return  isAdd;
    }
     ...
     * 新增或修改后提审，审核
     */
    public Boolean saveOrUpdate (KingdeeApiUtils apiUtils,PlatformEntity platformEntity, Map<String, Object> map) {
        //模块类型
        Integer type = ApiModuleTypeEnum.BD_RATE.getCode();

...
public class MabangReturnApiInitHandler implements DmpInputApiInitHandler {
	...
	public List<DmpInputTaskInitDTO> getApiData(DmpInputApiInitRequest dmpInputApiInitRequest) {
        ...
        if(history) {
        	while(true) {
        		DmpSoReturnInfoDTO.AddGyyReturnOrderDTO dto = new DmpSoReturnInfoDTO.AddGyyReturnOrderDTO();
        		...
        		List<ReturnOrderEntity> mongoData = mongoService.findMongoData(dto, pageIndex, pageSize, MongoTableNameContant.ORIGINAL_MABANG_RETURN_ORDER, ReturnOrderEntity.class);

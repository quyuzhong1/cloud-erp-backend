...
public class DmpCfgOutputDetailServiceImpl extends SuperServiceImpl<DmpCfgOutputDetailMapper, DmpCfgOutputDetailEntity> implements DmpCfgOutputDetailService {
    ...
    */
    ...
    @Override
    public void exportList(DmpCfgOutputDetailDTO.ExportDTO param, HttpServletResponse response) {
        List<DmpCfgOutputDetailDTO.ListDTO> list = this.baseMapper.listExport(param);
        ...
        String excelPath = "excel/dmpCfgEtl.xlsx";
        String name = "推送配置信息导出";

...
@Service
@Scope("prototype")
public class TikTokRefundDmpHandler extends DmpInputDbConvertDmpHandler {
    @Resource
    ...
    protected void afterConvertData(Map<List<Map<String, Object>>, List<TreeMap<String, Object>>> dmpInputDataDmpRelationMaps) {
        ...
        if (CollUtil.isNotEmpty(keySet)) {
            ...
            List<DmpSoRefundInfoEntity> list = dmpSoRefundInfoService.lambdaQuery()
                    .in(DmpSoRefundInfoEntity::getThirdCode, orderIdList)
                    .in(DmpSoRefundInfoEntity::getSourceSystem, Arrays.asList(DmpBasicSystemCodeEnum.KINGDEE.getCode(), DmpBasicSystemCodeEnum.MABANG.getCode()))
                    .select(DmpSoRefundInfoEntity::getId)
                    .list();
            if (CollUtil.isNotEmpty(list)) {
                List<String> ids = list.stream().map(DmpSoRefundInfoEntity::getId).collect(Collectors.toList());
                dmpSoRefundInfoService.removeByIds(ids);
                dmpSoRefundDetailService.lambdaUpdate()
                        .in(DmpSoRefundDetailEntity::getMainId, ids)
                        .remove();
            }
        }
        ...
        for (Map.Entry<List<Map<String, Object>>, List<TreeMap<String, Object>>> dmpInputDataDmpRelationMap : dmpInputDataDmpRelationMaps.entrySet()) {
            ...
            for (TreeMap<String, Object> dmpDataMap : dmpDataMaps) {
                ...
                if (paymentObj != null) {
                    ...
                    dmpDataMap.put("amount", paymentMap.get("refundTotal"));
                    dmpDataMap.put("shippingCost", paymentMap.get("refundShippingFee"));

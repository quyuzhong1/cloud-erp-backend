...
@Service
@Scope("prototype")
public class WeiShiOutboundRocketMQTaskHandler extends DmpOutputRocketMQTaskHandler {
    ...
    public PlatformOutboundDTO convert(DmpThirdOutboundEntity dmpThirdOutboundEntity , String cfgOutputId) {
		...
		String erpOrderStatus = WeiShiEnums.OrderStatusEnum.getErpOrderStatus(orderStatus);
    	...
    	platformOutboundDTO.setThirdOrderStatus(WeiShiEnums.OrderStatusEnum.getName(orderStatus));

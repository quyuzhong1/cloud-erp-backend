...
public class TestAmazonOrderProd {
	public static void main(String[] args) {
		...
		try (BufferedWriter writer = new BufferedWriter(new FileWriter(logFilePath, true))) { // true 表示追加模式
			while (startTime.before(new Date())) {
				...
				headers.put("Authorization", "eyJhbGciOiJIUzI1NiJ9.eyJ1aWQiOiIxNjUwMDQ3NTQ1OTA2MzAyOTc4IiwidXNlcl9rZXkiOiIxNjUwMDQ3NTQ1OTA2MzAyOTc4IiwidXNlck5hbWUiOiLnvZfnu7TliJoiLCJpYXQiOjE3MzkyNjEyNTcsImV4cCI6MTczOTg2NjA1N30.qkDSNf4x-lOJHTr_WETs-QDsVKZBa_plOGuL2VPwciE");
				createPost.addHeaders(headers);
				String body = "{\r\n" +
						"  \"cfgOutputId\": \"1859426447974751005\",\r\n" +
						"  \"queryParams\":[{\r\n" +
						"    \"type\": \"GE\",\r\n" +

...
@Service
@Scope("prototype")
public class ShopifyProductDmpHandler extends DmpInputDbConvertDmpHandler {
    ...
    protected void afterConvertData(Map<List<Map<String, Object>>, List<TreeMap<String, Object>>> dmpInputDataDmpRelationMaps) {
        for (Map.Entry<List<Map<String, Object>>, List<TreeMap<String, Object>>> dmpInputDataDmpRelationMap : dmpInputDataDmpRelationMaps.entrySet()) {
            ...
            for (TreeMap<String, Object> dmpDataMap : dmpDataMaps) {
                //状态
                Object variantsObj = dmpDataMap.get("variants");
                if (variantsObj != null) {

                    List<Map<String, Object>> variantsList = (List<Map<String, Object>>) variantsObj;
                    for (Map<String, Object> map : variantsList) {

                    }

                    String financialStatus = String.valueOf(variantsObj);

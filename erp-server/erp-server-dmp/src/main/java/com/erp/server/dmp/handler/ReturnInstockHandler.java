 ...
 * 订单出口回告处理类
 */
public class ReturnInstockHandler implements WebhookHandler{

    private static final Logger log = LoggerFactory.getLogger(ReturnInstockHandler.class);
...
//        }
    ...
    public String process(String data, Map<String, String> headers, String serviceFlag) {
        ...
        log.warn("webhook 获取退货入库单数据,{}",data);
        try {

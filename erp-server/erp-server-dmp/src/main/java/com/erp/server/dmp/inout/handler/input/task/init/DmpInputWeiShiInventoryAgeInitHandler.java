...
import com.sdk.wms.weishi.dto.response.WeiShiStockAgeResp;
...
@Service
@Scope("prototype")
public class DmpInputWeiShiInventoryAgeInitHandler extends DmpInputInitHandler {
    ...
    public List<DmpInputTaskInitDTO> getInitData(DmpInputInitRequest dmpRequest, DmpInputTaskResponse dmpResponse) {
        ...
        if(!resp.getCode().equals(200)){
            throw new ServiceException("纬狮获取库存列表失败: " + resp.getMsg());
        }

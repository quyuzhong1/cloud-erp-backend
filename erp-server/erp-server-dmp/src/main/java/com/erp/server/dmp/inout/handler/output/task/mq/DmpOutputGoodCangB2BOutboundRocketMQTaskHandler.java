...
@Service
@Scope("prototype")
public class DmpOutputGoodCangB2BOutboundRocketMQTaskHandler extends DmpOutputRocketMQTaskHandler{
    ...
    public PlatformOutboundDTO convert(DmpThirdOutboundEntity dmpThirdOutboundEntity , String cfgOutputId) {
		...
		String erpOrderStatus = GoodCangEnums.B2BOrderStatusEnum.getErpOrderStatus(orderStatus);
    	...
    	platformOutboundDTO.setThirdOrderStatus(GoodCangEnums.B2BOrderStatusEnum.getName(orderStatus));

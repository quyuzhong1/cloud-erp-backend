...
@Service
@Slf4j
public class KingdeeAssetPurchaseChangeConsumerServiceImpl implements KingdeeAssetPurchaseChangeConsumerService {
    ...
    public void executeConsumer(Map<String, Object> map) {
        //模块类型
        Integer type = ApiModuleTypeEnum.ASSET_PURCHASE_CHANGE.getCode();
        //操作项

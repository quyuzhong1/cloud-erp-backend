...
/**
 * WEGO 2C 出库单 DMP 输出 MQ 任务处理器。
 * 读取 dmp_third_outbound 实体，按 WegoEnums.OrderStatusEnum 做状态映射后推送到
 * dmp_platform_outbound_to_wms_topic，由 PlatformOutboundConsumerService 统一消费处理。
 */
@Service
@Scope("prototype")
public class WegoOutboundRocketMQTaskHandler extends DmpOutputRocketMQTaskHandler {
    ...
    public PlatformOutboundDTO convert(DmpThirdOutboundEntity entity, String cfgOutputId) {
        ...
        String erpOrderStatus = WegoEnums.OrderStatusEnum.getErpOrderStatus(orderStatus);
        ...
        dto.setThirdOrderStatus(WegoEnums.OrderStatusEnum.getName(orderStatus));

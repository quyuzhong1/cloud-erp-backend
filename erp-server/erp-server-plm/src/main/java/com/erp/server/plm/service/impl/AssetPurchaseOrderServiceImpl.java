...
public class AssetPurchaseOrderServiceImpl extends SuperServiceImpl<AssetPurchaseOrderMapper, AssetPurchaseOrderEntity> implements AssetPurchaseOrderService {
    ...
    public BaseResultDTO.AddDTO add(AssetPurchaseOrderDTO.AddDTO addDTO) {
        ...
        boolean save = super.save(assetPurchaseOrderEntity);
        if(!save) {
            throw new ServiceException("保存失败");
        }

        // 操作日志
        String msg = StrUtil.format("用户【{}】新增【{}】单据单号为【{}】", UserContext.getDefaultLoginUser().getUserName(), "" , assetPurchaseOrderEntity.getCode());
        // TODO 此处的null需修改为日志模块类型，moduleType查看ModuleTypeEnum枚举类
        operateLogService.addModuleOperateLog(msg, null, assetPurchaseOrderEntity.getId(), "新增操作");
        // TODO 新增明细（如果有明细的话）
    ...
    */
    ...
    public Boolean update(AssetPurchaseOrderDTO.UpdateDTO addOrUpdateDTO) {
        ...
        // TODO 此处的null需修改为日志模块类型，moduleType查看ModuleTypeEnum枚举类
        operateLogService.addModuleOperateLogByObj(old, assetPurchaseOrderEntity, null, assetPurchaseOrderEntity.getId(), msg);
        return Boolean.TRUE;
    }

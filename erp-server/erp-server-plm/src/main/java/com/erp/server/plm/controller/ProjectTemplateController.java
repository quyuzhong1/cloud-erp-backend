...
public class ProjectTemplateController extends BaseController {
     ...
     */
    @PostMapping("/paging")
    public ApiResult<PagingVO<ProjectTemplateDTO>> paging(@RequestBody  PagingDTO<ProjectTemplateDTO> dto) {
    ...
    public ApiResult saveOrUpdate(@RequestBody @Validated ProjectTemplateDTO dto) {
    ...
    public ApiResult updateTemplateStatus(@RequestBody @Validated ProjectTemplateDTO dto) {
    ...
    public ApiResult removeTemplate(@RequestBody @Validated ProjectTemplateDTO dto) {
        Boolean flag = projectTemplateService.removeTemplate(dto.getId());

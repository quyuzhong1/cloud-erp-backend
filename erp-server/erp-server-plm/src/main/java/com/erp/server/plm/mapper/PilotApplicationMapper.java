...
public interface PilotApplicationMapper extends BaseMapper<PilotApplicationEntity> {
     ...
     * @author: tanmujin
     */
    int tabList(@Param("approveStatus") String approveStatus, @Param("orderStatus") String orderStatus, @Param("approveUserId") String approveUserId,@Param("permissionSql") String permissionSql,@Param("ids") List<String> ids);

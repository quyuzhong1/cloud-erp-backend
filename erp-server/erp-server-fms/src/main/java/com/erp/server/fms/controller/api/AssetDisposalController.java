...
public class AssetDisposalController extends BaseController {
    ...
    */
    ...
    @LogAction(value = LogActionEnum.ADD_AND_SUBMIT, desc = "资产处置单主表新增并提交")
    ...
    */
    ...
    @LogAction(value = LogActionEnum.UPDATE_AND_SUBMIT, desc = "资产处置单主表修改并提交")
    @DataPermission(operationType = DataAttributeEnum.CHECK_BY_ID,
            tableField = "create_user_id",
    ...
    */
    ...
    public ApiResult<List<BatchResultDTO>> batchCancelProcess(@RequestBody @Validated BaseIdsDTO.IdsDTO dto) {
        ...
        for (String id : dto.getIds()) {
            ...
            try {
                cancelResult = assetDisposalService.cancelProcess(new ApproveDTO.CancelProcessDTO(id));
            }catch (Exception e){

...
public class AssetAcceptServiceImpl extends SuperServiceImpl<AssetAcceptMapper, AssetAcceptEntity> implements AssetAcceptService {
    ...
    public BaseResultDTO.AddDTO add(AssetAcceptDTO.AddDTO addDTO) {
        ...
        operateLogService.addModuleOperateLog(msg, null, assetAcceptEntity.getId(), "新增操作");
        // TODO 新增明细（如果有明细的话）
    ...
    */
    ...
    public Boolean update(AssetAcceptDTO.UpdateDTO addOrUpdateDTO) {
        ...
        // TODO 此处的null需修改为日志模块类型，moduleType查看ModuleTypeEnum枚举类
        operateLogService.addModuleOperateLogByObj(old, assetAcceptEntity, null, assetAcceptEntity.getId(), msg);
        return Boolean.TRUE;
    }
    ...
    @Override
    public void exportList(AssetAcceptDTO.ExportDTO param, HttpServletResponse response) {
        List<AssetAcceptDTO.ListDTO> list = this.baseMapper.listExport(param);
        ...
        String excelPath = "excel/assetAccept.xlsx";
        String name = "资产验收单导出";

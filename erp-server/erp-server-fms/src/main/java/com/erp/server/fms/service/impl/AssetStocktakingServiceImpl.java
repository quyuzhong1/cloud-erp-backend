...
public class AssetStocktakingServiceImpl extends SuperServiceImpl<AssetStocktakingMapper, AssetStocktakingEntity> implements AssetStocktakingService {
    ...
    public BaseResultDTO.AddDTO add(AssetStocktakingDTO.AddDTO addDTO) {
        ...
        operateLogService.addModuleOperateLog(msg, null, assetStocktakingEntity.getId(), "新增操作");
        // TODO 新增明细（如果有明细的话）
    ...
    */
    ...
    public Boolean update(AssetStocktakingDTO.UpdateDTO addOrUpdateDTO) {
        ...
        AssetStocktakingEntity assetStocktakingEntity =  BeanMapperUtils.map(AssetStocktakingEntity.class, addOrUpdateDTO);
        ...
        // 记录主单操作日志
            log.info("编辑 开始记录资产盘点单日志数据，单号：【{}】", assetStocktakingEntity.getCode());
            String msg = StrUtil.format("用户【{}】编辑单号为【{}】的【{}】单据 ", UserContext.getDefaultLoginUser().getUserName(), assetStocktakingEntity.getCode(), "资产盘点单");
        // TODO 此处的null需修改为日志模块类型，moduleType查看ModuleTypeEnum枚举类
        operateLogService.addModuleOperateLogByObj(old, assetStocktakingEntity, null, assetStocktakingEntity.getId(), msg);
        return Boolean.TRUE;
    }
    ...
    public List<AssetStocktakingDTO.TabListDTO> tabList(PermissionsDTO param) {
        ...
        statusList.parallelStream().forEach(status -> {
            ...
            list.add(new AssetStocktakingDTO.TabListDTO(status, 0));
        }
        });
        list.add(new AssetStocktakingDTO.TabListDTO("all", list.stream().mapToInt(AssetStocktakingDTO.TabListDTO::getCount).sum()));
        // 计算合计数量
        return list;
    }
    ...
    public void exportList(AssetStocktakingDTO.ExportDTO param, HttpServletResponse response) {
        List<AssetStocktakingDTO.ListDTO> list = this.baseMapper.listExport(param);
        ...
        String excelPath = "excel/assetStocktaking.xlsx";
        String name = "资产盘点单导出";
    ...
    */
    ...
    public BatchResultDTO delete(String id) {
        ...
        operateLogService.addModuleOperateLog(msg, null, entity.getCode(), "删除资产盘点单数据");

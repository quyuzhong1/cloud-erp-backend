...
//        LogisticsTrackVO logisticsQueryVO = new LogisticsTrackVO();
        ...
        LogisticsTrackVO logisticsTrackVO = JSONObject.parseObject(str, LogisticsTrackVO.class);
...
//        logisticsQueryVO.setAuthMap(authMap);
        ApiResult<List<LogisticsTrackEntity>> track = track123LogisticsHandler.getTrack(logisticsTrackVO);

...
public interface TmsB2cDeclareReconciliationDetailMapper extends BaseMapper<TmsB2cDeclareReconciliationDetailEntity> {
    ...
    List<String> pageAutoGenerateDeclareReconciliationSupplierIds(@Param("params") TmsAsyncTaskRecordDTO.CursorPageDTO params);

    List<TmsB2cDeclareReconciliationDetailEntity> listAutoGenerateDeclareReconciliationBySuppliers(@Param("params") TmsAsyncTaskRecordDTO.CursorPageDTO params);
    ...
    List<TmsB2cDeclareReconciliationDetailEntity> pageAutoGenerateCost(@Param("params") TmsAsyncTaskRecordDTO.CursorPageDTO params);

    List<TmsB2cDeclareReconciliationDetailEntity> listAutoGenerateCostByIds(@Param("params") TmsAsyncTaskRecordDTO.CursorPageDTO params);
}

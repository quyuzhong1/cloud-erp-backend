...
public interface ProductRegistrationConverter {
    ...
    @Mappings({
            ...
            @Mapping(target = "length", expression = "java(java.util.Objects.nonNull(productDTO.getProductLength())?productDTO.getProductLength().divide(java.math.BigDecimal.valueOf(10)):null)"),
            @Mapping(target = "width",  expression = "java(java.util.Objects.nonNull(productDTO.getProductWidth())?productDTO.getProductWidth().divide(java.math.BigDecimal.valueOf(10)):null)"),
            @Mapping(target = "height", expression = "java(java.util.Objects.nonNull(productDTO.getProductHeight())?productDTO.getProductHeight().divide(java.math.BigDecimal.valueOf(10)):null)"),

...
import com.erp.server.tms.handler.asynctask.B2cDeclareReconciliationPushDetailHandler;
...
@Slf4j
@Service
public class TmsB2cDeclareReconciliationDetailServiceImpl extends SuperServiceImpl<TmsB2cDeclareReconciliationDetailMapper, TmsB2cDeclareReconciliationDetailEntity>
    implements TmsB2cDeclareReconciliationDetailService, TmsB2cDeclareReconciliationAsyncTaskDelegate {
    @Resource
    ...
    @Resource
    private B2cDeclareReconciliationPushDetailHandler b2cDeclareReconciliationPushDetailHandler;
    ...
    */
    ...
    public void pushDeclareReconciliation(TmsAsyncTaskRecordEntity taskRecord) {
        tmsAsyncTaskBatchConsumerSupport.executePreparedDetails(taskRecord, b2cDeclareReconciliationPushDetailHandler);
    }

    @Override
    public List<TmsAsyncTaskDetailEntity> prepareDeclareReconciliationBatchDetails(String taskId, String businessType,
    ...
    @Override
    public TmsAsyncTaskRecordDTO.BatchProcessResult executeDeclareReconciliationBatch(String taskId,
        ...
        Map<String, List<TmsB2cDeclareReconciliationDetailEntity>> map = list.stream().collect(Collectors.groupingBy(TmsB2cDeclareReconciliationDetailEntity::getLogisticsSupplierId));
        ...
        try {
            ...
            if (!completed) {
                log.warn("B2C报关对账批次执行超时，taskId: {}, timeoutSeconds: {}", taskDetailList.get(0).getMainId(), timeoutSeconds);
    ...
    private TmsAsyncTaskRecordDTO.CursorPageDTO buildCursorPageDTO(LocalDate startDate, LocalDate endDate, List<String> ids, String lastId, int batchSize) {
    ...
    @Override
    public List<TmsB2cDeclareReconciliationDetailEntity> pageAutoGenerateCost(LocalDate startDate, LocalDate endDate, List<String> logisticsSupplierIds, String lastId, int batchSize) {
        TmsAsyncTaskRecordDTO.CursorPageDTO pageDTO = buildCursorPageDTO(startDate, endDate, logisticsSupplierIds, lastId, batchSize);
        return this.getBaseMapper().pageAutoGenerateCost(pageDTO);
    }

    @Override
    public List<TmsB2cDeclareReconciliationDetailEntity> listAutoGenerateCostByIds(List<String> ids) {

...
@Slf4j
@Component
@LogisticsPlatformType(LogisticsPlatformEnum.MERCADOLIBRE_LOCAL)
public class MercadoLocalLogisticsHandlerImpl extends AbstractLogisticsHandler {
    @Resource
    ...
    public Map<String, String> getLogisticsAuthConfigByShopId(String shopId) {
        ...
        AppClientEnum appClientEnum = AppClientEnum.MERCADO_LOCAL_ACCESS_TOKEN;

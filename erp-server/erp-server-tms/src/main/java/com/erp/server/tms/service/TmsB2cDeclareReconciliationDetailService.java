...
public interface TmsB2cDeclareReconciliationDetailService extends SuperService<TmsB2cDeclareReconciliationDetailEntity> {
    ...
    */
    ...
    void pushDeclareReconciliation(TmsAsyncTaskRecordEntity taskRecord);
    ...
    List<TmsB2cDeclareReconciliationDetailEntity> pageAutoGenerateCost(LocalDate startDate, LocalDate endDate, List<String> logisticsSupplierIds, String lastId, int batchSize);

    List<TmsB2cDeclareReconciliationDetailEntity> listAutoGenerateCostByIds(List<String> ids);

    ...
    */
	...
	public void pushReAllocation(TmsAsyncTaskRecordDTO.PushParamsDTO dto) {
		...
		try {
			...
			TransferDeclareCostAllocationService self = ApplicationContextUtils.getBean(TransferDeclareCostAllocationService.class);
	...
	private CfgSettingValueDTO.BillBatchParamsDTO loadBillBatchParams(String taskId) {
		...
		if (byKey == null || byKey.getDataJson() == null) {
			...
			asyncTaskRecordService.finishTaskWithError(taskId, "批次配置缺失");
			return null;
		}

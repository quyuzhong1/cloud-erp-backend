 ...
 */
@Service
@RocketMQMessageListener(topic = RocketMqTopic.TMS_ASYNC_GET_LOGISTICS_ORDER_LABEL_TOPIC,
        selectorExpression = RocketMqNewTag.TMS_ASYNC_GET_LOGISTICS_ORDER_LABEL_TAG,
        consumerGroup = RocketMqConsumerGroup.TMS_ASYNC_GET_LOGISTICS_ORDER_LABEL_CONSUMER)
@Slf4j

...
public class ShopifyLogisticsHandlerImpl extends AbstractLogisticsHandler {
    ...
    public ApiResult<List<LogisticsSaleChannelEntity>> getChannel(ChanelQueryVO chanelQueryVO) {
        ...
        entityList.add(new LogisticsSaleChannelEntity().setCode("Bonds").setPlatformChannelId("Bonds").setCnName("Bonds").setLogisticsPlatform(LogisticsPlatformEnum.SHOPIFY.getCode()));
        entityList.add(new LogisticsSaleChannelEntity().setCode("Allied Express").setPlatformChannelId("Allied Express").setCnName("Allied Express").setLogisticsPlatform(LogisticsPlatformEnum.SHOPIFY.getCode()));
        entityList.add(new LogisticsSaleChannelEntity().setCode("Direct Couriers").setPlatformChannelId("Direct Couriers").setCnName("Direct Couriers").setLogisticsPlatform(LogisticsPlatformEnum.SHOPIFY.getCode()));
        entityList.add(new LogisticsSaleChannelEntity().setCode("Northline").setPlatformChannelId("Northline").setCnName("Northline").setLogisticsPlatform(LogisticsPlatformEnum.SHOPIFY.getCode()));
        entityList.add(new LogisticsSaleChannelEntity().setCode("GO Logistics").setPlatformChannelId("GO Logistics").setCnName("GO Logistics").setLogisticsPlatform(LogisticsPlatformEnum.SHOPIFY.getCode()));
        entityList.add(new LogisticsSaleChannelEntity().setCode("Österreichische Post").setPlatformChannelId("Österreichische Post").setCnName("Österreichische Post").setLogisticsPlatform(LogisticsPlatformEnum.SHOPIFY.getCode()));
        entityList.add(new LogisticsSaleChannelEntity().setCode("Speedy").setPlatformChannelId("Speedy").setCnName("Speedy").setLogisticsPlatform(LogisticsPlatformEnum.SHOPIFY.getCode()));
        entityList.add(new LogisticsSaleChannelEntity().setCode("Intelcom").setPlatformChannelId("Intelcom").setCnName("Intelcom").setLogisticsPlatform(LogisticsPlatformEnum.SHOPIFY.getCode()));
        entityList.add(new LogisticsSaleChannelEntity().setCode("BoxKnight").setPlatformChannelId("BoxKnight").setCnName("BoxKnight").setLogisticsPlatform(LogisticsPlatformEnum.SHOPIFY.getCode()));
        entityList.add(new LogisticsSaleChannelEntity().setCode("Loomis").setPlatformChannelId("Loomis").setCnName("Loomis").setLogisticsPlatform(LogisticsPlatformEnum.SHOPIFY.getCode()));
        entityList.add(new LogisticsSaleChannelEntity().setCode("GLS").setPlatformChannelId("GLS").setCnName("GLS").setLogisticsPlatform(LogisticsPlatformEnum.SHOPIFY.getCode()));
        entityList.add(new LogisticsSaleChannelEntity().setCode("China Post").setPlatformChannelId("China Post").setCnName("China Post").setLogisticsPlatform(LogisticsPlatformEnum.SHOPIFY.getCode()));
        entityList.add(new LogisticsSaleChannelEntity().setCode("DHL eCommerce Asia").setPlatformChannelId("DHL eCommerce Asia").setCnName("DHL eCommerce Asia").setLogisticsPlatform(LogisticsPlatformEnum.SHOPIFY.getCode()));
        entityList.add(new LogisticsSaleChannelEntity().setCode("WanbExpress").setPlatformChannelId("WanbExpress").setCnName("WanbExpress").setLogisticsPlatform(LogisticsPlatformEnum.SHOPIFY.getCode()));
        entityList.add(new LogisticsSaleChannelEntity().setCode("YunExpress").setPlatformChannelId("YunExpress").setCnName("YunExpress").setLogisticsPlatform(LogisticsPlatformEnum.SHOPIFY.getCode()));
        entityList.add(new LogisticsSaleChannelEntity().setCode("Anjun Logistics").setPlatformChannelId("Anjun Logistics").setCnName("Anjun Logistics").setLogisticsPlatform(LogisticsPlatformEnum.SHOPIFY.getCode()));
        entityList.add(new LogisticsSaleChannelEntity().setCode("SFC Fulfillment").setPlatformChannelId("SFC Fulfillment").setCnName("SFC Fulfillment").setLogisticsPlatform(LogisticsPlatformEnum.SHOPIFY.getCode()));
        entityList.add(new LogisticsSaleChannelEntity().setCode("FSC").setPlatformChannelId("FSC").setCnName("FSC").setLogisticsPlatform(LogisticsPlatformEnum.SHOPIFY.getCode()));
        entityList.add(new LogisticsSaleChannelEntity().setCode("Zásilkovna").setPlatformChannelId("Zásilkovna").setCnName("Zásilkovna").setLogisticsPlatform(LogisticsPlatformEnum.SHOPIFY.getCode()));
        entityList.add(new LogisticsSaleChannelEntity().setCode("Deutsche Post (DE)").setPlatformChannelId("Deutsche Post (DE)").setCnName("Deutsche Post (DE)").setLogisticsPlatform(LogisticsPlatformEnum.SHOPIFY.getCode()));
        entityList.add(new LogisticsSaleChannelEntity().setCode("Deutsche Post (EN)").setPlatformChannelId("Deutsche Post (EN)").setCnName("Deutsche Post (EN)").setLogisticsPlatform(LogisticsPlatformEnum.SHOPIFY.getCode()));
        entityList.add(new LogisticsSaleChannelEntity().setCode("DHLDHL Express").setPlatformChannelId("DHLDHL Express").setCnName("DHLDHL Express").setLogisticsPlatform(LogisticsPlatformEnum.SHOPIFY.getCode()));
        entityList.add(new LogisticsSaleChannelEntity().setCode("SwishipHermes").setPlatformChannelId("SwishipHermes").setCnName("SwishipHermes").setLogisticsPlatform(LogisticsPlatformEnum.SHOPIFY.getCode()));
        entityList.add(new LogisticsSaleChannelEntity().setCode("GLS").setPlatformChannelId("GLS").setCnName("GLS").setLogisticsPlatform(LogisticsPlatformEnum.SHOPIFY.getCode()));
        entityList.add(new LogisticsSaleChannelEntity().setCode("SEUR").setPlatformChannelId("SEUR").setCnName("SEUR").setLogisticsPlatform(LogisticsPlatformEnum.SHOPIFY.getCode()));
        entityList.add(new LogisticsSaleChannelEntity().setCode("Colissimo").setPlatformChannelId("Colissimo").setCnName("Colissimo").setLogisticsPlatform(LogisticsPlatformEnum.SHOPIFY.getCode()));
        entityList.add(new LogisticsSaleChannelEntity().setCode("Mondial Relay").setPlatformChannelId("Mondial Relay").setCnName("Mondial Relay").setLogisticsPlatform(LogisticsPlatformEnum.SHOPIFY.getCode()));
        entityList.add(new LogisticsSaleChannelEntity().setCode("Colis Privé").setPlatformChannelId("Colis Privé").setCnName("Colis Privé").setLogisticsPlatform(LogisticsPlatformEnum.SHOPIFY.getCode()));
        entityList.add(new LogisticsSaleChannelEntity().setCode("GLS").setPlatformChannelId("GLS").setCnName("GLS").setLogisticsPlatform(LogisticsPlatformEnum.SHOPIFY.getCode()));
        entityList.add(new LogisticsSaleChannelEntity().setCode("Evri").setPlatformChannelId("Evri").setCnName("Evri").setLogisticsPlatform(LogisticsPlatformEnum.SHOPIFY.getCode()));
        entityList.add(new LogisticsSaleChannelEntity().setCode("DPD UK").setPlatformChannelId("DPD UK").setCnName("DPD UK").setLogisticsPlatform(LogisticsPlatformEnum.SHOPIFY.getCode()));
        entityList.add(new LogisticsSaleChannelEntity().setCode("Parcelforce").setPlatformChannelId("Parcelforce").setCnName("Parcelforce").setLogisticsPlatform(LogisticsPlatformEnum.SHOPIFY.getCode()));
        entityList.add(new LogisticsSaleChannelEntity().setCode("Yodel").setPlatformChannelId("Yodel").setCnName("Yodel").setLogisticsPlatform(LogisticsPlatformEnum.SHOPIFY.getCode()));
        entityList.add(new LogisticsSaleChannelEntity().setCode("DHL Parcel").setPlatformChannelId("DHL Parcel").setCnName("DHL Parcel").setLogisticsPlatform(LogisticsPlatformEnum.SHOPIFY.getCode()));
        entityList.add(new LogisticsSaleChannelEntity().setCode("Tuffnells").setPlatformChannelId("Tuffnells").setCnName("Tuffnells").setLogisticsPlatform(LogisticsPlatformEnum.SHOPIFY.getCode()));
        entityList.add(new LogisticsSaleChannelEntity().setCode("ACS Courier").setPlatformChannelId("ACS Courier").setCnName("ACS Courier").setLogisticsPlatform(LogisticsPlatformEnum.SHOPIFY.getCode()));
        entityList.add(new LogisticsSaleChannelEntity().setCode("SF Express").setPlatformChannelId("SF Express").setCnName("SF Express").setLogisticsPlatform(LogisticsPlatformEnum.SHOPIFY.getCode()));
        ...
        entityList.add(new LogisticsSaleChannelEntity().setCode("DPD Ireland").setPlatformChannelId("DPD Ireland").setCnName("DPD Ireland").setLogisticsPlatform(LogisticsPlatformEnum.SHOPIFY.getCode()));
        entityList.add(new LogisticsSaleChannelEntity().setCode("DTDC").setPlatformChannelId("DTDC").setCnName("DTDC").setLogisticsPlatform(LogisticsPlatformEnum.SHOPIFY.getCode()));
        entityList.add(new LogisticsSaleChannelEntity().setCode("India Post").setPlatformChannelId("India Post").setCnName("India Post").setLogisticsPlatform(LogisticsPlatformEnum.SHOPIFY.getCode()));
        entityList.add(new LogisticsSaleChannelEntity().setCode("Delhivery").setPlatformChannelId("Delhivery").setCnName("Delhivery").setLogisticsPlatform(LogisticsPlatformEnum.SHOPIFY.getCode()));
        entityList.add(new LogisticsSaleChannelEntity().setCode("Gati KWE").setPlatformChannelId("Gati KWE").setCnName("Gati KWE").setLogisticsPlatform(LogisticsPlatformEnum.SHOPIFY.getCode()));
        entityList.add(new LogisticsSaleChannelEntity().setCode("Professional Couriers").setPlatformChannelId("Professional Couriers").setCnName("Professional Couriers").setLogisticsPlatform(LogisticsPlatformEnum.SHOPIFY.getCode()));
        entityList.add(new LogisticsSaleChannelEntity().setCode("XpressBees").setPlatformChannelId("XpressBees").setCnName("XpressBees").setLogisticsPlatform(LogisticsPlatformEnum.SHOPIFY.getCode()));
        entityList.add(new LogisticsSaleChannelEntity().setCode("Ecom Express").setPlatformChannelId("Ecom Express").setCnName("Ecom Express").setLogisticsPlatform(LogisticsPlatformEnum.SHOPIFY.getCode()));
        entityList.add(new LogisticsSaleChannelEntity().setCode("Ekart").setPlatformChannelId("Ekart").setCnName("Ekart").setLogisticsPlatform(LogisticsPlatformEnum.SHOPIFY.getCode()));
        entityList.add(new LogisticsSaleChannelEntity().setCode("Shadowfax").setPlatformChannelId("Shadowfax").setCnName("Shadowfax").setLogisticsPlatform(LogisticsPlatformEnum.SHOPIFY.getCode()));
        entityList.add(new LogisticsSaleChannelEntity().setCode("Bluedart").setPlatformChannelId("Bluedart").setCnName("Bluedart").setLogisticsPlatform(LogisticsPlatformEnum.SHOPIFY.getCode()));
        entityList.add(new LogisticsSaleChannelEntity().setCode("BRT").setPlatformChannelId("BRT").setCnName("BRT").setLogisticsPlatform(LogisticsPlatformEnum.SHOPIFY.getCode()));
        entityList.add(new LogisticsSaleChannelEntity().setCode("GLS Italy").setPlatformChannelId("GLS Italy").setCnName("GLS Italy").setLogisticsPlatform(LogisticsPlatformEnum.SHOPIFY.getCode()));
        entityList.add(new LogisticsSaleChannelEntity().setCode("エコ配").setPlatformChannelId("エコ配").setCnName("エコ配").setLogisticsPlatform(LogisticsPlatformEnum.SHOPIFY.getCode()));
        entityList.add(new LogisticsSaleChannelEntity().setCode("西濃運輸").setPlatformChannelId("西濃運輸").setCnName("西濃運輸").setLogisticsPlatform(LogisticsPlatformEnum.SHOPIFY.getCode()));
        entityList.add(new LogisticsSaleChannelEntity().setCode("西濃スーパーエキスプレス").setPlatformChannelId("西濃スーパーエキスプレス").setCnName("西濃スーパーエキスプレス").setLogisticsPlatform(LogisticsPlatformEnum.SHOPIFY.getCode()));
        entityList.add(new LogisticsSaleChannelEntity().setCode("福山通運").setPlatformChannelId("福山通運").setCnName("福山通運").setLogisticsPlatform(LogisticsPlatformEnum.SHOPIFY.getCode()));
        entityList.add(new LogisticsSaleChannelEntity().setCode("日本通運").setPlatformChannelId("日本通運").setCnName("日本通運").setLogisticsPlatform(LogisticsPlatformEnum.SHOPIFY.getCode()));
        entityList.add(new LogisticsSaleChannelEntity().setCode("名鉄運輸").setPlatformChannelId("名鉄運輸").setCnName("名鉄運輸").setLogisticsPlatform(LogisticsPlatformEnum.SHOPIFY.getCode()));
        entityList.add(new LogisticsSaleChannelEntity().setCode("第一貨物").setPlatformChannelId("第一貨物").setCnName("第一貨物").setLogisticsPlatform(LogisticsPlatformEnum.SHOPIFY.getCode()));
        entityList.add(new LogisticsSaleChannelEntity().setCode("DHL Parcel").setPlatformChannelId("DHL Parcel").setCnName("DHL Parcel").setLogisticsPlatform(LogisticsPlatformEnum.SHOPIFY.getCode()));
        entityList.add(new LogisticsSaleChannelEntity().setCode("DPD").setPlatformChannelId("DPD").setCnName("DPD").setLogisticsPlatform(LogisticsPlatformEnum.SHOPIFY.getCode()));
        entityList.add(new LogisticsSaleChannelEntity().setCode("Bring").setPlatformChannelId("Bring").setCnName("Bring").setLogisticsPlatform(LogisticsPlatformEnum.SHOPIFY.getCode()));
        entityList.add(new LogisticsSaleChannelEntity().setCode("Inpost").setPlatformChannelId("Inpost").setCnName("Inpost").setLogisticsPlatform(LogisticsPlatformEnum.SHOPIFY.getCode()));
        entityList.add(new LogisticsSaleChannelEntity().setCode("PTT").setPlatformChannelId("PTT").setCnName("PTT").setLogisticsPlatform(LogisticsPlatformEnum.SHOPIFY.getCode()));
        entityList.add(new LogisticsSaleChannelEntity().setCode("Yurtiçi Kargo").setPlatformChannelId("Yurtiçi Kargo").setCnName("Yurtiçi Kargo").setLogisticsPlatform(LogisticsPlatformEnum.SHOPIFY.getCode()));
        entityList.add(new LogisticsSaleChannelEntity().setCode("Aras Kargo").setPlatformChannelId("Aras Kargo").setCnName("Aras Kargo").setLogisticsPlatform(LogisticsPlatformEnum.SHOPIFY.getCode()));
        entityList.add(new LogisticsSaleChannelEntity().setCode("Sürat Kargo").setPlatformChannelId("Sürat Kargo").setCnName("Sürat Kargo").setLogisticsPlatform(LogisticsPlatformEnum.SHOPIFY.getCode()));
        entityList.add(new LogisticsSaleChannelEntity().setCode("GLS").setPlatformChannelId("GLS").setCnName("GLS").setLogisticsPlatform(LogisticsPlatformEnum.SHOPIFY.getCode()));
        entityList.add(new LogisticsSaleChannelEntity().setCode("Alliance Air Freight").setPlatformChannelId("Alliance Air Freight").setCnName("Alliance Air Freight").setLogisticsPlatform(LogisticsPlatformEnum.SHOPIFY.getCode()));
        entityList.add(new LogisticsSaleChannelEntity().setCode("Pilot Freight").setPlatformChannelId("Pilot Freight").setCnName("Pilot Freight").setLogisticsPlatform(LogisticsPlatformEnum.SHOPIFY.getCode()));
        entityList.add(new LogisticsSaleChannelEntity().setCode("LSO").setPlatformChannelId("LSO").setCnName("LSO").setLogisticsPlatform(LogisticsPlatformEnum.SHOPIFY.getCode()));
        entityList.add(new LogisticsSaleChannelEntity().setCode("Old Dominion").setPlatformChannelId("Old Dominion").setCnName("Old Dominion").setLogisticsPlatform(LogisticsPlatformEnum.SHOPIFY.getCode()));
        entityList.add(new LogisticsSaleChannelEntity().setCode("R+L Carriers").setPlatformChannelId("R+L Carriers").setCnName("R+L Carriers").setLogisticsPlatform(LogisticsPlatformEnum.SHOPIFY.getCode()));
        entityList.add(new LogisticsSaleChannelEntity().setCode("Southwest Air Cargo").setPlatformChannelId("Southwest Air Cargo").setCnName("Southwest Air Cargo").setLogisticsPlatform(LogisticsPlatformEnum.SHOPIFY.getCode()));
        entityList.add(new LogisticsSaleChannelEntity().setCode("Fastway").setPlatformChannelId("Fastway").setCnName("Fastway").setLogisticsPlatform(LogisticsPlatformEnum.SHOPIFY.getCode()));

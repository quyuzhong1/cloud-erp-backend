...
public class RemotePostcodeServiceImpl extends SuperServiceImpl<RemotePostcodeMapper, RemotePostcodeEntity> implements RemotePostcodeService {
    ...
    public BaseResultDTO.AddDTO add(RemotePostcodeDTO.AddDTO addDTO) {
        ...
        remotePostcodeEntity.setCode(code);
        ...
        // 操作日志
        String msg = StrUtil.format("用户【{}】新增【{}】单据单号为【{}】", UserContext.getDefaultLoginUser().getUserName(), "偏远邮编组" , remotePostcodeEntity.getCode());
        // TODO 此处的null需修改为日志模块类型，moduleType查看ModuleTypeEnum枚举类
        operateLogService.addModuleOperateLog(msg, null, remotePostcodeEntity.getId(), "新增操作");
        // TODO 新增明细（如果有明细的话）

        return new BaseResultDTO.AddDTO(remotePostcodeEntity.getId(), code);
    }
    ...
    */
    ...
    public Boolean update(RemotePostcodeDTO.UpdateDTO updateDTO) {
        ...
        // 数据处理
        handleData(remotePostcodeEntity);
        log.info("编辑 开始修改偏远邮编组数据，单号：【{}】", old.getCode());
        ...
        // 记录主单操作日志
            log.info("编辑 开始记录偏远邮编组日志数据，单号：【{}】", remotePostcodeEntity.getCode());
            String msg = StrUtil.format("用户【{}】编辑单号为【{}】的【{}】单据 ", UserContext.getDefaultLoginUser().getUserName(), remotePostcodeEntity.getCode(), "偏远邮编组");
        // TODO 此处的null需修改为日志模块类型，moduleType查看ModuleTypeEnum枚举类
    ...
    @Override
    public void exportList(RemotePostcodeDTO.ExportDTO param, HttpServletResponse response) {
        List<RemotePostcodeDTO.ListDTO> list = this.baseMapper.listExport(param);
        ...
        String excelPath = "excel/remotePostcode.xlsx";
        String name = "偏远邮编组导出";
    ...
    public BatchResultDTO submit(String id) {
        RemotePostcodeEntity entity = getById(id);
        if (ObjectUtil.isEmpty(entity)) {
            throw new ServiceException("未找到偏远邮编组数据");
        }
        validateSubmit(entity);
        // 更新单据审核状态
        log.info("提交 开始修改偏远邮编组状态数据，id：【{}】", id);
        this.updateApproveStatus(id, ApproveStatusEnum.APPROVE_ING.getStatus());

        // TODO 启动流程（如果需要的话）
        log.info("提交 开始启动偏远邮编组流程，id=：【{}】", entity.getId());
        startProcess(entity);
        // 记录操作日志
        log.info("提交 开始记录偏远邮编组日志数据，id：【{}】", id);
        String msg = StrUtil.format("用户【{}】单号为【{}】的【{}】单据提交审核 ", UserContext.getDefaultLoginUser().getUserName(), entity.getCode(), "偏远邮编组");
        // TODO 此处的null需修改为日志模块类型，moduleType查看ModuleTypeEnum枚举类
    ...
    @Transactional(rollbackFor = Exception.class)
    @Override
    public BaseResultDTO.AddDTO addAndSubmit(RemotePostcodeDTO.AddDTO dto) {
        // 新增
    ...
    @Transactional(rollbackFor = Exception.class)
    @Override
    public void updateAndSubmit(RemotePostcodeDTO.UpdateDTO dto) {
        // 修改
        this.update(dto);
        // 提交
    ...
    public BatchResultDTO approve(ApproveOneDTO dto) {
        ...
        RemotePostcodeEntity entity = getById(dto.getId());
        // 审核中的数据允许审核
        ...
        // 操作日志
        String msg = StrUtil.format("用户【{}】单号为【{}】的【{}】单据审核操作  审核结果：【{}】 审核意见 ：【{}】", UserContext.getDefaultLoginUser().getUserName(), entity.getCode(), "偏远邮编组", approveType.getName(), dto.getComment());
        // TODO 此处的null需修改为日志模块类型，moduleType查看ModuleTypeEnum枚举类
    ...
    * @param dto
    */
    private void approveProcess(RemotePostcodeEntity entity, ApproveOneDTO dto) {
    ...
    public BatchResultDTO disApprove(String id) {
        RemotePostcodeEntity entity = super.getByIdOpt(id).orElseThrow(() -> new ServiceException("未找到偏远邮编组单数据"));
        // 反审核条件判断
        ...
        // 操作日志
        String msg = StrUtil.format("用户【{}】单号为【{}】的【{}】单据反审核操作 ", UserContext.getDefaultLoginUser().getUserName(), entity.getCode(), "偏远邮编组");
        // TODO 此处的null需修改为日志模块类型，moduleType查看ModuleTypeEnum枚举类
        operateLogService.addModuleOperateLog(msg, null, entity.getId(), "反审核操作");
        return BatchResultDTO.success(entity.getId(), entity.getCode(), OperationTypeEnum.DISAPPROVE);
    }

    private Boolean validateDisApprove(RemotePostcodeEntity entity) {
        // 已审核支持反审核
    ...
    public BatchResultDTO delete(String id) {
        ...
        // 删除主单数据
        log.info("删除 开始删除偏远邮编组主单数据，id：【{}】", id);
        super.removeById(id);
        // 删除日志数据
        log.info("删除 开始删除偏远邮编组日志数据，id：【{}】", id);
        String msg = StrUtil.format("用户【{}】单号为【{}】的【{}】单据删除操作 ", UserContext.getDefaultLoginUser().getUserName(), entity.getCode(), "偏远邮编组");
        operateLogService.addModuleOperateLog(msg, null, entity.getCode(), "删除偏远邮编组数据");
    ...
    */
    ...
    public BatchResultDTO cancelProcess(String id) {
        ...
        log.info("撤销 开始修改偏远邮编组状态，id：【{}】", id);
        updateApproveStatus(id, ApproveStatusEnum.WAIT_SUBMIT.getStatus());

        //操作日志
        log.info("撤销 开始记录操作日志，id：【{}】", id);
        String msg = StrUtil.format("用户【{}】单号为【{}】的【{}】单据撤销流程操作 ", UserContext.getDefaultLoginUser().getUserName(), entity.getCode(), "偏远邮编组");
        // TODO 此处的null需修改为日志模块类型，moduleType查看ModuleTypeEnum枚举类
    ...
    @Override
    @Transactional(rollbackFor = Exception.class)
    public Boolean approveEnd(ApproveOneDTO dto, RemotePostcodeEntity entity) {
        if (ObjectUtil.isEmpty(entity)) {
            return Boolean.TRUE;
        }
    ...
    **/
    ...
    public void startProcess(RemotePostcodeEntity entity) {
    ...
    private void fillOne(RemotePostcodeDTO.ViewDTO data) {
    ...
    */
    public void updateForApprove(String id, String approveStatus) {
        this.lambdaUpdate().eq(RemotePostcodeEntity::getId, id)
            .set(RemotePostcodeEntity::getApproveStatus, approveStatus)
            .update(new RemotePostcodeEntity());
     }
    ...
    */
    ...
    public void updateApproveStatus(String id, String approveStatus) {
        lambdaUpdate().eq(RemotePostcodeEntity::getId, id)
        .set(RemotePostcodeEntity::getApproveStatus, approveStatus)
        .update(new RemotePostcodeEntity());
    }
    ...
    * 分页查询、导出 数据处理
    */
    private void fillList(List<RemotePostcodeDTO.ListDTO> list) {
        if(CollUtil.isEmpty(list)) {
           return;
        }

        // 属性赋值
        for(RemotePostcodeDTO.ListDTO data : list) {
    ...
    * 分页查询、导出 数据处理
    */
    private void validateSubmit(RemotePostcodeEntity entity) {
        // 待提交或审核不通过并且未作废允许提交

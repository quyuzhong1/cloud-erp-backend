        ...
        stage('远程执行k8s-master的kubectl命令') {
            steps {
                sh '''
                    ...
                    ssh -tt root@172.16.100.60 "/usr/bin/kubectl delete -f /k8s-yaml/erp-server/erp-server-dmp.yaml -f /k8s-yaml/erp-server/erp-server-file.yaml -f /k8s-yaml/erp-server/erp-server-mrp.yaml -f /k8s-yaml/erp-server/erp-server-msg.yaml -f /k8s-yaml/erp-server/erp-server-oms.yaml -f /k8s-yaml/erp-server/erp-server-plm.yaml -f /k8s-yaml/erp-server/erp-server-scm.yaml -f /k8s-yaml/erp-server/erp-server-srm.yaml -f /k8s-yaml/erp-server/erp-server-sys.yaml -f /k8s-yaml/erp-server/erp-server-tms.yaml -f /k8s-yaml/erp-server/erp-server-wms.yaml -f /k8s-yaml/erp-server/erp-server-workflow.yaml|| true"

                    ssh -tt root@172.16.100.60 "/usr/bin/kubectl apply -f /k8s-yaml/erp-server/erp-server-dmp.yaml -f /k8s-yaml/erp-server/erp-server-file.yaml -f /k8s-yaml/erp-server/erp-server-mrp.yaml -f /k8s-yaml/erp-server/erp-server-msg.yaml -f /k8s-yaml/erp-server/erp-server-oms.yaml -f /k8s-yaml/erp-server/erp-server-plm.yaml -f /k8s-yaml/erp-server/erp-server-scm.yaml -f /k8s-yaml/erp-server/erp-server-srm.yaml -f /k8s-yaml/erp-server/erp-server-sys.yaml -f /k8s-yaml/erp-server/erp-server-tms.yaml -f /k8s-yaml/erp-server/erp-server-wms.yaml -f /k8s-yaml/erp-server/erp-server-workflow.yaml"
                    '''
            }
        }
    }

...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir(projectPath + "/erp-chrome/src/main/java"); // 输出路径(写死无需更改！！！)
        ...
        dc.setUrl("jdbc:postgresql://192.168.31.86:5432/erp-chrome?useSSL=false&serverTimezone=GMT%2B8");
        ...
        pc.setParent("com.cloud.erp.chrome");//代码生成到哪个包下面
//        pc.setModuleName(""); //此处是所属模块名称
        ...
        focList.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                return projectPath +"/erp-chrome"+"/src/main/resources/mapper/"

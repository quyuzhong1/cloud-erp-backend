...
| **名称含 id/type/status** | select | string | 检索 `skills/data/query_option_lite.md` Markdown 表格匹配 ID |
...
## 3. 特殊逻辑红线 🚨
- **动态维护**: 生成 `cfg_query_option` 脚本后，自动将其 ID/URL/Name 按 Markdown 表格行追加至 `skills/data/query_option_lite.md` 引用库。

...
/**
 * 
 * @TableName bi_delivery_detail_info
 */
@TableName(value ="bi_delivery_detail_info")
@Data
public class BiDeliveryDetailInfoEntity implements Serializable {
    /**
     * 主键id
     */
    ...
    private List<BiDeliveryDetailItemEntity> details;

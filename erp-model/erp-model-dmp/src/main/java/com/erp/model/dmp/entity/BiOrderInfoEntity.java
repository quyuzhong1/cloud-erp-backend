...
/**
 * @TableName bi_order_info
 */
@TableName(value = "bi_order_info")
@Data
@NoArgsConstructor
public class BiOrderInfoEntity implements Serializable {
    /**
     * 主键id
     */
...
//    private String customerCode;
    ...
    @TableField(exist = false)
    private List<BiOrderItemSplitEntity> itemList;
    ...
    public BiOrderInfoEntity(BiOrderInfoEntity entity, BigDecimal exchangeRate) {

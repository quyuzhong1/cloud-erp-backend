...
@Data
@NoArgsConstructor
public class DmpPushMsgHisDTO implements Serializable {
    ...
    */
    ...
    public static class CommonDTO {
        ...
        */
        ...
        @Size(max = 255,message = "来源编号最大长度不能超过255位")
        private String sourceCode;
        ...
        */
        ...
        @Size(max = 1000,message = "父id最大长度不能超过1,000位")
        private String parentId;
        ...
        */
        ...
        @Size(max = 255,message = "第三方编号最大长度不能超过255位")
        private String thirdCode;

...
public class AmzReportScheduleEntity extends BaseEntity<AmzReportScheduleEntity> {
     ...
     */
    public AmzReportScheduleEntity(String reportType, String marketplaceId, String shopId, String period, String amzReportScheduleId) {
        this.amzReportScheduleId = amzReportScheduleId;

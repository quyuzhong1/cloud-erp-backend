...
@TableName("dmp_return_instock_detail")
public class DmpReturnInstockDetailEntity extends BaseEntity<DmpReturnInstockDetailEntity> {
    ...
    * 第三方退货入库明细id
    */
    @TableField("third_return_instock_detail_id")
    private String thirdReturnInstockDetailId;
    /**
    * 第三方明细创建时间
    */
    ...
    * 退货入库金额
    */
    @TableField("return_instock_amount")
    ...
    */
    ...
    public static final String THIRD_RETURN_INSTOCK_DETAIL_ID = "third_return_instock_detail_id";
    ...
    public static final String RETURN_INSTOCK_QTY = "return_instock_qty";

    public static final String UNIT = "unit";

    public static final String RETURN_INSTOCK_AMOUNT = "return_instock_amount";

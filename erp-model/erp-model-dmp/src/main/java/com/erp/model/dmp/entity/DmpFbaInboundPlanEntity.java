...
@TableName("dmp_fba_inbound_plan")
public class DmpFbaInboundPlanEntity extends BaseEntity<DmpFbaInboundPlanEntity> {
     ...
     * 装箱选项JSON
     */
    @TableField("packing_options_json")
    private String packingOptionsJson;

    /**
     * 分仓选项JSON
     */
    @TableField("placement_options_json")
    private String placementOptionsJson;

    /**
     * 货件集合JSON
     */
    @TableField("shipments_json")

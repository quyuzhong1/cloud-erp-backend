...
/**
 * 退款表
 * @TableName bi_refund_info
 */
@TableName(value ="bi_refund_info")
@Data
@NoArgsConstructor
public class BiRefundInfoEntity implements Serializable {
    /**
     * 主键id
     */
    ...
    @TableField(exist = false)
    private List<BiRefundItemEntity> itemList;

    @TableField(exist = false)
    private static final long serialVersionUID = 1L;

    public BiRefundInfoEntity(BiRefundInfoEntity entity, BigDecimal exchangeRate) {

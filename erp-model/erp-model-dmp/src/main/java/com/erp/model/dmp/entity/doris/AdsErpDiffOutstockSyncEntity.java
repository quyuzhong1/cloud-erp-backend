...
@NoArgsConstructor
@TableName("ads_erp_diff_outstock_sync")
public class AdsErpDiffOutstockSyncEntity extends BaseEntity<AdsErpDiffOutstockSyncEntity> {
    ...
    * 平台出库单号
    */
    @TableField("platform_outstock_code")
    ...
    */
    ...
    public static final String PLATFORM_OUTSTOCK_CODE = "platform_outstock_code";

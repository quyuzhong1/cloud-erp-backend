...
/**
 * 退货订单表
 * @TableName bi_return_order_info
 */
@TableName(value ="bi_return_order_info")
@Data
@NoArgsConstructor
public class BiReturnOrderInfoEntity implements Serializable {
    /**
     * 主键id
     */
    ...
    private List<BiReturnOrderItemEntity> itemList;

    @TableField(exist = false)
    private static final long serialVersionUID = 1L;

    public BiReturnOrderInfoEntity(BiReturnOrderInfoEntity entity, BigDecimal exchangeRate) {

...
@NoArgsConstructor
@TableName("ads_erp_receive_flow_diff")
public class AdsErpReceiveFlowDiffEntity extends BaseEntity<AdsErpReceiveFlowDiffEntity> {
    ...
    */
    ...
    public static final String TRANSFER_INFO_CODE = "transfer_info_code";

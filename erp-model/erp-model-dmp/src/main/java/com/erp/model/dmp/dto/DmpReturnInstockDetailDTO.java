...
@Data
@NoArgsConstructor
public class DmpReturnInstockDetailDTO implements Serializable {
    ...
    */
    ...
    public static class CommonDTO {
        ...
        * 第三方退货入库明细id
        */
        @NotBlank(message = "第三方退货入库明细id不能为空")
        @Size(max = 64,message = "第三方退货入库明细id最大长度不能超过64位")
        private String thirdReturnInstockDetailId;
        ...
        */
        ...
        @Size(max = 64,message = "商家SKU名称最大长度不能超过64位")
        private String skuName;
        ...
        */
        ...
        @Size(max = 1000,message = "备注最大长度不能超过1,000位")
        private String remark;

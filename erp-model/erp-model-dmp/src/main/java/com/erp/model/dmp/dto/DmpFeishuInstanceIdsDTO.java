...
@Data
@NoArgsConstructor
public class DmpFeishuInstanceIdsDTO implements Serializable {
    ...
    */
    ...
    public static class CommonDTO {
        ...
        * 飞书实例ID
        */
        @NotBlank(message = "飞书实例ID不能为空")
        @Size(max = 255,message = "飞书实例ID最大长度不能超过255位")
        private String instanceId;

        /**
        * ERP实例代号
        */
        @NotBlank(message = "ERP实例代号不能为空")
        @Size(max = 255,message = "ERP实例代号最大长度不能超过255位")
        private String ulanziApprovalCode;

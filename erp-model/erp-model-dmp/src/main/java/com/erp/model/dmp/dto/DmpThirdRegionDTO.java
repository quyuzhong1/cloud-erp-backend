...
@Data
@NoArgsConstructor
public class DmpThirdRegionDTO implements Serializable {
    ...
    */
    ...
    public static class CommonDTO {
        ...
        * 父级区域id
        */
        @NotBlank(message = "父级区域id不能为空")
        @Size(max = 64,message = "父级区域id最大长度不能超过64位")
        private String parentRegionId;
        ...
        */
        ...
        @Size(max = 500,message = "区域id最大长度不能超过500位")
        private String regionId;
        ...
        */
        ...
        @Size(max = 64,message = "区域等级最大长度不能超过64位")
        private String regionLevel;
        ...
        */
        ...
        @Size(max = 500,message = "区域名称最大长度不能超过500位")
        private String regionName;

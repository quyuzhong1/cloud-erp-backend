 ...
 *
 * @author hcg
 * @since 2025-05-12 16:17:47
 */
public enum CfgProcessBussinessKeyEnum implements EnumMessage {
	...
	CfgProcessBussinessKeyEnum(String code, String name) {
        this.code = code;
        this.name = name;
    }
    ...
    public static String getName(String code) {
        ...
        for (CfgProcessBussinessKeyEnum statusEnum : CfgProcessBussinessKeyEnum.values()) {

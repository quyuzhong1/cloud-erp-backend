...
public class KolPartnerInfoImportExcelDTO implements Serializable {
    ...
    @Data
    @NoArgsConstructor
    public static class UpdateExcelDTO implements Serializable {

        /**
         * 达人编码
         */
        @ColumnWidth(25)
        @ExcelProperty(value = "*达人编码", index = 0)
        @FieldValid(fieldName = "*达人编码", isNotBlank = true)
        private String code;
        ...
        @FieldValid(fieldName = "达人昵称", maxLength = 200)
        private String nickname;
         ...
         */
        @ColumnWidth(20)
        @ExcelProperty(value = "达人类型", index = 2)
        @FieldValid(fieldName = "达人类型")
        private String typeName;
        @ExcelIgnore
        private String type;
         ...
         */
        @ColumnWidth(20)
        @ExcelProperty(value = "合作类型", index = 3)
        @FieldValid(fieldName = "合作类型")
        private String cooperationTypeName;
        @ExcelIgnore
        private String cooperationType;
         ...
         */
        @ColumnWidth(20)
        @ExcelProperty(value = "合作日期", index = 4)
        @FieldValid(fieldName = "合作日期")
        private String cooperationDateStr;
        @ExcelIgnore
        private LocalDate cooperationDate;
         ...
         */
        @ColumnWidth(30)
        @ExcelProperty(value = "国家", index = 5)
         ...
         */
        @ColumnWidth(30)
        @ExcelProperty(value = "语言", index = 6)
        @FieldValid(fieldName = "语言")
        private String languageName;
        @ExcelIgnore
        private String language;
        ...
        @FieldValid(fieldName = "邮箱", maxLength = 100)
        private String email;
        ...
        @FieldValid(fieldName = "电话", maxLength = 20)
        private String phone;
         ...
         */
        @ColumnWidth(20)
        @ExcelProperty(value = "负责部门", index = 10)
        @FieldValid(fieldName = "负责部门")
        private String deptName;
        @ExcelIgnore
        private String deptId;
         ...
         */
        @ColumnWidth(20)
        @ExcelProperty(value = "合作平台", index = 12)
        @FieldValid(fieldName = "合作平台")
        private String platformName;
         ...
         */
        @ColumnWidth(20)
        @ExcelProperty(value = "账号ID", index = 13)
        @FieldValid(fieldName = "账号ID")
        private String platformAccountId;
         ...
         */
        @ColumnWidth(20)
        @ExcelProperty(value = "账号名称", index = 14)
        @FieldValid(fieldName = "账号名称")
        private String platformAccountName;
         ...
         */
        @ColumnWidth(20)
        @ExcelProperty(value = "主页链接", index = 16)
        @FieldValid(fieldName = "主页链接", maxLength = 500)
        private String homepageUrl;
         ...
         */
        @ColumnWidth(20)
        @ExcelProperty(value = "平台备注", index = 17)
        @FieldValid(fieldName = "平台备注", maxLength = 500)
        private String platformRemark;
         ...
         */
        @ColumnWidth(20)
        @ExcelProperty(value = "省/州", index = 19)
         ...
         */
        @ColumnWidth(20)
        @ExcelProperty(value = "城市", index = 20)
        @FieldValid(fieldName = "城市")
        private String city;
        @ExcelIgnore
        private String cityId;
         ...
         */
        @ColumnWidth(20)
        @ExcelProperty(value = "区域", index = 21)
        @FieldValid(fieldName = "区域")
        private String district;
        @ExcelIgnore
        private String districtId;
         ...
         */
        @ColumnWidth(20)
        @ExcelProperty(value = "联系人电话", index = 24)
        @FieldValid(fieldName = "联系人电话")
        private String contactPersonPhone;
         ...
         */
        @ColumnWidth(20)
        @ExcelProperty(value = "联系人邮编", index = 25)
        @FieldValid(fieldName = "联系人邮编")
        private String zipCode;
         ...
         */
        @ColumnWidth(20)
        @ExcelProperty(value = "收件人税号", index = 26)
        @FieldValid(fieldName = "收件人税号")
        private String receiverTaxNo;
         ...
         */
        @ColumnWidth(20)
        @ExcelProperty(value = "默认地址", index = 27)
        @FieldValid(fieldName = "默认地址")
        private String isDefaultName;
         ...
         */
        @ColumnWidth(20)
        @ExcelProperty(value = "启用状态", index = 28)
        @FieldValid(fieldName = "启用状态")
        private String disabledName;
         ...
         */
        @ColumnWidth(20)
        @ExcelProperty(value = "地址备注", index = 29)
        @FieldValid(fieldName = "地址备注")
        private String addressRemark;
         ...
         * 错误数据
         */
        @ExcelProperty(value = "错误数据", index = 30)
        @ColumnWidth(50)
        private String errorMsg = "";
    }
}

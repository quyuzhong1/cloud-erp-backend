...
public class ProductSaleDTO implements Serializable {
     ...
     * 年目标销售额
     */
    @Digits(integer = 18, fraction = 6,message = "年目标销售额最大16字符，小数位不能大于6位")
     ...
     * 月目标销售额
     */
    @Digits(integer = 18, fraction = 6,message = "月目标销售额最大16字符，小数位不能大于6位")
     ...
     * 首季度目标销量
     */
    @Digits(integer = 18, fraction = 6,message = "首季度目标销量最大16字符")

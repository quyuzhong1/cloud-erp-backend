...
public class ProductCustomsDTO {
    ...
    public static class CommonDTO {
        ...
        @Digits(integer = 18, fraction = 6, message = "目的国关税税率整数位不能超过18位，小数位不能超过6位")
        ...
        @Digits(integer = 18, fraction = 6, message = "目的国增值税税率整数位不能超过18位，小数位不能超过6位")
        ...
        @Digits(integer = 18, fraction = 6, message = "目的国附加关税税率整数位不能超过18位，小数位不能超过6位")
        ...
        @Digits(integer = 18, fraction = 6, message = "目的国反倾销税税率整数位不能超过18位，小数位不能超过6位")
        ...
        @Digits(integer = 18, fraction = 6, message = "目的国其他税率整数位不能超过18位，小数位不能超过6位")

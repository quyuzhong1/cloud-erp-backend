...
public class ProductDetailExcelDTO {
     ...
     * skuNo
     */
    //@ExcelProperty( value = "skuNo", index = 1)
    ...
    @FieldValid(fieldName = "一级类目", isNotBlank = true)
     ...
     */
    //@ExcelProperty( value = "产品分类", index = 2)
    @FieldValid(fieldName = "二级类目", isNotBlank = true)
    private String secondaryCategory;

    /**
     * 销售方式
     */
    //@ExcelProperty( value = "销售方式", index = 3)
     ...
     * 品名
     */
    //@ExcelProperty(value = "品名", index = 9)
     ...
     * 品名（英文）
     */
    //@ExcelProperty(value = "品名（英文）", index = 10)
     ...
     * 产品属性
     */
    //@ExcelProperty(value = "产品属性", index = 12)
    private String property;

    /**
     * 计划上市时间
     */
    //@ExcelProperty(value = "计划上市时间", index = 13)
     ...
     * 目标含税成本
     */
    //@ExcelProperty(value = "目标含税成本", index = 16)
    private String targetTaxCost;

    /**
     * 目标不含税成本
     */
    //@ExcelProperty(value = "目标不含税成本", index = 17)
    private String targetNoTaxCost;

    /**
     * 实际含税成本
     */
    //@ExcelProperty(value = "实际含税成本", index = 18)
    private String actualTaxCost;

    /**
     * 实际不含税成本
     */
    //@ExcelProperty(value = "实际不含税成本", index = 19)
    private String actualNoTaxCost;

    /**
     * 标准零售价
     */
    //@ExcelProperty(value = "标准零售价", index = 20)
    private String retailPrice;

    /**
     * 目标毛利率
     */
    //@ExcelProperty(value = "目标毛利率", index = 21)
    private String targetGpm;

    /**
     * 实际毛利率(人民币)
     */
    //@ExcelProperty(value = "实际毛利率(人民币)", index = 22)
    private String actualGpmCny;

    /**
     * 实际毛利率(美元)
     */
    //@ExcelProperty(value = "实际毛利率(美元)", index = 23)
    private String actualGpmUsd;

    /**
     * 年目标销售量
     */
    //@ExcelProperty(value = "年目标销售量", index = 24)
     ...
     * 年目标销售额
     */
    //@ExcelProperty(value = "年目标销售额", index = 25)
     ...
     * 月目标销售量
     */
    //@ExcelProperty(value = "月目标销售量", index = 26)
     ...
     * 月目标销售额
     */
    //@ExcelProperty(value = "月目标销售额", index = 27)
     ...
     * 销售国家
     */
    //@ExcelProperty(value = "销售国家", index = 28)
    private String saleCountry;

    /**
     * 上市时间
     */
    //@ExcelProperty(value = "上市时间", index = 29)
     ...
     * 退市时间
     */
    //@ExcelProperty(value = "退市时间", index = 30)
     ...
     * 图片是否完成
     */
    //@ExcelProperty(value = "图片是否完成", index = 31)
     ...
     * 视频是否完成
     */
    //@ExcelProperty(value = "视频是否完成", index = 32)
     ...
     * 销售状态
     */
    //@ExcelProperty(value = "销售状态", index = 33)
     ...
     * 报关产品属性
     */
    //@ExcelProperty(value = "报关产品属性", index = 34)
    private String productProperty;

    /**
     * 报关中文名
     */
    //@ExcelProperty(value = "报关中文名", index = 35)
    private String declareChineseName;

    /**
     * 报关英文名
     */
    //@ExcelProperty(value = "报关英文名", index = 36)
    private String declareEnglishName;

    /**
     * 报关申报价格
     */
    //@ExcelProperty(value = "报关申报价格", index = 37)
     ...
     * 海关编码
     */
    //@ExcelProperty(value = "海关编码", index = 38)
    private String customsCode;

    /**
     * 申报要素
     */
    //@ExcelProperty(value = "申报要素", index = 39)
    private String declareElement;

    /**
     * 英文材质
     */
    //@ExcelProperty(value = "英文材质", index = 40)
    private String englishMaterial;

    /**
     * 英文用途
     */
    //@ExcelProperty(value = "英文用途", index = 41)
    private String englishUsage;

    /**
     * 产品尺寸(长)
     */
    //@ExcelProperty(value = "产品尺寸(长)", index = 42)
     ...
     * 产品尺寸(宽)
     */
    //@ExcelProperty(value = "产品尺寸(宽)", index = 43)
     ...
     * 产品尺寸(高)
     */
    //@ExcelProperty(value = "产品尺寸(高)", index = 44)
     ...
     * 毛重
     */
    //@ExcelProperty(value = "毛重", index = 45)
     ...
     * 净重
     */
    //@ExcelProperty(value = "净重", index = 46)
     ...
     * 箱规(长)
     */
    //@ExcelProperty(value = "箱规(长)", index = 47)
     ...
     * 箱规(宽)
     */
    //@ExcelProperty(value = "箱规(宽)", index = 48)
     ...
     * 箱规(高)
     */
    //@ExcelProperty(value = "箱规(高)", index = 49)
     ...
     * 单箱重量
     */
    //@ExcelProperty(value = "单箱重量", index = 50)
     ...
     * 单箱数量
     */
    //@ExcelProperty(value = "单箱数量", index = 51)
     ...
     * ean码
     */
    //@ExcelProperty(value = "ean码", index = 52)
    private String ean;

    /**
     * 计划首批下单量
     */
    //@ExcelProperty(value = "计划首批下单量", index = 53)
     ...
     * 首批下单时间
     */
    //@ExcelProperty(value = "首批下单时间", index = 54)
     ...
     * 预计首批到货时间
     */
    //@ExcelProperty(value = "预计首批到货时间", index = 55)
     ...
     * MOQ(最小起订量)
     */
    //@ExcelProperty(value = "MOQ(最小起订量)", index = 56)
     ...
     * 交货周期(天)
     */
    //@ExcelProperty(value = "交货周期(天)", index = 57)
     ...
     * 实际首批到货时间
     */
    //@ExcelProperty(value = "实际首批到货时间", index = 58)
     ...
     * 实际首批到货量
     */
    //@ExcelProperty(value = "实际首批到货量", index = 59)
     ...
     * 首批到货状态
     */
    //@ExcelProperty(value = "首批到货状态", index = 60)
     ...
     * 采购员
     */
    //@ExcelProperty(value = "采购员", index = 61)
    private String purchaseUser;

    /**
     * 一级供应商
     */
    //@ExcelProperty(value = "一级供应商", index = 62)
    private String mainSupplier;

    /**
     * 二级供应商
     */
    //@ExcelProperty(value = "二级供应商", index = 63)
    private String secondSupplier;

    /**
     * 量产入库时间
     */
    //@ExcelProperty(value = "量产入库时间", index = 64)
     ...
     * 产品开发状态
     */
    //@ExcelProperty(value = "产品开发状态", index = 65)
     ...
     * 错误信息
     */
    //@ExcelProperty(value = "错误信息", index = 66)

...
@Data
@NoArgsConstructor
public class ProductTaskViewPersonnelExcelDTO implements Serializable {
    ...
    @ColumnWidth(20)
    @ExcelProperty(value = "计划开始日期", index = 3)
    ...
    @ColumnWidth(20)
    @ExcelProperty(value = "实际开始日期", index = 5)
    @JsonFormat(pattern = "yyyy-MM-dd", timezone = "GMT+8")
    private Date realityStartTime;

    @ColumnWidth(20)
    @ExcelProperty(value = "实际结束日期", index = 6)
    @JsonFormat(pattern = "yyyy-MM-dd", timezone = "GMT+8")

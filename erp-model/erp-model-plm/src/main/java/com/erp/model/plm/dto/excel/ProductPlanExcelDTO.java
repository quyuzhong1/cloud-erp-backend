...
public class ProductPlanExcelDTO implements Serializable {
     ...
     * 产品等级
     */
    @ExcelProperty(value = "产品等级", index = 5)
    private String grade;

    /**
     * 产品款品
     */
    @ExcelProperty(value = "产品款品", index = 6)
     ...
     * 新品/老品
     */
    @ExcelProperty(value = "新品/老品升级", index = 7)
     ...
     * 三代规划（721原则）
     */
    @ExcelProperty(value = "三代规划（721原则）", index = 8)
     ...
     * 产品名称
     */
    @ExcelProperty(value = "*产品名称（中文）", index = 9)
     ...
     * 产品名称（英文）
     */
    @ExcelProperty(value = "产品名称（英文）", index = 10)
    private String nameEn;

    /**
     * 核心专利
     */
    @ExcelProperty(value = "核心专利", index = 11)
    private String patent;

    /**
     * 对标竞品链接
     */
    @ExcelProperty(value = "对标竞品链接", index = 12)
    private String competitiveProductLink;

    /**
     * SPU（型号Model）
     */
    @ExcelProperty(value = "SPU（型号Model）", index = 13)
    private String spuNo;

    /**
     * sku数量
     */
    @ExcelProperty(value = "sku数量", index = 14)
     ...
     * 规格参数
     */
    @ExcelProperty(value = "规格参数", index = 15)
    private String specification;

    /**
     * 应用场景
     */
    @ExcelProperty(value = "应用场景", index = 16)
    private String applicationScenario;

    /**
     * 场景类目
     */
    @ExcelProperty(value = "场景类目", index = 17)
    private String sceneCategory;

    /**
     * 使用场景描述
     */
    @ExcelProperty(value = "使用场景描述", index = 18)
    private String applicationScenarioDesc;

    /**
     * 主要卖点描述
     */
    @ExcelProperty(value = "主要卖点描述", index = 19)
     ...
     * 销售目标国家
     */
    @ExcelProperty(value = "销售目标国家", index = 20)
     ...
     * 销售平台/渠道
     */
    @ExcelProperty(value = "销售平台/渠道", index = 21)
     ...
     * 人民币定价
     */
    @ExcelProperty(value = "人民币定价", index = 22)
     ...
     * 美元定价
     */
    @ExcelProperty(value = "美元定价", index = 23)
     ...
     * 是否需要ID设计
     */
    @ExcelProperty(value = "是否需要ID设计", index = 24)
     ...
     * 是否需要结构设计
     */
    @ExcelProperty(value = "是否需要结构设计", index = 25)
     ...
     * 目标成本
     */
    @ExcelProperty(value = "目标成本", index = 26)
     ...
     * 摸具成本预估
     */
    @ExcelProperty(value = "摸具成本预估", index = 27)
     ...
     * 供应商状态
     */
    @ExcelProperty(value = "供应商状态", index = 28)
    private String supplierStatus;

    /**
     * 主要供应商名称
     */
    @ExcelProperty(value = "主要供应商名称", index = 29)
    private String mainSupplierName;

    /**
     * 项目类型（同产品属性）
     */
    @ExcelProperty(value = "项目类型", index = 30)
    private String property;

    /**
     * 计划调研时间
     */
    @ExcelProperty(value = "计划调研时间", index = 31)
     ...
     * 计划立项时间
     */
    @ExcelProperty(value = "计划立项时间", index = 32)
     ...
     * 计划首批入库时间
     */
    @ExcelProperty(value = "计划首批入库时间", index = 33)
     ...
     * 计划上市季节
     */
    @ExcelProperty(value = "计划上市季节", index = 34)

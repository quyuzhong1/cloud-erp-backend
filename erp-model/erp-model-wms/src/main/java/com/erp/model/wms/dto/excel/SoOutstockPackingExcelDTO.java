...
@Data
@NoArgsConstructor
public class SoOutstockPackingExcelDTO implements Serializable {
    ...
    @FieldValid(fieldName = "出库单号", isNotBlank = true)
    private String code;
     ...
     * 发货箱号
     */
    @ExcelProperty(value = "出库箱号", index = 2)
    @FieldValid(fieldName = "出库箱号", isNotBlank = true)

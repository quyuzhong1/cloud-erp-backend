...
@Data
@TableName("warehouse_location_replenishment")
public class WarehouseLocationReplenishmentEntity extends BaseEntity<WarehouseLocationReplenishmentEntity> implements Serializable {
    /**
     * sku id
     */
    @TableField("sku_id")

 ...
 */
@Data
public class VwAllocationAllocationTransferExcelDTO1 extends VwAllocationExcelDTO implements Serializable {
     ...
     */
    @ColumnWidth(30)
    @ExcelProperty(value = "调出虚拟仓", index = 2)
    @FieldValid(fieldName = "调出虚拟仓", isNotBlank = true)
     ...
     */
    @ColumnWidth(30)
    @ExcelProperty(value = "调入虚拟仓", index = 4)

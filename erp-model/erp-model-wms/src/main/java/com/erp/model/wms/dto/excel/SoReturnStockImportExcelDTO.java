...
public class SoReturnStockImportExcelDTO implements Serializable {
     ...
     * 退货物流单号
     */
    @ExcelProperty(value = "退货物流单号", index = 4)
     ...
     * 上架数量
     */
    @ExcelProperty(value = "*上架数量", index = 6)
     ...
     * 仓位
     */
    @ExcelProperty(value = "仓位", index = 7)
     ...
     * 退货金额
     */
    @ExcelProperty(value = "退货金额", index = 8)
     ...
     * 含税退货金额
     */
    @ExcelProperty(value = "含税退货金额", index = 9)
     ...
     * 退货原因
     */
    @ExcelProperty(value = "*退货原因", index = 11)

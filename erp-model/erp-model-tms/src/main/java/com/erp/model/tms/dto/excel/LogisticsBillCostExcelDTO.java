...
public class LogisticsBillCostExcelDTO  implements Serializable {
     ...
     * 销售订单号
     */
    @ExcelProperty(value = "销售订单号" , index = 3)
     ...
     * 物流跟踪单号
     */
    @ExcelProperty(value = "物流跟踪单号", index = 4)
     ...
     * 计费重[预估]
     */
    @ExcelProperty(value = "计费重[预估]", index = 5)
     ...
     * 计费重[物流商]
     */
    @ExcelProperty(value = "计费重[物流商]", index = 6)
     ...
     * 类型
     */
    @ExcelProperty(value = "*对账类型", index = 11)
     ...
     * 费用名称
     */
    @ExcelProperty(value = "*费用名称", index = 12)
     ...
     * 实际运费
     */
    @ExcelProperty(value = "*实际金额", index = 13)
     ...
     * 币种
     */
    @ExcelProperty(value = "*实际币种", index = 14)
     ...
     * 预估运费
     */
    @ExcelProperty(value = "预估金额", index = 15)
     ...
     * 预估币种
     */
    @ExcelProperty(value = "预估币种", index = 16)
     ...
     * 账单确认时间
     */
    @ExcelProperty(value = "账单确认时间", index = 17)

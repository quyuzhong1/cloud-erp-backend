...
public class LogisticsLastMileCostExcelDTO implements Serializable {
     ...
     * 类型
     */
    @ExcelProperty(value = "*对账类型", index = 6)
     ...
     * 包装尺寸(物流商)
     */
    @ExcelProperty(value = "包装尺寸长(物流商)", index = 8)
     ...
     * 计费重[物流商]
     */
    @ExcelProperty(value = "包装尺寸宽(物流商)", index = 9)
     ...
     * 包装尺寸高(物流商)
     */
    @ExcelProperty(value = "包装尺寸高(物流商)", index = 10)
     ...
     * 实重(物流商)
     */
    @ExcelProperty(value = "实重(物流商)", index = 11)
     ...
     * 账单确认时间
     */
    @ExcelProperty(value = "账单确认时间", index = 12)

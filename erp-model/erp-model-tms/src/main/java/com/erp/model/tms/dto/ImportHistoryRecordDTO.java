...
public class ImportHistoryRecordDTO implements Serializable {
    ...
    public static class ImportSyncDTO extends BaseDTO.ImportDTO{
        ...
        public ImportSyncDTO (ImportDTO importDTO,BaseDTO.ImportDTO baseImportDTO) {
            ...
            this.costType = importDTO.getCostType();
            this.processingType = importDTO.getProcessingType();
            this.reconciliationMonth = importDTO.getReconciliationMonth();
            //赋值baseImportDTO属性
            this.setTaskId(baseImportDTO.getTaskId());
            this.setFileUrl( baseImportDTO.getFileUrl());
            this.setFileName(baseImportDTO.getFileName());
            this.setImportCount(baseImportDTO.getImportCount());
            this.setImportType(baseImportDTO.getImportType());

...
@Data
@NoArgsConstructor
public class SmallBagCostAllocationMainDTO implements Serializable {
    ...
    */
    ...
    public static class ViewDTO {
        ...
        */
        ...
        /**
        * 费用来源：confirmed=实际账单，estimateConfirm=暂估账单
        */
    ...
    */
    ...
    public static class CommonDTO {
        ...
        * 费用来源：confirmed=实际账单，estimateConfirm=暂估账单
        */
        @NotBlank(message = "费用来源：confirmed=实际账单，estimateConfirm=暂估账单不能为空")
        @Size(max = 20,message = "费用来源：confirmed=实际账单，estimateConfirm=暂估账单最大长度不能超过20位")
        private String feeSource;

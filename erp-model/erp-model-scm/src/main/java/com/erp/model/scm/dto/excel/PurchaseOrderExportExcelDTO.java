...
public class PurchaseOrderExportExcelDTO implements Serializable {
     ...
     * 作废状态（0未作废，1已作废）
     */
    @ExcelProperty(value = "作废状态", index = 5)
     ...
     * 报关名称
     */
    @ExcelProperty(value = "报关名称", index = 9)
    private String declareName;

    /**
     * 报关型号
     */
    @ExcelProperty(value = "报关型号", index = 10)
    private String declareModel;

    /**
     * 计划交期
     */
    @ExcelProperty(value = "计划交期", index = 11)
     ...
     * 采购数量
     */
    @ExcelProperty(value = "采购数量", index = 15)
    private Integer purchaseQty;

    /**
     * 采购金额
     */
    @ExcelProperty(value = "采购金额", index = 16)
    private BigDecimal purchaseAmount;

    /**
     * 待交货量
     */
    @ExcelProperty(value = "待交货量", index = 17)
     ...
     * 入库数量
     */
    @ExcelProperty(value = "入库数量", index = 19)
    private Integer stockInQty;

    /**
     * 退货数量
     */
    @ExcelProperty(value = "退货数量", index = 20)

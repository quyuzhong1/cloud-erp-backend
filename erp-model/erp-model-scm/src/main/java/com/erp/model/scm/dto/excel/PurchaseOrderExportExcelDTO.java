...
public class PurchaseOrderExportExcelDTO implements Serializable {
     ...
     */
    @ExcelProperty(value = "到货状态", index = 5)
     ...
     * 报关名称
     */
    @ExcelProperty(value = "报关名称", index = 8)
    private String declareName;

    /**
     * 报关型号
     */
    @ExcelProperty(value = "报关型号", index = 9)
    private String declareModel;

    /**
     * 计划交期
     */
    @ExcelProperty(value = "计划交期", index = 10)
     ...
     * 采购数量
     */
    @ExcelProperty(value = "采购数量", index = 13)
    private Integer purchaseQty;

    /**
     * 采购金额
     */
    @ExcelProperty(value = "采购金额", index = 14)
    private BigDecimal purchaseAmount;

    /**
     * 待交货量
     */
    @ExcelProperty(value = "待交货量", index = 15)
    private Integer deliveryQty;

    /**
     * 签收数量
     */
    @ExcelProperty(value = "签收数量", index = 16)
    private Integer receiveQty;

    /**
     * 入库数量
     */
    @ExcelProperty(value = "入库数量", index = 17)
    private Integer stockInQty;

    /**
     * 退货数量
     */
    @ExcelProperty(value = "退货数量", index = 18)
     ...
     * 申请人
     */
    @ExcelProperty(value = "申请人", index = 21)

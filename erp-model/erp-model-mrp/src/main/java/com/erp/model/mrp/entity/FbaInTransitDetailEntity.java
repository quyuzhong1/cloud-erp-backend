...
@TableName("fba_in_transit_detail")
@EqualsAndHashCode(callSuper = true)
public class FbaInTransitDetailEntity extends BaseEntity<FbaInTransitDetailEntity> {

    private static final long serialVersionUID = 5520424448605245885L;
    /**
     * 补货建议id
     */

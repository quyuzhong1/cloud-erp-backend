...
@TableName("overseas_in_transit_detail")
@EqualsAndHashCode(callSuper = true)
public class OverseasInTransitDetailEntity extends BaseEntity<OverseasInTransitDetailEntity> {

    private static final long serialVersionUID = 1653939719476121633L;
    /**
     * 补货建议id
     */

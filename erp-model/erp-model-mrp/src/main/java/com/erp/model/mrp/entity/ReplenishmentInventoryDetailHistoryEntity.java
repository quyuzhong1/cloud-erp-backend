...
@TableName("replenishment_inventory_detail_history")
@EqualsAndHashCode(callSuper = true)
public class ReplenishmentInventoryDetailHistoryEntity extends BaseEntity<ReplenishmentInventoryDetailHistoryEntity> {

    private static final long serialVersionUID = 4713985833241567615L;
    /**
     * 补货建议id
     */

 ...
 */
@Data
public class DeliverySuggestImportExcelDTO implements Serializable {
     ...
     * 运营确认值
     */
    @ExcelProperty(value = "*运营确认值", index = 2)
    @FieldValid(fieldName = "运营确认值", isNotBlank = true, formatPattern= FieldFormatPatternTypeEnum.POSITIVEINTEGER)
    private String actualDeliveryQty;

    /**
     * 发货备货数
     */
    @ExcelProperty(value = "*发货备货数", index = 3)

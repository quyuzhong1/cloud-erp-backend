...
//
//        List<Map<String, String>> params = createParamsMap(targetClass, targetDtoExcludesFields, targetDetailDtoExcludesFields);
//
...
//                            continue;
//                        }
//                        Map<String, String> map = putDetailToMap(field, aClass, fieldDetail);
//                        result.add(map);
//                    }
//                }
//            } else {
//                Map<String, String> map = createMap(aClass, field);
//                result.add(map);
//            }
//        }
//        return result;
//    }
//
//    private static Map<String, String> putDetailToMap(Field field, Class<?> aClass, Field fieldDetail) {
//        Map<String, String> params = new HashMap<>();
//        params.put("field", field.getName().concat(".").concat(fieldDetail.getName()));
...
//    }
//
//    private static Map<String, String> createMap(Class<?> aClass, Field field) {
//
//        Map<String, String> params = new HashMap<>();

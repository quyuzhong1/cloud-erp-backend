...
public class VOInfo {
    ...
    public VOInfo setConvert(boolean convert) {
        this.convert = convert;
        return this;
    }

    protected VOInfo setConvert(StrategyConfig strategyConfig) {
    ...
    public VOInfo setEntityName(StrategyConfig strategyConfig, String entityName) {
        this.entityName = entityName;
        this.setConvert(strategyConfig);
        return this;
    }

    public VOInfo setFields(List<TableField> fields) {
    ...
    public VOInfo setImportPackages(String pkg) {

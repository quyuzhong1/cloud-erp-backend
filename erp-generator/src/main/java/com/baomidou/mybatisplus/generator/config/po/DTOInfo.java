...
public class DTOInfo {
    ...
    public DTOInfo setConvert(boolean convert) {
        this.convert = convert;
        return this;
    }

    protected DTOInfo setConvert(StrategyConfig strategyConfig) {
    ...
    public DTOInfo setEntityName(StrategyConfig strategyConfig, String entityName) {
    ...
    public DTOInfo setFields(List<TableField> fields) {
    ...
    public DTOInfo setImportPackages(String pkg) {

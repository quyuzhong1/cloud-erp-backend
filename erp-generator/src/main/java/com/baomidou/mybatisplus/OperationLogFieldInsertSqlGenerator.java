 ...
 * 自动生成工具
 */
public class OperationLogFieldInsertSqlGenerator {
     ...
     * 插入的日志配置表
     */
    public final static String sysLogFieldTableName = "\"public\".\"cfg_operate_log_field\"";
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (Map<String, String> param : params) {
            String insertSql = genInsertSql(sysLogFieldTableName, CfgOperateLogFieldEntity.class, new HashMap<>(), sysLogExcludesFields, param);

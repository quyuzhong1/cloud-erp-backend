...
public enum ApiError implements Serializable {
    ...
    ERROR_95029(95029, "关闭任务失败，进行中的任务才能关闭"),
    ERROR_95030(95030, "发布任务失败，只能发布待发布的任务"),
    ERROR_95031(95031, "取消发布任务失败，只能取消未开始和未审核的任务"),
    ERROR_95032(95032, "操作失败，只能关闭进行中或者待审核的任务"),
    ERROR_95033(95033, "操作失败，当前任务中有评审任务，不能完成任务"),
    ERROR_95034(95034, "完成任务失败，进行中的任务才能完成任务"),
    ERROR_95035(95035, "操作失败，前置任务有未完成的任务"),
    ERROR_95036(95036, "操作失败，子任务有未完成的任务"),
    ERROR_95037(95037, "操作失败，存在不是待审核的任务"),
    ERROR_95038(95038, "操作失败，只能操作流程任务"),

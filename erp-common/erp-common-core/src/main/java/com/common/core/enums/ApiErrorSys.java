...
public final class ApiErrorSys {
    ...
    static ApiError[] values() {
        return new ApiError[]{
                ...
                AUTH_USER_NOT_FOUND,
                AUTH_LOGIN_LOCKED,
                AUTH_LOGIN_RETRY_LEFT,
                AUTH_CREDENTIALS_INVALID,
                AUTH_PASSWORD_REQUIRED,
                AUTH_ACCOUNT_PASSWORD,
                AUTH_ACCOUNT_BIND_FAILED,
                AUTH_ACCOUNT_NOT_BOUND,
                AUTH_ACCOUNT_ALREADY_BOUND,
                AUTH_USERNAME_EXISTS,
                AUTH_ACCOUNT_NOT_FOUND,
                AUTH_MOBILE_IS_EXIST,
                AUTH_FS_USER_NOT_BIND,
                AUTH_FS_NOT_BOUND,
                AUTH_MODIFY_DELETE_DENIED,
                AUTH_VIEW_DENIED,
                AUTH_SSO_APP_NOT_FOUND,
                AUTH_SSO_DISABLED,
                AUTH_SSO_DECRYPT_FAILED,
                AUTH_SSO_PAYLOAD_PARSE_FAILED,
                AUTH_SSO_INVALID_PAYLOAD,
                AUTH_SSO_USER_NOT_BOUND_ERP,
                AUTH_SSO_SYSTEM_ERROR,
                AUTH_ARCHIVE_DENIED,
                AUTH_API_TOKEN_EXPIRED_RECREATE,
                AUTH_API_TOKEN_ID_REQUIRED,
                AUTH_API_TOKEN_NOT_FOUND,
                AUTH_API_TOKEN_USER_NOT_LOGIN,
                AUTH_API_TOKEN_NAME_REQUIRED,
                AUTH_API_TOKEN_NAME_TOO_LONG,
                AUTH_API_TOKEN_VALIDITY_REQUIRED,
                AUTH_API_TOKEN_VALIDITY_INVALID,
                AUTH_API_TOKEN_ENCRYPT_FAILED,
                AUTH_API_TOKEN_CIPHERTEXT_INVALID,
                AUTH_API_TOKEN_DECRYPT_FAILED,
                AUTH_API_TOKEN_AES_KEY_REQUIRED,
                AUTH_API_TOKEN_AES_KEY_INIT_FAILED,
                AUTH_API_TOKEN_HASH_FAILED,
                AUTH_API_TOKEN_PATH_REQUIRED,
                AUTH_API_TOKEN_PATH_BACKSLASH_FORBIDDEN,
                AUTH_API_TOKEN_PATH_INVALID,
                AUTH_API_TOKEN_PATH_TRAVERSAL_FORBIDDEN,
                AUTH_API_TOKEN_PATH_TOO_LONG,
                AUTH_API_TOKEN_WHITELIST_NOT_FOUND,
                AUTH_API_TOKEN_PATH_EXISTS,
                AUTH_API_TOKEN_MANAGEMENT_PATH_FORBIDDEN,
                AUTH_API_TOKEN_PATH_NOT_IN_WHITELIST,
                AUTH_API_TOKEN_WHITELIST_ADMIN_REQUIRED,
                QUERY_NOT_EXTEND_METHOD,
                QUERY_ILLEGAL_FIELD,
                QUERY_ILLEGAL_COND,
                QUERY_LIST_TYPE_ERROR,
                QUERY_BETWEEN_ERROR,
                QUERY_ILLEGAL_DATE_FORMAT,
                QUERY_NOT_EXTEND_CLASS,
                CFG_QUERY_OPTION_API_CONFIG_REQUIRED,
                CFG_QUERY_OPTION_API_CONFIG_DUPLICATE,
                CFG_FILE_PARSE_NOT_MONTHLY,
                CFG_FILE_PARSE_FOLDER_REQUIRED,
                CFG_FILE_PARSE_FILE_REQUIRED,
                CFG_FILE_PARSE_DUPLICATE,
                CFG_FILE_PARSE_DOWNSTREAM_EXISTS,
                CFG_FILE_PARSE_TEMPLATE_NOT_FOUND,
                CFG_FILE_PARSE_EXPORT_TASK_CREATE_FAILED,
                CFG_FILE_PARSE_FILE_RULE_INVALID,
                CFG_FILE_PARSE_FOLDER_RULE_INVALID,

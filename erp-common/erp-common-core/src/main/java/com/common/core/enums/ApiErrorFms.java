...
public final class ApiErrorFms {
    ...
    static ApiError[] values() {
        return new ApiError[]{
                FIN_INVOICE_NOT_FOUND,
                FIN_INVOICE_OPERATION_NOT_ALLOWED,
                FIN_INVOICE_NOT_REQUIRED_ONLY_PENDING_OR_FAILED,
                FIN_INVOICE_NFE_ONLY_SUPPORTED,
                FIN_SKU_INVOICE_TAX_INFO_NOT_FOUND,
                FIN_INVOICE_NFE_CANCEL_FAILED,
                FIN_COMPANY_TOKEN_NOT_FOUND,
                FIN_INVOICE_NFE_UPDATE_CCE_FAILED,
                FIN_INVOICE_UPLOAD_FILE_NOT_FOUND,
                FIN_INVOICE_NFE_JSON_PARSE_FAILED,
                FIN_INVOICE_CREATING_REGENERATE_FORBIDDEN,
                FIN_INVOICE_NFE_RETURN_FAILED,
                FIN_INVOICE_NFE_VOID_FAILED,
                FIN_RECONCILIATION_NOT_FOUND,
                FIN_RECONCILIATION_DETAIL_NOT_FOUND,
        };
    }
}

...
public final class ApiError implements Serializable {
    ...
    public static final ApiError SO_THIRD_DELIVERY_REVOKE_OUTSTOCK_ONLY_MANUAL_SHIPPED = ApiErrorOms.SO_THIRD_DELIVERY_REVOKE_OUTSTOCK_ONLY_MANUAL_SHIPPED;
    ...
    public static final ApiError WH_LOCATION_MOVE_DEFECTIVE_QTY_EXCEEDS = ApiErrorWms.WH_LOCATION_MOVE_DEFECTIVE_QTY_EXCEEDS;
    ...
    public static final ApiError WH_AIYA_OUTBOUND_CARRIER_REQUIRED = ApiErrorWms.WH_AIYA_OUTBOUND_CARRIER_REQUIRED;
    public static final ApiError WH_AIYA_OUTBOUND_ADDRESS1_REQUIRED = ApiErrorWms.WH_AIYA_OUTBOUND_ADDRESS1_REQUIRED;
    public static final ApiError WH_AIYA_OUTBOUND_LABEL_REQUIRED = ApiErrorWms.WH_AIYA_OUTBOUND_LABEL_REQUIRED;
    public static final ApiError WH_AIYA_OUTBOUND_TRACKING_REQUIRED = ApiErrorWms.WH_AIYA_OUTBOUND_TRACKING_REQUIRED;
    ...
    public static final ApiError LOGISTICS_PACKING_PRINT_STATUS_FORBIDDEN = ApiErrorTms.LOGISTICS_PACKING_PRINT_STATUS_FORBIDDEN;
    public static final ApiError LOGISTICS_PACKING_PRINT_CARTON_EMPTY = ApiErrorTms.LOGISTICS_PACKING_PRINT_CARTON_EMPTY;
    public static final ApiError LOGISTICS_PACKING_PRINT_PDF_GENERATE_FAILED = ApiErrorTms.LOGISTICS_PACKING_PRINT_PDF_GENERATE_FAILED;
    public static final ApiError LOGISTICS_PACKING_PRINT_PDF_MERGE_FAILED = ApiErrorTms.LOGISTICS_PACKING_PRINT_PDF_MERGE_FAILED;
    public static final ApiError LOGISTICS_PACKING_PRINT_TEMPLATE_NOT_FOUND = ApiErrorTms.LOGISTICS_PACKING_PRINT_TEMPLATE_NOT_FOUND;
    public static final ApiError LOGISTICS_PACKING_PRINT_TEMPLATE_LOAD_FAILED = ApiErrorTms.LOGISTICS_PACKING_PRINT_TEMPLATE_LOAD_FAILED;
    public static final ApiError LOGISTICS_PACKING_PRINT_CARTON_LIMIT_EXCEEDED = ApiErrorTms.LOGISTICS_PACKING_PRINT_CARTON_LIMIT_EXCEEDED;
    public static final ApiError LOGISTICS_PACKING_PRINT_PDF_UPLOAD_FAILED = ApiErrorTms.LOGISTICS_PACKING_PRINT_PDF_UPLOAD_FAILED;
    ...
    public static final ApiError LOGISTICS_DECLARE_DETAIL_FIELD_REQUIRED_BATCH = ApiErrorTms.LOGISTICS_DECLARE_DETAIL_FIELD_REQUIRED_BATCH;
    ...
    public static final ApiError DMP_KUAIDI100_WEBHOOK_PARAM_SIGN_REQUIRED = ApiErrorDmp.DMP_KUAIDI100_WEBHOOK_PARAM_SIGN_REQUIRED;
    public static final ApiError DMP_KUAIDI100_WEBHOOK_SIGN_INVALID = ApiErrorDmp.DMP_KUAIDI100_WEBHOOK_SIGN_INVALID;
    public static final ApiError DMP_KUAIDI100_WEBHOOK_RAW_DATA_REQUIRED = ApiErrorDmp.DMP_KUAIDI100_WEBHOOK_RAW_DATA_REQUIRED;
    public static final ApiError DMP_KUAIDI100_WEBHOOK_RAW_DATA_JSON_INVALID = ApiErrorDmp.DMP_KUAIDI100_WEBHOOK_RAW_DATA_JSON_INVALID;
    public static final ApiError DMP_KUAIDI100_WEBHOOK_RAW_DATA_PARAM_REQUIRED = ApiErrorDmp.DMP_KUAIDI100_WEBHOOK_RAW_DATA_PARAM_REQUIRED;
    public static final ApiError DMP_KUAIDI100_WEBHOOK_PARAM_REQUIRED = ApiErrorDmp.DMP_KUAIDI100_WEBHOOK_PARAM_REQUIRED;
    public static final ApiError DMP_KUAIDI100_WEBHOOK_PARAM_JSON_INVALID = ApiErrorDmp.DMP_KUAIDI100_WEBHOOK_PARAM_JSON_INVALID;
    public static final ApiError DMP_KUAIDI100_WEBHOOK_LAST_RESULT_REQUIRED = ApiErrorDmp.DMP_KUAIDI100_WEBHOOK_LAST_RESULT_REQUIRED;
    public static final ApiError DMP_KUAIDI100_WEBHOOK_TRACK_NO_REQUIRED = ApiErrorDmp.DMP_KUAIDI100_WEBHOOK_TRACK_NO_REQUIRED;
    public static final ApiError DMP_KUAIDI100_WEBHOOK_FORM_URL_DECODE_FAILED = ApiErrorDmp.DMP_KUAIDI100_WEBHOOK_FORM_URL_DECODE_FAILED;
    public static final ApiError DMP_TRACK123_WEBHOOK_RAW_DATA_REQUIRED = ApiErrorDmp.DMP_TRACK123_WEBHOOK_RAW_DATA_REQUIRED;
    public static final ApiError DMP_TRACK123_WEBHOOK_RAW_DATA_JSON_INVALID = ApiErrorDmp.DMP_TRACK123_WEBHOOK_RAW_DATA_JSON_INVALID;
    public static final ApiError DMP_TRACK123_WEBHOOK_DATA_NODE_INVALID = ApiErrorDmp.DMP_TRACK123_WEBHOOK_DATA_NODE_INVALID;
    public static final ApiError DMP_TRACK123_WEBHOOK_TRACK_NO_REQUIRED = ApiErrorDmp.DMP_TRACK123_WEBHOOK_TRACK_NO_REQUIRED;

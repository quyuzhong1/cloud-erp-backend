...
public enum ApiError implements Serializable {
    ...
    ERROR_95305(98305,"开模通知单已下推模具采购单"),
    ERROR_95306(98306,"模具采购订单已下推模具采购变更单"),
    ERROR_95307(95307,"未找到模具采购订单"),
    ERROR_95308(95308,"未找到模具采购订单明细"),
    ERROR_95309(95309,"未找到可以下推的模具采购订单"),
    ERROR_95310(95310,"未审核的模具采购单不允许变更"),
    ...
    ERROR_95317(95317,"未找到模具采购供应商信息"),
    ERROR_95318(95318,"未找到模具采购变更单明细"),
    ERROR_95319(95319,"只有已审核的模具采购单才可以结束验收"),
    ERROR_95320(95320,"已验收和已关闭的明细行不允许变更"),
    ERROR_95321(95321,"已存在下推资产验收单，不支持反审核"),
    ERROR_95322(95322,"更新sku【{}】占用状态失败"),
    ERROR_95323(95323,"sku【{}】变更数量不能小于已验收数量"),

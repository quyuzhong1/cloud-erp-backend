...
public enum CustomizeFieldEnum {
    ...
    TASK_TYPE("任务类型", "type", false, "plmScheduleTask", "plm项目计划任务"),
    ...
    TASK_PRIORITY("任务优先级", "priority", false, "plmScheduleTask", "plm项目计划任务"),
    IS_MILEPOST("设置里程碑", "isMilepost", false, "plmScheduleTask", "plm项目计划任务"),

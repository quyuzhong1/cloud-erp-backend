...
public final class ApiErrorTms {
    ...
    public static final ApiError LOGISTICS_DECLARE_DETAIL_SOURCE_REQUIRED = new ApiError("LOGISTICS_DECLARE_DETAIL_SOURCE_REQUIRED", 13683, "业务单号【{0}】SKU【{1}】来源明细不能为空");
    public static final ApiError LOGISTICS_DECLARE_DETAIL_SOURCE_DUPLICATE = new ApiError("LOGISTICS_DECLARE_DETAIL_SOURCE_DUPLICATE", 13684, "业务单号【{0}】SKU【{1}】来源明细重复，请勿重复保存");
    public static final ApiError LOGISTICS_DECLARE_DETAIL_QTY_MISMATCH = new ApiError("LOGISTICS_DECLARE_DETAIL_QTY_MISMATCH", 13685, "业务单号【{0}】SKU【{1}】数量必须等于来源明细数量合计");
    ...
    public static final ApiError LOGISTICS_DECLARE_DETAIL_SOURCE_VALUE_MISMATCH = new ApiError("LOGISTICS_DECLARE_DETAIL_SOURCE_VALUE_MISMATCH", 13692, "业务单号【{0}】SKU【{1}】{2}与来源明细不一致");
    public static final ApiError LOGISTICS_DECLARE_DETAIL_FIELD_REQUIRED = new ApiError("LOGISTICS_DECLARE_DETAIL_FIELD_REQUIRED", 13693, "业务单号【{0}】SKU【{1}】{2}不能为空");
    public static final ApiError LOGISTICS_DECLARE_DETAIL_FIELD_REQUIRED_BATCH = new ApiError("LOGISTICS_DECLARE_DETAIL_FIELD_REQUIRED_BATCH", 13727, "{0}");
    public static final ApiError LOGISTICS_DECLARE_DETAIL_FIELD_POSITIVE_REQUIRED = new ApiError("LOGISTICS_DECLARE_DETAIL_FIELD_POSITIVE_REQUIRED", 13694, "业务单号【{0}】SKU【{1}】{2}必须大于0");

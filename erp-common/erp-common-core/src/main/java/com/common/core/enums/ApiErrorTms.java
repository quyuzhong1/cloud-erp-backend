...
public final class ApiErrorTms {
    ...
    public static final ApiError LOGISTICS_PACKING_CARTON_COMPLETED_FORBIDDEN = new ApiError("LOGISTICS_PACKING_CARTON_COMPLETED_FORBIDDEN", 13726, "该箱已完成装箱，请刷新后重试");

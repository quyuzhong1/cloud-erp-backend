...
public enum FileTaskEventEnum implements EnumMessage {
    ...
    EXPORT_ADS_ERP_OUTSTOCK_DETAIL_PLATFORM("EXPORT_ADS_ERP_OUTSTOCK_DIFF_FLOW_DETAIL_PLATFORM","朔源查询-平台出库单","","",""),
    EXPORT_ADS_ERP_OUTSTOCK_DETAIL_SELF("EXPORT_ADS_ERP_OUTSTOCK_DIFF_FLOW_DETAIL_SELF","朔源查询-库存流水","","",""),
    ...
    EXPORT_ADS_ERP_DIFF_RETURN_INSTOCK_SYNC_DETAIL_PLATFORM("EXPORT_ADS_ERP_DIFF_RETURN_INSTOCK_SYNC_DETAIL_PLATFORM","退货同步差异朔源查询-平台出库单","","",""),
    EXPORT_ADS_ERP_DIFF_RETURN_INSTOCK_SYNC_DETAIL_SELF("EXPORT_ADS_ERP_DIFF_RETURN_INSTOCK_SYNC_DETAIL_SELF","退货同步差异朔源查询-ERP出库单","","",""),

...
public enum FileTaskEventEnum implements EnumMessage {
    ...
    EXPORT_PROCESS_CFG_PROCESS("EXPORT_CFG_PROCESS","流程配置Excel导出"),
    EXPORT_PROCESS_THIRD_PROCESS("EXPORT_THIRD_PROCESS", "三方审批生成导出"),
    ...
    EXPORT_PROCESS_APPROVE_SYNC_RECORD("EXPORT_APPROVE_TASK", "三方生成查询导出"),

...
public enum FileTaskEventEnum implements EnumMessage {
    ...
    EXPORT_ADS_ERP_OUTSTOCK_DETAIL_PLATFORM("EXPORT_ADS_ERP_OUTSTOCK_DETAIL_PLATFORM","朔源查询-平台出库单","","",""),
    EXPORT_ADS_ERP_OUTSTOCK_DETAIL_SELF("EXPORT_ADS_ERP_OUTSTOCK_DETAIL_SELF","朔源查询-库存流水","","",""),
    EXPORT_ADS_ERP_INVENTORY_DETAIL_PLATFORM("EXPORT_ADS_ERP_INVENTORY_DETAIL_PLATFORM","朔源查询-每日库存","","",""),
    EXPORT_ADS_ERP_INVENTORY_DETAIL_SELF("EXPORT_ADS_ERP_INVENTORY_DETAIL_SELF","朔源查询-库存流水","","",""),
    EXPORT_ADS_ERP_DIFF_OUTSTOCK_SYNC_DETAIL_PLATFORM("EXPORT_ADS_ERP_DIFF_OUTSTOCK_SYNC_DETAIL_PLATFORM","出库同步差异朔源查询-平台出库单","","",""),
    EXPORT_ADS_ERP_DIFF_OUTSTOCK_SYNC_DETAIL_SELF("EXPORT_ADS_ERP_DIFF_OUTSTOCK_SYNC_DETAIL_SELF","出库同步差异朔源查询-ERP出库单","","",""),
    EXPORT_ADS_ERP_DIFF_RETURN_INSTOCK_SYNC_PLATFORM("EXPORT_ADS_ERP_DIFF_RETURN_INSTOCK_SYNC_PLATFORM","退货同步差异朔源查询-平台退货单","","",""),
    EXPORT_ADS_ERP_DIFF_RETURN_INSTOCK_SYNC_SELF("EXPORT_ADS_ERP_DIFF_RETURN_INSTOCK_SYNC_SELF","退货同步差异朔源查询-ERP退货单","","",""),
    ...
    EXPORT_PLM_PRODUCT_FORBIDDEN_WORD("EXPORT_PLM_PRODUCT_FORBIDDEN_WORD", "违禁词库导出","","",""),
    ...
    EXPORT_OMS_KOL_B2B_APPLICATION_REPORT("EXPORT_OMS_KOL_B2B_APPLICATION_REPORT","B2B寄样申请导出","","",""),
    EXPORT_OMS_KOL_SAMPLE_COST_REPORT("EXPORT_OMS_KOL_SAMPLE_COST_REPORT","寄样费用导出","","",""),
    ...
    IMPORT_WMS_WAREHOUSE_LOCATION_MAPPING("IMPORT_WMS_WAREHOUSE_LOCATION_MAPPING", "仓位绑定导入","com.erp.rpc.wms.feign.ImportWmsFeign","importWarehouseLocationMapping",""),
    ...
    EXPORT_WMS_AWD_SHIPMENT("EXPORT_WMS_AWD_SHIPMENT", "AWD货件导出","","",""),
    ...
    EXPORT_WMS_AFTER_SALE_PACK("EXPORT_WMS_AFTER_SALE_PACK", "售后装箱导出","","",""),
    ...
    EXPORT_TMS_LOGISTICS_LAST_MILE_COST("EXPORT_TMS_LOGISTICS_LAST_MILE_COST", "尾程费用(平台发货)列表","","",""),
    EXPORT_TMS_LOGISTICS_BILL_COST("EXPORT_TMS_LOGISTICS_BILL_COST", "尾程费用(自发货)列表","","",""),
    ...
    EXPORT_TMS_LOGISTICS_RECON("EXPORT_TMS_LOGISTICS_RECON", "物流商对账单导出","","",""),
    EXPORT_TMS_LOGISTICS_RECON_DETAIL("EXPORT_TMS_LOGISTICS_RECON_DETAIL", "物流商对账明细导出","","",""),
    ...
    EXPORT_APPROVE_TASK("EXPORT_APPROVE_TASK", "流程拉取导出","","",""),

...
public enum FileTaskEventEnum implements EnumMessage {
    ...
    EXPORT_ADS_ERP_DIFF_RETURN_INSTOCK_SYNC_PLATFORM("EXPORT_ADS_ERP_DIFF_RETURN_INSTOCK_SYNC_PLATFORM","退货同步差异朔源查询-平台出库单","","",""),
    EXPORT_ADS_ERP_DIFF_RETURN_INSTOCK_SYNC_SELF("EXPORT_ADS_ERP_DIFF_RETURN_INSTOCK_SYNC_SELF","退货同步差异朔源查询-ERP出库单","","",""),

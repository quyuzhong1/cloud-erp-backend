...
public enum FileTaskEventEnum implements EnumMessage {
    ...
    EXPORT_WMS_SAMPLE_BORROW_INFO_REPORT("EXPORT_WMS_SAMPLE_BORROW_INFO_REPORT", "样品借出单导出","","",""),
    EXPORT_WMS_SAMPLE_RETURN_INFO_REPORT("EXPORT_WMS_SAMPLE_RETURN_INFO_REPORT", "样品归还单导出","","",""),
    EXPORT_WMS_SAMPLE_SCRAP_INFO_REPORT("EXPORT_WMS_SAMPLE_SCRAP_INFO_REPORT", "样品报废单导出","","",""),

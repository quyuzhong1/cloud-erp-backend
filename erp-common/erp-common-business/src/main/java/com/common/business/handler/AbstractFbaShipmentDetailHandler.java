...
/**
 * 亚马逊根据FBA货件明细更新时间处理器抽象类
 *
 * @author Jim
 * @since 2023-11-01
 */
public abstract class AbstractFbaShipmentDetailHandler<T extends CleanBaseDTO, R extends UniqueDto> implements IBusinessHandler<T, R> {

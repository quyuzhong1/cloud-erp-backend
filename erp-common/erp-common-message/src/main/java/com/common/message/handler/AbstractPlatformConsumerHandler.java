...
public abstract class AbstractPlatformConsumerHandler<T extends DmpSyncTaskIdDTO> implements RocketMQListener<Object> {
    ...
    public void onMessage(Object obj) {
    	...
    	try {
            ...
            try {
                updateSyncTaskStatus(new DmpSyncMqDTO.ParamDTO(dmpSyncTaskId,version, SyncStatusEnum.FAILED_SYNC.getCode(), ExceptionUtil.stacktraceToString(e, 2000)));
     ...
     * @param ext
     */
    public abstract ApiResult<Object> handle(Object ext);

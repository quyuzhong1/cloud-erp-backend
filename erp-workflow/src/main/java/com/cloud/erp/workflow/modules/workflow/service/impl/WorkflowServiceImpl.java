...
import com.cloud.erp.workflow.modules.workflow.mapper.WorkflowMapper;
import com.cloud.erp.workflow.modules.workflow.service.ActHistoryActivityService;
import com.cloud.erp.workflow.modules.workflow.service.WorkflowService;
...
public class WorkflowServiceImpl implements WorkflowService {
     ...
     */
    @Override
    public List<ApproveRecordVO> queryApproveRecord(ProcessBaseDTO dto) {
        String processInstanceId = dto.getProcessInstanceId();
        List<HistoricActivityInstance> list = historyService.createHistoricActivityInstanceQuery()
                ...
                .asc()
                .list();
        List<ApproveRecordVO> resultList = new ArrayList<>(list.size());
        for (HistoricActivityInstance item : list) {
            String taskId=item.getTaskId();
            List<Comment> taskComments = taskService.getTaskComments(taskId);
            ApproveRecordVO vo = new ApproveRecordVO();

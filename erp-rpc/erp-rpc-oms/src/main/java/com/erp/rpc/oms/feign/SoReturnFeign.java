...
@FeignClient(name = "erp-oms", contextId = "soReturnFeign",configuration = {FeignErrorDecoder.class})
public interface SoReturnFeign {
     ...
     **/
    @PostMapping("feign/soReturn/listByReturnLogisticCode")
    List<SoReturnEntity> listByReturnLogisticCode(@RequestBody String returnLogisticCode);
     ...
     * @return java.util.List<com.erp.model.oms.entity.SoReturnDetailEntity>
     **/
    @PostMapping("feign/soReturn/listDetailByReturnType")
    List<SoReturnDetailEntity> listDetailByReturnType(@RequestBody List<String> returnType);
}

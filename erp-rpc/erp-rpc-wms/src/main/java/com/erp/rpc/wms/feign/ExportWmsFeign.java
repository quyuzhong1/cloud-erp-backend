...
public interface ExportWmsFeign {
    ...
    @PostMapping("/feign/export/exportAfterSalePack")
    PagingVO<AfterSalePackDTO.ExportViewDTO> exportAfterSalePack(@RequestBody @Validated PagingDTO<AfterSalePackDTO.ExportDTO> dto);
}

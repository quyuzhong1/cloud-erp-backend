...
public interface ImportWmsFeign {
    ...
    @PostMapping("/feign/import/importSampleBackInfo")
    void importSampleBackInfo(@RequestBody BaseDTO.ImportDTO dto);
    ...
    @PostMapping("/feign/import/importWarehouseLocationMapping")
    void importWarehouseLocationMapping(@RequestBody BaseDTO.ImportDTO dto);

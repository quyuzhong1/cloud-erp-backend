...
@Getter
@NoArgsConstructor
public class PlatformShopeeGlobalListingDTO extends CleanBaseDTO {
    //
     ...
     * 初始化
     */
    public PlatformShopeeGlobalListingDTO(GlobalItemInfo globalItemInfo, JobTaskDTO dto) {
     ...
     */
    public static PlatformProductDTO convertDTO(PlatformShopeeGlobalListingDTO dto) {
        // 原商品信息

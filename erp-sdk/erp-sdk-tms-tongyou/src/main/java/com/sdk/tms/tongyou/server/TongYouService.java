...
public class TongYouService {
     ...
     *  查询全部已开通的渠道
     */
    public TongYouResponse<List<TongYouChannel>> getAllChannel(){
        String response = TongYouUtils.sendPost(TongYouConstants.METHOD_GET_CHANNEL,null);
     ...
     *  创建订单
     */
    public TongYouCreateOrder createOrder(TongYouCreateOrderRequest request){
        TongYouSignDTO tongYouSignDTO = TongYouSignDTO.builder()
                ...
                .build();
        String sign = TongYouUtils.getCreateOrderSign(tongYouSignDTO);
        Map<String, Object> paramsMap = BeanUtil.beanToMap(request);
        String response = TongYouUtils.sendPost(TongYouConstants.METHOD_CREATE_ORDER,paramsMap,sign);
     ...
     *  回调订单
     */
    public TongYouCallBackOrder callBackOrderInfo(TongYouCallBackOrderRequest request){
        String sign = TongYouUtils.getCallBackOrderSign(request.getLogisticsId(),request.getOrderNo());
        Map<String, Object> paramsMap = BeanUtil.beanToMap(request);
        String response = TongYouUtils.sendPost(TongYouConstants.METHOD_ORDER_CALL_BACK,paramsMap,sign);
    ...
    public TongYouPrintLabel printLabel(TongYouPrintLabelRequest request){
        ...
        Map<String, Object> paramsMap = BeanUtil.beanToMap(request);
        String response = TongYouUtils.sendPost(TongYouConstants.METHOD_PRINT_LABEL,paramsMap,sign);
     ...
     *  查询订单信息
     */
    public TongYouOrderInfo getOrderInfo(TongYouGetOrderRequest request){
        Map<String, Object> paramsMap = BeanUtil.beanToMap(request);
        String response = TongYouUtils.sendPost(TongYouConstants.METHOD_ORDER_GET,paramsMap);

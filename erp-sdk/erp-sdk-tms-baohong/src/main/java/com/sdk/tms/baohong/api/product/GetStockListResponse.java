 ...
 *           &lt;element name="dataList" type="{http://www.example.org/ServiceForProduct/}inventoryRow" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;/sequence>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
...
@XmlRootElement(name = "getStockListResponse")
public class GetStockListResponse {
    ...
    protected int total;
    protected List<InventoryRow> dataList;
     ...
     * 
     */
    public List<InventoryRow> getDataList() {
        if (dataList == null) {
            dataList = new ArrayList<InventoryRow>();
        }

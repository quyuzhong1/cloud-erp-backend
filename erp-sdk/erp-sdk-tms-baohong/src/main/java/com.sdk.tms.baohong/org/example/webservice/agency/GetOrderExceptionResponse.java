 ...
 *         &lt;element name="exceptionData" type="{http://www.example.org/ServiceForOrder/}exceptionData" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "getOrderExceptionResponse")
public class GetOrderExceptionResponse {

    @XmlElement(required = true)
    protected String ask;
    @XmlElement(required = true)
    protected String message;
    protected List<ExceptionData> exceptionData;
    ...
    public List<ExceptionData> getExceptionData() {
        if (exceptionData == null) {
            exceptionData = new ArrayList<ExceptionData>();
        }

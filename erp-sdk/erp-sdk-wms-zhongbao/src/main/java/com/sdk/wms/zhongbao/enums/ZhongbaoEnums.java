package com.sdk.wms.zhongbao.enums;
...
public enum ZhongbaoEnums {
    ...
    ZhongbaoEnums(String fieldName, Class<?> enumClz) {
    ...
    public enum OpenTransitTypeEnum {
        STANDARD_RECEIPT(1,"客户自发头程",OverseasInstockTypeEnum.SELF_HEADWAY),
        TRANSFER_RECEIPT(2,"海外仓头程", OverseasInstockTypeEnum.TRANSFER_AGENT),
        FBA_WAREHOUSE_RECEIPT(3,"海外仓码头提货",null),
        ;
        private final Integer code;
        private final String name;
    ...
    public enum ProductCodeEnum {
        LOCAL_DELIVERY(1,"整柜", LogisticsMethodEnum.LOCAL_DELIVERY),
        AIR_TRANSPORT(3,"托盘", LogisticsMethodEnum.AIRFREIGHT),
    ...
    public enum ReturnInstockTypeEnum {
        RETURNS_FROM_SERVICE_PROVIDERS(0,"服务商退件", ReturnTypeEnum.RETURNS_FROM_SERVICE_PROVIDERS),
        CUSTOMER_RETURNS(1,"客户退件", ReturnTypeEnum.CUSTOMER_RETURNS),
        ;
        private final Integer code;
        private final String name;

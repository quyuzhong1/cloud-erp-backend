...
public class AccessTokenDemo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Result<?> result = AKRestClientBuild.builder().endpoint(endpoint).getAccessToken(appId, appSecret);
    ...
    public static void main1(String[] args) throws Exception {
        String json = "{\"access_token\":\"d77283df-f841-4fb0-926e-c81a8e672ce0\", \"refresh_token\":\"7aee55a3-fc4b-4c8c-bf86-bfd93eb2b31e\", \"expires_in\":7199}";

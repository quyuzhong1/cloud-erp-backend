...
@Data
public class AuthTokenRefreshTokenResponse extends PopBaseHttpResponse{

    @JSONField(name ="pop_auth_token_refresh_response")
    private PopAuthTokenRefreshResponse popAuthTokenRefreshResponse;

    public AuthTokenRefreshTokenResponse() {
    }
    ...
    public static class PopAuthTokenRefreshResponse {
        ...
        public PopAuthTokenRefreshResponse() {
        }

...
@NoArgsConstructor
public class ReportFbaMyiUnsuppressedInventoryMongoDTO extends ReportSuperMongoDTO {
    ...
    public static ReportFbaMyiUnsuppressedInventoryMongoDTO queryReportId(String myiAllInventoryReportId) {
        ReportFbaMyiUnsuppressedInventoryMongoDTO mongoDTO = new ReportFbaMyiUnsuppressedInventoryMongoDTO();

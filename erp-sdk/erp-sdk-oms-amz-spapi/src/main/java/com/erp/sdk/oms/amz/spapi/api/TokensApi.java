...
public class TokensApi {
     ...
     * 初始化Api
     */
    public static TokensApi initApi(AmazonEndpointsEnum endpointsEnum, AmazonShopInfoDTO shopInfoDTO, boolean isSandbox) {
        ...
        TokensApi ordersV0Api = new TokensApi.Builder()

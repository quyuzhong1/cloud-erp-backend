...
//    GET_REFERRAL_FEE_PREVIEW_REPORT("GET_REFERRAL_FEE_PREVIEW_REPORT", "销售佣金预览报告", false, "", null),
    ...
    //
    GET_AMAZON_FULFILLED_SHIPMENTS_DATA_INVOICING("GET_AMAZON_FULFILLED_SHIPMENTS_DATA_INVOICING","亚马逊FBA配送信息发票", true, null),

    // 亚马逊售后
    // FBM
    GET_FLAT_FILE_RETURNS_DATA_BY_RETURN_DATE("GET_FLAT_FILE_RETURNS_DATA_BY_RETURN_DATE","亚马逊退货报告_根据退货时间",true, null),
    // FBA
    GET_FBA_FULFILLMENT_CUSTOMER_RETURNS_DATA("GET_FBA_FULFILLMENT_CUSTOMER_RETURNS_DATA","亚马逊物流退货报告",true, null),

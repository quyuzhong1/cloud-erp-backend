...
public class DefinitionsApi {
     ...
     * 
     */
    public Call getDefinitionsProductTypeAsync(String productType, List<String> marketplaceIds, String sellerId, String productTypeVersion, String requirements, String requirementsEnforced, String locale, final ApiCallback<ProductTypeDefinition> callback) throws ApiException {
     ...
     * 
     */
    public Call searchDefinitionsProductTypesCall(List<String> marketplaceIds, List<String> keywords, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private Call searchDefinitionsProductTypesValidateBeforeCall(List<String> marketplaceIds, List<String> keywords, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'marketplaceIds' is set
        if (marketplaceIds == null) {
            throw new ApiException("Missing the required parameter 'marketplaceIds' when calling searchDefinitionsProductTypes(Async)");
        }

        Call call = searchDefinitionsProductTypesCall(marketplaceIds, keywords, progressListener, progressRequestListener);
        return call;
    ...
    public ApiResponse<ProductTypeList> searchDefinitionsProductTypesWithHttpInfo(List<String> marketplaceIds, List<String> keywords) throws ApiException {
        Call call = searchDefinitionsProductTypesValidateBeforeCall(marketplaceIds, keywords, null, null);
     ...
     * 
     */
    public Call searchDefinitionsProductTypesAsync(List<String> marketplaceIds, List<String> keywords, final ApiCallback<ProductTypeList> callback) throws ApiException {
        ...
        Call call = searchDefinitionsProductTypesValidateBeforeCall(marketplaceIds, keywords, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ProductTypeList>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    ...
    public static class Builder {
        ...
        public DefinitionsApi.Builder awsAuthenticationCredentials(AWSAuthenticationCredentials awsAuthenticationCredentials) {
            this.awsAuthenticationCredentials = awsAuthenticationCredentials;
            return this;
        }

        public DefinitionsApi.Builder lwaAuthorizationCredentials(LWAAuthorizationCredentials lwaAuthorizationCredentials) {
            this.lwaAuthorizationCredentials = lwaAuthorizationCredentials;
            return this;
        }

        public DefinitionsApi.Builder endpoint(String endpoint) {
            this.endpoint = endpoint;
            return this;
        }

        public DefinitionsApi.Builder lwaAccessTokenCache(LWAAccessTokenCache lwaAccessTokenCache) {
            this.lwaAccessTokenCache = lwaAccessTokenCache;
            return this;
        }

        public DefinitionsApi.Builder disableAccessTokenCache() {
            this.disableAccessTokenCache = true;
            return this;
        }

        public DefinitionsApi.Builder rateLimitConfigurationOnRequests(RateLimitConfiguration rateLimitConfiguration) {
            this.rateLimitConfiguration = rateLimitConfiguration;
            return this;
        }

        public DefinitionsApi.Builder disableRateLimitOnRequests() {
            this.rateLimitConfiguration = null;
            return this;
        }

        public DefinitionsApi.Builder awsAuthenticationCredentialsProvider(AWSAuthenticationCredentialsProvider awsAuthenticationCredentialsProvider) {

...
//        shopifyOrderHandler.downloadDetail(platformShopifyOrderDTO,null);
        List<ShopifyTransaction> transactionList = shopifyRestClientService.getShopifyRestClient("agimbalgear.myshopify.com", "")
                .getOrderTransactions("5722925924573");
        System.out.println(transactionList);
        ShopifyGraphQLClient shopifyGraphQLClient = shopifyGraphQLClientService.getShopifyGraphQLClient("agimbalgear.myshopify.com", "");

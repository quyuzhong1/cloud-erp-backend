package com.sdk.oms.shopify.utils;
 ...
 * Shopify HMAC校验工具类型
 */
public class HmacVerificationUtils {

    /**
     * <a href="https://shopify.dev/tutorials/authenticate-with-oauth#verification">校验</a>
     */
    public static boolean verifyQueryString(String clientSecret, String queryString) {
        TreeMap<String, String> map = splitQueryString(queryString);
     ...
     *  Shopify HMAC校验
     */
    public static boolean verifyQueryString(String clientSecret, TreeMap<String, String> map) {
        String hmac = map.remove("hmac");
        String queryString = joinQueryString(map);
        String digest = new HmacUtils(HmacAlgorithms.HMAC_SHA_256, clientSecret).hmacHex(queryString);
        return StringUtils.equalsIgnoreCase(digest, hmac);
    }

    private static String joinQueryString(TreeMap<String, String> map) {
        if (map.isEmpty()) {
    ...
    private static TreeMap<String, String> splitQueryString(String queryString) {
//        LinkedHashMap<String, String> map = new LinkedHashMap<>();
    ...
    /**
     * <a href="https://shopify.dev/tutorials/manage-webhooks#verifying-webhooks">校验webhook事件</a>
     */

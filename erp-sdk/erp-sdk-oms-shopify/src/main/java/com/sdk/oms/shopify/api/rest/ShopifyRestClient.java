...
public class ShopifyRestClient {
     ...
     * @return ShopifyPage<ShopifyOrder>
     */
    public ShopifyPage<ShopifyOrder> getOrders(final OffsetDateTime mininumCreationDate) {
     ...
     * @return ShopifyPage<ShopifyOrder>
     */
    public ShopifyPage<ShopifyOrder> getOrders(final OffsetDateTime mininumCreationDate, final int pageSize) {
     ...
     * @return ShopifyPage<ShopifyOrder>
     */
    public ShopifyPage<ShopifyOrder> getOrders(final OffsetDateTime mininumCreationDate, final OffsetDateTime maximumCreationDate) {
     ...
     * @return ShopifyPage<ShopifyOrder>
     */
    public ShopifyPage<ShopifyOrder> getUpdatedOrdersCreatedBefore(final OffsetDateTime minimumUpdatedAtDate,
                                                                   final OffsetDateTime maximumUpdatedAtDate,
    ...
    public List<ShopifyOrder> getAllUpdatedOrdersCreatedBefore(final OffsetDateTime minimumUpdatedAtDate, final OffsetDateTime maximumUpdatedAtDate,
                                                               final OffsetDateTime maximumCreatedAtDate) {

        ShopifyPage<ShopifyOrder> shopifyOrderPage = getUpdatedOrdersCreatedBefore(minimumUpdatedAtDate, maximumUpdatedAtDate, maximumCreatedAtDate, MAX_REQUEST_LIMIT);
     ...
     * @return ShopifyPage<ShopifyOrder>
     */
    public ShopifyPage<ShopifyOrder> getOrders(final OffsetDateTime mininumCreationDate, final OffsetDateTime maximumCreationDate, final int pageSize) {
        final Response response = get(buildOrdersEndpoint().queryParam(STATUS_QUERY_PARAMETER, ANY_STATUSES)
                .queryParam(LIMIT_QUERY_PARAMETER, pageSize).queryParam(CREATED_AT_MIN_QUERY_PARAMETER, mininumCreationDate.toString())
     ...
     * @return ShopifyPage<ShopifyOrder>
     */
    public ShopifyPage<ShopifyOrder> getOrders(final OffsetDateTime mininumCreationDate, final OffsetDateTime maximumCreationDate, final String appId) {

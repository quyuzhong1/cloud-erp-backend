...
public class ImlServerTest {
    ...
    @Resource
    private TongYouService imlServer;
    ...
    public void getSkuList() {
        TongYouGetProductReq imlProductReq = TongYouGetProductReq.builder()
                .page(1)
                .pageSize(50)
//                .productSku("0044")
//                .productSkuArr(Arrays.asList("0044"))
                ...
                .build();
        TongYouResponse<List<TongYouProductResp>> response = imlServer.getSkuList(imlProductReq);
...
//                .pageSize(50)
                .build();
        TongYouResponse<List<TongYouWarehouseResp>> response = imlServer.getWarehouse(imlProductReq);
        System.out.println(response);
    }

    @Test
    public void getReceivingRegionTest() {
        TongYouResponse<List<TongYouRegionResp>> response = imlServer.getReceivingRegion();
        System.out.println(response);
    }
...
//                .receivingCode("RV86526-230919-0005")
                ...
                .build();
        TongYouResponse<List<TongYouReceiptResp>> response = imlServer.getReceiptBatch(imlGetReceiptReq);
        System.out.println(response);
    }

    @Test
    public void getProductInventoryTest() {
        TongYouGetInventoryReq imlGetInventoryReq = TongYouGetInventoryReq.builder()
                .page(1)
                .pageSize(1000)
//                .receivingCode("RV86526-230919-0005")
                .build();
        TongYouResponse<List<TongYouInventoryResp>> response = imlServer.getProductInventory(imlGetInventoryReq);
        System.out.println(response);
    }

    @Test
    public void getShippingMethodTest() {
        TongYouResponse<List<TongYouInventoryLogisticsProductsResp>> response = imlServer.getShippingMethod("");
        System.out.println(response);
    }

    @Test
    public void createInboundBillTest() {
        TongYouCreateInboundReq imlGetReceiptReq = TongYouCreateInboundReq.builder()
                .referenceNo("wjtest20231205")
                .warehouseCode("UAW1")
                .verify(0)
                .items(Arrays.asList(TongYouCreateInboundReq.Item.builder()
                                .productSku("2898")
                                .boxNo(1)
                                .quantity(1)
                        .build()))
                .build();
        TongYouResponse<String> response = imlServer.createInboundBill(imlGetReceiptReq);
        System.out.println(response);
    }
    @Test
    public void editInboundBillTest() {
        TongYouCreateInboundReq imlGetReceiptReq = TongYouCreateInboundReq.builder()
                ...
                .items(Arrays.asList(TongYouCreateInboundReq.Item.builder()
                        ...
                        .build()))
                .build();
        TongYouResponse<String> response = imlServer.editInboundBill(imlGetReceiptReq);
        System.out.println(response);
    }
    @Test
    public void cancelInboundBillTest() {
        TongYouResponse<String> response = imlServer.cancelInboundBill("RV86526-231205-0001");
        System.out.println(response);
    }

    @Test
    public void createOutboundBillTest() {
        TongYouCreateOutboundReq tongYouCreateOutboundReq;
        String json = " {\n" +
                "                    \"platform\":\"OTHER\",\n" +
                "                    \"allocated_auto\":\"0\",\n" +
                "                    \"warehouse_code\":\"RUS2\",\n" +
                ...
                "                }";
        tongYouCreateOutboundReq = JSONObject.parseObject(json,new TypeReference<TongYouCreateOutboundReq>() {}.getType());
        TongYouResponse<String> response = imlServer.createOutboundBill(tongYouCreateOutboundReq);
        System.out.println(response);
    }

    @Test
    public void cancelOutboundBillTest() {
        TongYouResponse<String> response = imlServer.cancelOutboundBill("86526-231116-2374",null);
        System.out.println(response);
    }
    @Test
